...
有关具体插件示例，请参阅 [Voice Call](/en/plugins/voice-call)。正在寻找第三方列表？请参阅 [Community plugins](/en/plugins/community)。
...
Schema 代替。请参阅 [Plugin manifest](/en/plugins/manifest)。
...
有关设置和使用，请参阅 [语音通话](/en/plugins/voice-call) 和 `extensions/voice-call/README.md`。
