...
<Note>
在 Windows 上，我们强烈建议在 [OpenClaw](https://learn.microsoft.com/en-us/windows/wsl/install) 下运行 WSL2。
</Note>

## 安装方法

<Tip>
**安装程序脚本** 是安装 OpenClaw 的推荐方式。它一步即可完成 Node 检测、安装和引导。
</Tip>

<Warning>
对于 VPS/云主机，请尽可能避免使用第三方“一键式”市场镜像。首选纯净的基础操作系统镜像（例如 Ubuntu LTS），然后使用安装程序脚本自行安装 OpenClaw。
</Warning>
