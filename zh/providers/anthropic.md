...
OpenClaw 包含用于 Anthropic API 请求的 `extended-cache-ttl-2025-04-11` beta 标志；如果您覆盖提供商标头，请保留此标志（请参阅 [/gateway/configuration](/zh/gateway/configuration)）。
...
- 如果在 Claude 订阅上看到“OAuth token refresh failed …”，请使用 setup-token 重新进行身份验证。请参阅 [/gateway/故障排除](/zh/gateway/troubleshooting)。
