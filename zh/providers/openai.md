...
- [使用 WebSocket 的 API](https://platform.openai.com/docs/guides/realtime-websocket)
- [API 响应流式传输 (SSE)](https://platform.openai.com/docs/guides/streaming-responses)
...
- 身份验证详细信息 + 重用规则位于 [/concepts/oauth](/zh/concepts/oauth)。
