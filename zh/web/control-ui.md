...
[Devices CLI](/zh/cli/devices) for token rotation and revocation.
...
See [Tailscale](/zh/gateway/tailscale) for HTTPS setup guidance.
...
Remote access setup details: [Remote access](/zh/gateway/remote).
