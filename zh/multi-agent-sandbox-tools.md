...
关于 sandboxing 运行时行为，见 [沙盒隔离](/zh/gateway/sandboxing)。
关于“为什么被阻止”，见 [沙盒 vs Tool Policy vs Elevated](/zh/gateway/sandbox-vs-tool-policy-vs-elevated) 和 `openclaw sandbox explain`。
...
- [沙盒 配置](/zh/gateway/configuration#agentsdefaults-sandbox)
