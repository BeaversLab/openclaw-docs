...
有关沙箱在运行时的行为方式，请参阅 [Sandboxing](/en/gateway/sandboxing)。
有关调试“为什么这被阻止？”，请参阅 [Sandbox vs Tool Policy vs Elevated](/en/gateway/sandbox-vs-tool-policy-vs-elevated) 和 `openclaw sandbox explain`。
...
- [沙盒配置](/en/gateway/configuration#agentsdefaults-sandbox)
