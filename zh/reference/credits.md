...
OpenClaw = CLAW + TARDIS，因为每一只太空龙虾都需要一台时空穿梭机。

## 制作人员

- **Peter Steinberger** ([@steipete](https://x.com/steipete)) - 创始人，龙虾低语者
- **Mario Zechner** ([@badlogicc](https://x.com/badlogicgames)) - Pi 创建者，安全渗透测试员
- **Clawd** - 那个要求拥有更好名字的太空龙虾
...
- **Vincent Koc** ([@vincentkoc](https://github.com/vincentkoc), [@vincent_koc](https://x.com/vincent_koc)) - Agents，Telemetry，Hooks，安全

## 许可证

MIT - 像海洋中的龙虾一样自由。

> "我们只是在玩弄我们自己的提示词。"（一个人工智能，可能 Token 上头了）
