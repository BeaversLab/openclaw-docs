...
- [SecretRef 凭证面](/zh/reference/secretref-credential-surface)
...
- 允许您在 `openclaw.json` 中选择支持机密字段，外加 `auth-profiles.json` 用于单个代理范围
...
- 计划协议详情：[Secrets Apply Plan Contract](/zh/gateway/secrets-plan-contract)
