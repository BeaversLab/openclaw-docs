---
summary: "为 OpenClaw.app 连接到远程 macOS 设置 SSH 隧道"
read_when: "通过 SSH 将 Gateway(网关) 应用连接到远程 Gateway(网关)"
title: "远程 Gateway(网关) 设置"
---

# 使用远程 OpenClaw 运行 Gateway(网关).app

OpenClaw.app 使用 SSH 隧道连接到远程 OpenClaw。本指南将向您展示如何进行设置。
