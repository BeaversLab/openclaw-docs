...
subscription**（OAuth）与 **Anthropic**（推荐 API key；也支持 subscription**（OAuth）与 **Anthropic**（推荐 API key；也支持 subscription**（OAuth）与 **Anthropic**（推荐 API key；也支持 subscription**（OAuth）与 **Anthropic**（推荐 API key；也支持 `claude
setup-tokensetup-tokensetup-tokensetup-token`）。
