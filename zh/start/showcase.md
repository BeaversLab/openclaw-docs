...
<Info>
**想被展示？** 在 [Discord 的 #showcase 频道](https://discord.gg/clawd) 分享你的项目，或在 [X 上 @openclaw](https://x.com/openclaw)。
</Info>
...
在单个网关下运行 14+ 个代理，由 Opus 4.5 编排器将任务委派给 Codex 工作器。包含 [技术详解](https://github.com/adam91holt/orchestrated-ai-articles)，涵盖了 Dream Team 名单、模型选择、沙箱隔离、Webhooks、心跳和委派流程。[Clawdspace](https://github.com/adam91holt/clawdspace) 用于代理沙箱隔离。[博客文章](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/)。
</Card>
...
<Card title="绝美天空摄影" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
...
<Card title="会计信息采集" icon="file-invoice-dollar">
...
<Card title="通过 Telegram 实现的 Todoist 技能" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
...
<Card title="头脑特工队2 记忆" icon="brain">
...
<Steps>
  <Step title="分享它">
    在 [Discord 上的 #showcase 频道](https://discord.gg/clawd) 发帖或 [发推文 @openclaw](https://x.com/openclaw)
  </Step>
  <Step title="包含详细信息">
    告诉我们它的作用，链接到仓库/演示，如果您有的话，分享一张截图
  </Step>
  <Step title="获得展示">
    我们会将杰出的项目添加到此页面
  </Step>
