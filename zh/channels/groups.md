...
- 调试工具被阻止的原因：[沙盒 vs 工具策略 vs 提升权限](/zh/en/gateway/sandbox-vs-工具-policy-vs-elevated)
- 绑定挂载详细信息：[沙盒化](/zh/en/gateway/沙箱隔离#custom-bind-mounts)
...
- 私信 配对批准（`*-allowFrom` 存储条目）仅适用于 私信 访问；群组发送者授权保持对群组白名单的显式指定。
