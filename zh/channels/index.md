...
- [Feishu](/zh/channels/feishu) — 飞书/Lark bot 通过 WebSocket（插件，需单独安装）。
- [iMessage](/zh/channels/imessage) — 旧版 macOS 集成，通过 imsg CLI（已弃用，新部署请使用 BlueBubbles）。
...
- 群组行为因渠道而异；见 [群组](/zh/concepts/groups)。
