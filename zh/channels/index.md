...
- [Discord](/zh/en/channels/discord) — Discord Bot API + Gateway；支持服务器、频道和私信。
...
- [WebChat](/zh/en/web/webchat) — 基于 WebSocket 的 Gateway WebChat UI。
...
- 出于安全考虑，会强制执行私信（DM）配对和允许列表；请参阅 [Security](/zh/en/gateway/security)。
- 故障排除：[Channel troubleshooting](/zh/en/channels/troubleshooting)。
