...
- Localhost 信任意味着同主机反向代理可能会无意中绕过密码。如果您代理 Gateway 网关，请在代理处要求身份验证并配置 `gateway.trustedProxies`。请参阅 [Gateway 网关 安全](/zh/en/gateway/security#reverse-proxy-configuration)。
