---
summary: "帮助中心：常见修复方法、安装合理性检查，以及出现故障时的排查位置"
read_when:
...
- **故障排除：** [从这里开始](/zh/en/help/troubleshooting)
- **安装合理性检查 (Node/npm/PATH)：** [安装](/zh/en/install#nodejs--npm-path-sanity)
- **网关问题：** [网关故障排除](/zh/en/gateway/troubleshooting)
- **日志：** [日志记录](/zh/en/logging) 和 [网关日志记录](/zh/en/gateway/logging)
