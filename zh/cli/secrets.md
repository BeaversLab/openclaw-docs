...
- 凭据覆盖范围：[SecretRef Credential Surface](/en/reference/secretref-credential-surface)
...
- 规范支持的表面：[SecretRef Credential Surface](/en/reference/secretref-credential-surface)。
- 它在应用之前执行预检解析。
