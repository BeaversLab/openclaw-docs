...
参见 [Heartbeat](/gateway/heartbeat) 获取完整配置。
...
参见 [Cron jobs](/automation/cron-jobs) 获取完整 CLI 参考。
...
参见 [Lobster](/tools/lobster) 获取完整用法与示例。
...
- [System](/cli/system) - system event + heartbeat 控制
