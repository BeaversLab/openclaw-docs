...
<Warning>
  Pour les hébergeurs VPS/cloud, évitez autant que possible les images de place de marché "1-clic"
  de tiers. Préférez une image de système d'exploitation de base propre (par exemple Ubuntu LTS),
  puis installez OpenClaw vous-même avec le script d'installation.
</Warning>
