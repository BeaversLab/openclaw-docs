...
Affichez les journaux en temps réel dans **Dashboard → your service → Logs**. Filtrez par :
...
Les services de l'offre gratuite s'arrêtent après 15 minutes d'inactivité. La première requête après l'arrêt prend quelques secondes le temps que le conteneur démarre. Passez à l'offre Starter pour une disponibilité permanente.
