...
Cela crée une archive de sauvegarde portable que vous pouvez restaurer sur n'importe quel hôte OpenClaw. Consultez [Sauvegarde](/fr/cli/backup) pour plus de détails.
