...
- Les scripts sont **facultatifs**, sauf s'ils sont référencés dans la documentation ou les listes de contrôle de version.
...
- Ajoutez une courte entrée dans le document pertinent (ou créez-en une si elle est manquante).
