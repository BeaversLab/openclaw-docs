...
<Warning>
  Pour les agents avec outils activés ou les agents qui lisent du contenu non fiable, le risque
  d'injection de prompt avec des modèles plus anciens/plus petits est souvent trop élevé. N'exécutez
  pas ces charges de travail sur des niveaux de modèle faibles.
</Warning>
