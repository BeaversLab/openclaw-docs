...
<Warning>
  ...
  par le passé certaines utilisations d'abonnement en dehors de Claude Code. Utilisez-le uniquement
  si vous décidez que le risque de politique est acceptable, et vérifiez vous-même les conditions
  actuelles de Anthropic.
</Warning>
