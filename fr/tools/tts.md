...
- **Feishu / Matrix / Telegram / WhatsApp** : Message vocal Opus (`opus_48000_64` de ElevenLabs, `opus` d'OpenAI).
...
l'audio est délivré sous forme de message vocal plutôt que de pièce jointe de fichier.
