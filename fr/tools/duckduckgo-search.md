...
<Warning>
  DuckDuckGo est une intégration **expérimentale et non officielle** qui récupère les résultats des
  pages de recherche non-JavaScript de DuckDuckGo — et non d'une API officielle. Attendez-vous à des
  pannes occasionnelles dues aux pages de défi pour les bots ou aux modifications du HTML.
</Warning>
...
<Tip>
  Pour une utilisation en production, envisagez [Recherche Brave](/en/tools/brave-search) (gratuit
  disponible) ou un autre fournisseur pris en charge par une API.
</Tip>
