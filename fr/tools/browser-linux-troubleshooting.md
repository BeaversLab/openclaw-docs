...
| `browser.executablePath` | Chemin vers le binaire d'un navigateur basé sur Chromium (Chrome/Brave/Edge/Chromium) | détecté automatiquement (préfère le navigateur par défaut s'il est basé sur Chromium) |
