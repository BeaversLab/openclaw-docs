...
<Warning>
  Utilisez une image de base propre (Ubuntu 24.04 LTS). Évitez les images en 1 clic du Marketplace
  tiers, sauf si vous avez examiné leurs scripts de démarrage et les paramètres par défaut du
  pare-feu.
</Warning>
