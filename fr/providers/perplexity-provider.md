...
<Note>
  Cette page couvre la configuration du **provider** Perplexity. Pour l'**outil** Perplexity
  (comment l'agent l'utilise), voir [Perplexity tool](/fr/tools/perplexity-search).
</Note>
