...
- Si vous voyez « Échec de l'actualisation du jeton OAuth … » sur un abonnement Claude, réauthentifiez-vous avec un setup-token. Voir [/gateway/troubleshooting](/fr/gateway/troubleshooting).
