...
<Accordion title="Découpage sortant">
  - limite de découpage de texte : `channels.imessage.textChunkLimit` (par défaut 4000) - mode de
  découpage : `channels.imessage.chunkMode` - `length` (par défaut) - `newline` (découpage
  paragraphe en priorité)
</Accordion>
