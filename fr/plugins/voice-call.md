...
Voice Call utilise la configuration `messages.tts` principale (OpenAI ou ElevenLabs) pour
la diffusion audio en continu lors des appels. Vous pouvez la remplacer sous la configuration du plugin avec la
...
Ce dépôt inclut un document de compétence correspondant à `skills/voice-call/SKILL.md`.
