...
<Info>
  Si vous n'avez jamais créé de plugin OpenClaw auparavant, lisez le guide [Getting
  Started](/fr/plugins/building-plugins) d'abord pour comprendre la structure de base du package et
