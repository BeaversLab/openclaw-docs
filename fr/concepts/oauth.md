...
<Warning>
  La prise en charge du token de configuration Anthropic est une compatibilité technique, et non une
  garantie de stratégie. Anthropic a bloqué certaines utilisations d'abonnement en dehors de Claude
  Code par le passé. Décidez par vous-même d'utiliser ou non l'authentification par abonnement, et
  vérifiez les conditions actuelles de Anthropic.
</Warning>
