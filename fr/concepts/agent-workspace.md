...
[`agents.defaults.sandbox`](/fr/gateway/sandboxing) (et/ou la configuration de sandbox par agent).
...
Voir [Mémoire](/fr/concepts/memory) pour le workflow et le vidage automatique de la mémoire.
