...
- Les informations de mise à jour s'affichent dans l'aperçu ; si une mise à jour est disponible, status affiche une invite à exécuter `openclaw update` (voir [Updating](/fr/install/updating)).
