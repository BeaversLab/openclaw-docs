...
| `codexPlugins`             | disabled                         | Prise en charge native des plugins/applications Codex pour les plugins Codex tiers configurés. Voir [Plugins Codex natifs](/fr/plugins/codex-native-plugins). |
...
Le harnais groupé actuel est `@openai/codex` `0.135.0`. Une sonde `model/list`
