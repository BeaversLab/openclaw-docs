...
<Steps>
  ...
  <Step title="Canaux">
    ...
    - [Google Chat](/fr/channels/googlechat) : compte de service JSON + audience du webhook
    ...
    - [iMessage](/fr/channels/imessage) : chemin de la CLI `imsg` obsolète + accès à la base de données
