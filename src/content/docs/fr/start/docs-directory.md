...
# Annuaire de la documentation

<Note>Cette page est un index sélectionné. Si vous êtes novice, commencez par [Premiers pas](/fr/start/getting-started). Pour une carte complète de la documentation, consultez [Hubs de documentation](/fr/start/hubs).</Note>

## Commencer ici

- [Hubs de documentation (toutes les pages liées)](/fr/start/hubs)
- [Aide](/fr/help)
- [Configuration](/fr/gateway/configuration)
- [Exemples de configuration](/fr/gateway/configuration-examples)
- [Commandes slash](/fr/tools/slash-commands)
- [Routage multi-agent](/fr/concepts/multi-agent)
- [Mise à jour et retour en arrière](/fr/install/updating)
- [Jumelage (DM et nœuds)](/fr/channels/pairing)
...
- [Images multimédia](/fr/nodes/images)
