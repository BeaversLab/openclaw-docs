...
- D'autres canaux (WhatsApp, iMessage, Microsoft Teams, Discord) utilisent toujours du texte brut ou
  leurs propres règles de formatage, avec la conversion de tableaux Markdown appliquée avant
  le découpage (chunking) lorsqu'elle est activée.
