...
| --------------------------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Runtime du modèle local           | `agents.defaults.experimental.localModelLean`             | Un backend local plus petit ou plus strict s'étouffe avec la surface d'outils par défaut complète de OpenClaw                                      | [Modèles locaux](/fr/gateway/local-models)                                                                 |
...
| Outil de planification structurée | `tools.experimental.planTool`                             | Vous souhaitez que l'outil `update_plan` structuré soit exposé pour le suivi du travail en plusieurs étapes dans les runtimes et UI compatibles    | [Référence de configuration du Gateway](/fr/gateway/configuration-reference#toolsexperimental)             |
