...
| Partie                | Objectif                                                                                                                      |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Étiquette             | Une ligne de démarrage/statut courte telle que `Thinking...` ou `Shelling...`.                                                |
...
L'étiquette par défaut est `auto`OpenClaw, qui choisit parmi le pool d'étiquettes intégrées d'OpenClaw composé de mots uniques avec points de suspension :
