...
<Warning>La prise en charge du setup-token Anthropic est une compatibilité technique, et non une garantie de politique. Anthropic a bloqué certaines utilisations d'abonnement en dehors de Claude Code par le passé. Décidez par vous-même s'il faut utiliser l'auth par abonnement, et vérifiez les conditions actuelles de Anthropic.</Warning>
