...
Ne partagez jamais le `agentDir` de l'agent principal avec le délégué. Voir [Multi-Agent Routing](/fr/concepts/multi-agent) pour les détails sur l'isolement de l'authentification.
