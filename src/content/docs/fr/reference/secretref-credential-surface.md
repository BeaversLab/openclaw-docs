...
- Ces informations d'identification sont des classes créées, pivotées, portant une session ou durables OAuth qui ne correspondent pas à la résolution externe SecretRef en lecture seule.
