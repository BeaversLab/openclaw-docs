...
- `@whiskeysockets/baileys` `preinstall` -- vérifie que la version majeure de Node est >= 20 (OpenClaw est par défaut sur Node 24 et prend toujours en charge Node 22 LTS, actuellement `22.14+`)
