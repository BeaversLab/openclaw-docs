...
Cela crée une archive de sauvegarde portable que vous pouvez restaurer sur n'importe quel hôte OpenClaw. Consultez [Sauvegarde](/en/cli/backup) pour plus de détails.
...
Cela arrive sur la version gratuite (pas de disque persistant). Passez à un plan payant, ou
