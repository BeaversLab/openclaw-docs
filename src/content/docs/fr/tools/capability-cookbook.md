...
<Info>Ceci est un **guide du contributeur** pour les développeurs du cœur de OpenClaw. Si vous créez un plugin externe, consultez plutôt [Building Plugins](/fr/plugins/building-plugins).</Info>
