...
Ce modèle de menace est basé sur [MITRE ATLAS](https://atlas.mitre.org/), le cadre standard de l'industrie pour documenter les menaces adverses pesant sur les systèmes d'IA/ML. ATLAS est maintenu par [MITRE](https://www.mitre.org/) en collaboration avec la communauté de sécurité de l'IA.
...
- [GitHub GitHub ATLAS](https://github.com/mitre-atlas/atlas-data)
