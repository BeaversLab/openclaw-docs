...
- **Le packaging utilise par défaut Node 24** : le script exécute les builds TS et le build de l'interface de contrôle. Node 22 LTS, actuellement `22.19+`, reste pris en charge pour la compatibilité.
