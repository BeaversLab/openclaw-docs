...
- Les références OpenCode basées sur Gemini restent sur le chemin proxy-Gemini, donc OpenClaw y maintient
  le nettoyage de la signature de pensée Gemini sans activer la validation native de
