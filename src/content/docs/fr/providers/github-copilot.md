...
<Tabs>
  <Tab title="Fournisseur intégré (github-copilot)">
    Utilisez le flux de connexion natif par appareil pour obtenir un jeton GitHub, puis échangez-le contre
    des jetons de l'API Copilot lors de l'exécution de API. C'est le chemin **par défaut** et le plus simple
    ...
    <Steps>
      <Step title="Exécuter la commande de connexion">
        ...
        Il vous sera demandé de visiter une URL et d'entrer un code à usage unique. Gardez le
