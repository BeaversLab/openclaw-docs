...
- Le texte d'avertissement `gateway probe` tel que `multiple reachable gateways detected` n'est attendu que lorsque vous exécutez intentionnellement plus d'une passerelle isolée.
