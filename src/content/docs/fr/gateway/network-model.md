...
- Un Gateway par hôte est recommandé. C'est le seul processus autorisé à posséder la session Web WhatsApp. Pour les bots de secours ou une isolation stricte, exécutez plusieurs passerelles avec des profils et des ports isolés. Voir [Multiple gateways](/fr/gateway/multiple-gateways).
