...
<Warning>La prise en charge du setup-token Anthropic est une compatibilité technique uniquement. Anthropic a bloqué par le passé certaines utilisations d'abonnement en dehors de Claude Code. Utilisez-le uniquement si vous décidez que le risque de stratégie est acceptable, et vérifiez vous-même les conditions actuelles de Anthropic.</Warning>
