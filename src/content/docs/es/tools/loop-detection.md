...
| `criticalThreshold`              | `20`           | Umbral para bloquear patrones de bucle repetitivos.                                                                                                                    |
...
| `detectors.genericRepeat`        | `true`         | Detecta patrones repetitivos de la misma herramienta y los mismos parámetros.                                                                                          |
