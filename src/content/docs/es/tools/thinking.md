...
- Para `openai-codex/*`, el modo rápido envía la misma opción `service_tier=priority` en las respuestas de Codex. OpenClaw mantiene un solo botón `/fast` compartido en ambas rutas de autenticación.
