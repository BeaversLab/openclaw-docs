...
`/btw` le permite hacer una pregunta secundaria rápida sobre la **sesión actual** sin
...
Gateway y la arquitectura multicanal de OpenClaw.
...
los clientes lo tratarían como un historial de conversación regular.
...
La UI de control actual todavía necesita un consumidor dedicado `chat.side_result` para
