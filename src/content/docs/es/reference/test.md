...
- `pnpm check:changed`: Ejecuta el filtro inteligente de cambios para la diferencia contra `origin/main`. Ejecuta el trabajo principal con carriles de prueba principales, el trabajo de extensión con carriles de prueba de extensión, el trabajo de solo prueba con verificación de tipos de prueba/pruebas solo, y expande los cambios públicos del SDK de Plugin o del contrato de complemento a la validación de extensiones.
