...
<Note>En Windows, recomendamos encarecidamente ejecutar OpenClaw bajo [WSL2](https://learn.microsoft.com/en-us/windows/wsl/install).</Note>

## Métodos de instalación

<Tip>El **script de instalación** es la forma recomendada de instalar OpenClaw. Maneja la detección de Node, la instalación y el incorporamiento en un solo paso.</Tip>

<Warning>Para hosts VPS/nube, evita las imágenes de mercado de "un clic" de terceros cuando sea posible. Prefiere una imagen base de sistema operativo limpia (por ejemplo Ubuntu LTS) y luego instala OpenClaw tú mismo con el script de instalación.</Warning>
