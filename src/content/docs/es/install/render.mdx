...
Esto crea un archivo de copia de seguridad portable que puedes restaurar en cualquier host de OpenClaw. Consulta [Backup](/en/cli/backup) para obtener más detalles.
