...
<Note>Las URLs de descarga anteriores son para x86_64 (amd64). Para las máquinas virtuales basadas en ARM (por ejemplo, Hetzner ARM, GCP Tau T2A), reemplace las URLs de descarga con las variantes ARM64 correspondientes de la página de lanzamiento de cada herramienta.</Note>
