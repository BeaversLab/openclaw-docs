...
<Note>Si la instalación tiene éxito pero `openclaw` no se encuentra en una nueva terminal, consulte [Solución de problemas de Node.js](/en/install/node#troubleshooting).</Note>
