...
- La información de actualización aparece en la Resumen; si hay una actualización disponible, el estado imprime una sugerencia para ejecutar `openclaw update` (consulte [Actualización](/en/install/updating)).
