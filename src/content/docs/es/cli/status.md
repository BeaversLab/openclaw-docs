...
- La información de actualización aparece en la descripción general; si hay una actualización disponible, el estado imprime una pista para ejecutar `openclaw update` (consulte [Actualización](/es/install/updating)).
