...
- Doctor informa una nota informativa cuando los agentes en modo Codex están configurados y existen recursos personales de la CLI de Codex en el directorio personal de Codex del operador. Los lanzamientos locales del servidor de aplicaciones de Codex utilizan directorios personales aislados por agente, por lo que instala primero el complemento de Codex si es necesario y luego usa `openclaw migrate plan codex` para inventariar los recursos que deben promoverse deliberadamente.
