...
- [Slack](/es/channels/slack) — Bolt SDK; aplicaciones del área de trabajo.
- [Synology Chat](/es/channels/synology-chat) — Synology NAS Chat mediante webhooks de salida y entrada (complemento, instalado por separado).
...
- [Zalo](/es/channels/zalo) — Zalo Bot API; el mensajero popular de Vietnam (complemento, instalado por separado).
- [Zalo Personal](/es/channels/zalouser) — cuenta personal de Zalo mediante inicio de sesión QR (complemento, instalado por separado).
...
- El emparejamiento DM y las listas permitidas se aplican por seguridad; consulte [Seguridad](/es/gateway/security).
