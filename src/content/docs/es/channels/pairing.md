...
Las políticas de DM predeterminadas están documentadas en: [Seguridad](/en/gateway/security)
...
- Modelo de seguridad + inyección de prompt: [Seguridad](/en/gateway/security)
