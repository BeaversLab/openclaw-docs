...
Estado: experimental. Se admiten MD. La sección [Capabilities](#capabilities) a continuación refleja el comportamiento actual del bot de Marketplace.
...
Si está en una versión anterior o en una instalación personalizada que excluye Zalo, instale el
paquete npm directamente:
