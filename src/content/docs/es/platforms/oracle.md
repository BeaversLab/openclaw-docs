...
- [Acceso remoto del Gateway](/en/gateway/remote) — otros patrones de acceso remoto
...
- [Guía de DigitalOcean](/en/platforms/digitalocean) — si deseas pago + registro más fácil
