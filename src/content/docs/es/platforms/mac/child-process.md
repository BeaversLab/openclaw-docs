...
El modo de proceso secundario (Gateway generado directamente por la aplicación) **no está en uso** en la actualidad.
...
- [Manual del operador de Gateway](/es/gateway)
