...
La concesión de permisos de macOS es frágil. TCC asocia una concesión de permiso con la
firma de código de la aplicación, el identificador de paquete y la ruta en disco. Si alguno de estos cambia,
macOS trata la aplicación como nueva y puede eliminar u ocultar los avisos.
...
- Firma coherente: utilice un certificado real de Apple Development o Developer ID
