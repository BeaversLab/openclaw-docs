...
- **El empaquetado utiliza por defecto Node 24**: el script ejecuta las compilaciones de TS y la compilación de la interfaz de usuario de Control. Node 22 LTS, actualmente `22.19+`, sigue siendo compatible.
