...
Azure Speech es un proveedor de conversión de texto a voz de Azure AI Speech. En OpenClaw sintetiza
el audio de respuesta de salida como MP3 de forma predeterminada, Ogg/Opus nativo para notas de voz
...
<Steps>
  <Step title="Crear un recurso de Azure Speech">
    En el portal de Azure, cree un recurso de Speech. Copie **CLAVE 1** de
    Administración de recursos > Claves y punto de conexión, y copie la ubicación del
    recurso como `eastus`.
  ...
  <Step title="Enviar un mensaje">
    Envíe una respuesta a través de cualquier canal conectado. OpenClaw sintetiza el audio
