...
SenseAudio puede transcribir archivos de audio o notas de voz entrantes a través de la canalización compartida `tools.media.audio` de OpenClaw. OpenClaw envía audio multiparte al punto final de transcripción compatible con OpenAI e inyecta el texto devuelto como `{{Transcript}}` además de un bloque `[Audio]`.
...
<Note>SenseAudio es STT por lotes solo en OpenClaw. La transcripción en tiempo real de llamadas de voz continúa utilizando proveedores con soporte de STT en streaming.</Note>
