...
Actualmente, `inferrs` se trata mejor como un backend personalizado y autohospedado compatible con OpenAI,
...
<Steps>
  ...
  <Step title="Verificar que el servidor es accesible">```bash curl http://127.0.0.1:8080/health curl http://127.0.0.1:8080/v1/models ```</Step>
