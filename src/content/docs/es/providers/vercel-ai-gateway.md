...
acceder a cientos de modelos a través de un solo punto final.
...
<Tip>OpenClaw descubre automáticamente el catálogo `/v1/models` de Gateway, por lo que `/models vercel-ai-gateway` incluye referencias de modelos actuales como `vercel-ai-gateway/openai/gpt-5.5` y `vercel-ai-gateway/moonshotai/kimi-k2.6`.</Tip>
