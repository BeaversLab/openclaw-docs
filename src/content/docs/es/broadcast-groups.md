...
Nota: los grupos de difusión no omiten las listas de permitidos del canal ni las reglas de activación de grupos (menciones/comandos/etc.). Solo cambian _qué agentes se ejecutan_ cuando un mensaje es elegible para procesamiento.
...
### 1. Mantener los Agentes Enfocados
...
- [Configuración de multiagente](/en/multi-agent-sandbox-tools)
- [Configuración de enrutamiento](/en/concepts/channel-routing)
- [Gestión de sesiones](/en/concepts/sessions)
