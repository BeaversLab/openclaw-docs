...
- `timeoutSeconds`: tiempo máximo en segundos permitido para un turno de agente de latido antes de que se aborte. Déjelo sin establecer para usar `agents.defaults.timeoutSeconds` cuando se establezca; de lo contrario, la cadencia del latido se limita a 600 segundos.
