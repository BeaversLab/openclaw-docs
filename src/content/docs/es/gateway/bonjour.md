...
Eso deshabilita la publicidad multidifusión de LAN sin cambiar la configuración del complemento.
Es seguro para imágenes de Docker, archivos de servicio, scripts de inicio y depuración
de un solo uso porque la configuración desaparece cuando lo hace el entorno.

Use la configuración del complemento cuando intencionalmente desee desactivar el complemento de
descubrimiento de LAN incluido para esa configuración de OpenClaw:
...
2. Confirme que el propio Gateway sea accesible a través del puerto publicado:

   ```bash
   curl -fsS http://127.0.0.1:18789/healthz
   ```

3. Use un objetivo directo cuando Bonjour esté deshabilitado:
...
- **El anunciador atascado en sondeo/anuncio**: los hosts con multicast bloqueado,
