...
Manual: [acceso remoto de macOS](/en/platforms/mac/remote).
...
- **Los nodos no ejecutan el servicio de puerta de enlace (gateway).** Solo se debe ejecutar una puerta de enlace por host, a menos que intencionalmente ejecute perfiles aislados (consulte [Múltiples puertas de enlace](/en/gateway/multiple-gateways)).
