...
- [Configuración](/en/start/setup)
- [Panel (Gateway local)](http://127.0.0.1:18789/)
- [Ayuda](/en/help)
- [Directorio de documentos](/en/start/docs-directory)
- [Configuración](/en/gateway/configuration)
- [Ejemplos de configuración](/en/gateway/configuration-examples)
- [Asistente de OpenClaw](/en/start/openclaw)
- [Showcase](/en/start/showcase)
- [Historia](/en/start/lore)

## Instalación + actualizaciones

- [Docker](/en/install/docker)
- [Nix](/en/install/nix)
- [Actualización / reversión](/en/install/updating)
- [Flujo de trabajo de Bun (experimental)](/en/install/bun)

## Conceptos básicos

- [Arquitectura](/en/concepts/architecture)
- [Características](/en/concepts/features)
- [Hub de red](/en/network)
- [Runtime del agente](/en/concepts/agent)
- [Espacio de trabajo del agente](/en/concepts/agent-workspace)
- [Memoria](/en/concepts/memory)
- [Bucle del agente](/en/concepts/agent-loop)
- [Streaming + fragmentación](/en/concepts/streaming)
- [Enrutamiento multiagente](/en/concepts/multi-agent)
- [Compactación](/en/concepts/compaction)
- [Sesiones](/en/concepts/session)
- [Poda de sesiones](/en/concepts/session-pruning)
- [Herramientas de sesión](/en/concepts/session-tool)
- [Cola](/en/concepts/queue)
- [Comandos de barra](/en/tools/slash-commands)
- [Adaptadores RPC](/en/reference/rpc)
- [Esquemas TypeBox](/en/concepts/typebox)
- [Manejo de zonas horarias](/en/concepts/timezone)
- [Presencia](/en/concepts/presence)
- [Descubrimiento + transportes](/en/gateway/discovery)
- [Bonjour](/en/gateway/bonjour)
- [Enrutamiento de canales](/en/channels/channel-routing)
- [Grupos](/en/channels/groups)
- [Mensajes grupales](/en/channels/group-messages)
- [Conmutación por error del modelo](/en/concepts/model-failover)
- [OAuth](/en/concepts/oauth)

## Proveedores + ingress

- [Centro de canales de chat](/en/channels)
- [Centro de proveedores de modelos](/en/providers/models)
...
- [Superficie de herramientas](/en/tools)
- [OpenProse](/en/prose)
...
- [CLI de envío de agente](/en/tools/agent-send)
...
- [Cámara](/en/nodes/camera)
- [Imágenes](/en/nodes/images)
...
- [Descripción general de plataformas](/en/platforms)
...
- [AGENTES predeterminados](/en/reference/AGENTS.default)
- [Plantillas: AGENTES](/en/reference/templates/AGENTS)
- [Plantillas: BOOTSTRAP](/en/reference/templates/BOOTSTRAP)
- [Plantillas: HEARTBEAT](/en/reference/templates/HEARTBEAT)
- [Plantillas: IDENTITY](/en/reference/templates/IDENTITY)
- [Plantillas: SOUL](/en/reference/templates/SOUL)
- [Plantillas: TOOLS](/en/reference/templates/TOOLS)
- [Plantillas: USER](/en/reference/templates/USER)

## Proyecto

- [Créditos](/en/reference/credits)
