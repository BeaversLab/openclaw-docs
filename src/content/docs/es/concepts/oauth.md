...
<Warning>La compatibilidad con el token de configuración de Anthropic es una compatibilidad técnica, no una garantía política. Anthropic ha bloqueado algunos usos de suscripción fuera de Claude Code en el pasado. Decida por sí mismo si desea utilizar la autenticación por suscripción y verifique los términos actuales de Anthropic.</Warning>
