...
| Parte              | Propósito                                                                                                                               |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| Etiqueta           | Una línea corta de inicio/estado como `Thinking...` o `Shelling...`.                                                                    |
...
La etiqueta predeterminada es `auto`, que elige del grupo de etiquetas
de una sola palabra con puntos suspensivos integrado en OpenClaw:
