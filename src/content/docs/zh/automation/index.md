...
参见 [Heartbeat](/en/gateway/heartbeat)。
...
- [Scheduled Tasks](/en/automation/cron-jobs) — 精确调度和一次性提醒
- [Background Tasks](/en/automation/tasks) — 所有分离工作的任务账本
- [Task Flow](/en/automation/taskflow) — 持久的多步骤流程编排
- [Hooks](/en/automation/hooks) — 事件驱动的生命周期脚本
- [Standing Orders](/en/automation/standing-orders) — 持久的代理指令
- [Heartbeat](/en/gateway/heartbeat) — 定期主会话轮次
- [Configuration Reference](/en/gateway/configuration-reference) — 所有配置键
