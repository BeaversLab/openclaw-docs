...
请参阅[钩子](/en/automation/hooks)了解设置和示例。
...
有关 hook API 和注册详细信息，请参阅 [Plugin hooks](/en/plugins/architecture#provider-runtime-hooks)。
...
- 有关分块和块回复行为，请参阅 [Streaming](/en/concepts/streaming)。
...
- [钩子](/en/automation/hooks) — 由 Agent 生命周期事件触发的事件驱动脚本
- [压缩](/en/concepts/compaction) — 长对话如何被总结
- [执行批准](/en/tools/exec-approvals) — Shell 命令的批准关卡
- [思考](/en/tools/thinking) — 思考/推理级别配置
