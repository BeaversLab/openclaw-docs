...
<Steps>
  <Step title="获取您的 APIAPI 密钥">
    ...
    2. 前往 **设置 > APIAPI 密钥 > 创建新密钥**
    3. 复制您的 APIAPI 密钥（格式：`vapi_xxxxxxxxxxxx`）
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="VeniceAnonymized models (12) — via Venice proxy">
    | Model ID                        | 名称                           | 上下文 | 功能                  |
    | ------------------------------- | ------------------------------ | ------- | ------------------------- |
    | `claude-opus-4-6`Venice               | Claude Opus 4.6 (via Venice)   | 1M      | 推理、视觉         |
    | `claude-sonnet-4-6`Venice             | Claude Sonnet 4.6 (via Venice) | 1M      | 推理、视觉         |
    | `openai-gpt-54`Venice                 | GPT-5.4 (via Venice)           | 1M      | 推理、视觉         |
    | `openai-gpt-53-codex`Venice           | GPT-5.3 Codex (via Venice)     | 400k    | 推理、视觉、编程 |
    | `openai-gpt-52`Venice                 | GPT-5.2 (via Venice)           | 256k    | 推理                 |
    | `openai-gpt-52-codex`Venice           | GPT-5.2 Codex (via Venice)     | 256k    | 推理、视觉、编程 |
    | `openai-gpt-4o-2024-11-20`Venice      | GPT-4o (via Venice)            | 128k    | 视觉                    |
    | `openai-gpt-4o-mini-2024-07-18`Venice | GPT-4o Mini (via Venice)       | 128k    | 视觉                    |
    | `gemini-3-1-pro-preview`Venice        | Gemini 3.1 Pro (via Venice)    | 1M      | 推理、视觉         |
    | `gemini-3-pro-preview`Venice          | Gemini 3 Pro (via Venice)      | 198k    | 推理、视觉         |
    | `gemini-3-flash-preview`Venice        | Gemini 3 Flash (via Venice)    | 256k    | 推理、视觉         |
    | `grok-41-fast`Venice                  | Grok 4.1 Fast (via Venice)     | 1M      | 推理、视觉         |
  </Accordion>
</AccordionGroup>
