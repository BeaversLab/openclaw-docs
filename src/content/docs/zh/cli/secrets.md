...
- 密钥指南：[密钥管理](/en/gateway/secrets)
- 凭证范围：[SecretRef 凭证范围](/en/reference/secretref-credential-surface)
...
- 规范支持范围：[SecretRef Credential Surface](/en/reference/secretref-credential-surface)。
- 它在应用之前执行预检解析。
