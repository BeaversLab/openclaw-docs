...
<Info>[nix-openclaw](https://github.com/openclaw/nix-openclaw) 代码仓库是 Nix 安装的权威来源。本页面仅作快速概览。</Info>
...
<Steps>
  <Step title="安装 Determinate Nix">如果尚未安装 Nix，请按照 [Determinate Nix 安装程序](https://github.com/DeterminateSystems/nix-installer) 的说明操作。</Step>
...
- [向导](/en/start/wizard) -- 非 Nix CLI 设置
