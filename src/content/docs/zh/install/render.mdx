...
- 来自您首选 [模型提供商](/en/providers) 的 API 密钥
...
这将创建一个包含 OpenClaw 状态以及任何已配置工作区的可移植备份存档。详情请参阅 [Backup](/en/cli/backup)。
...
- 设置消息渠道：[Channels](/en/channels)
- 配置 Gateway(网关)：[Gateway(网关) configuration](/en/gateway/configuration)
- 保持 OpenClaw 为最新：[Updating](/en/install/updating)
