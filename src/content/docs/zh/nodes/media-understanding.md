...
| Capability | 提供商集成                                                                                                             | 说明                                                                                                                                                                                                                               |
| ---------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 图像       | OpenAI，OpenAI Codex OAuth，Codex app-server，OpenRouter，Anthropic，Google，MiniMax，Moonshot，Qwen，Z.AI，配置提供商 | 供应商插件注册图像支持；`openai/*`APIOAuth 可以使用 API 密钥或 Codex OAuth 路由；`codex/*`MiniMaxMiniMaxOAuth 使用受限的 Codex 应用服务器轮次；MiniMax 和 MiniMax OAuth 均使用 `MiniMax-VL-01`；支持图像的配置提供程序会自动注册。 |
