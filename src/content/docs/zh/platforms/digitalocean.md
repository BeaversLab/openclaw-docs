...
如果您想要一个每月 0 美元的选项，并且不介意 ARM + 特定于提供商的设置，请参阅 [Oracle Cloud 指南](/zh/platforms/oracle)。
...
- Hetzner：良好的性价比（请参阅 [Hetzner 指南](/zh/install/hetzner)）
- Oracle Cloud：可以每月 0 美元，但更加挑剔且仅限 ARM（请参阅 [Oracle 指南](/zh/platforms/oracle)）
...
<Warning>使用干净的基准镜像（Ubuntu 24.04 LTS）。避免使用第三方 Marketplace 一键镜像，除非您 已审查其启动脚本和防火墙默认设置。</Warning>
...
有关其他提供商，请参阅 [Channels](/zh/channels)。
