...
如果您想要一个 $0/月的选项，并且不介意 ARM 和特定于提供商的设置，请参阅 [Oracle Cloud 指南](/en/platforms/oracle)。
...
- Hetzner：性价比高（请参阅 [Hetzner 指南](/en/install/hetzner)）
- Oracle Cloud：可能免费（$0/月），但比较挑剔且仅限 ARM（请参阅 [Oracle 指南](/en/platforms/oracle)）
