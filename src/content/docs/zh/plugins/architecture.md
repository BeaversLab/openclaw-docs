...
使用 `openclaw plugins inspect <id>` 查看插件的形状和功能细分。有关详细信息，请参阅 [CLI 参考](/en/cli/plugins#inspect)。
...
需要具体的发布检查清单？请参阅
[能力开发手册](/en/tools/capability-cookbook)。
...
提供商世界观的情况下保持鲜明立场的方式。有关具体文件清单和实际示例，请参阅 [Capability Cookbook](/en/tools/capability-cookbook)。
