...
- 已安装并完成新手引导 OpenClaw - 如果尚未完成，请参阅 [入门指南](OpenClaw/en/start/getting-started)
...
这意味着，当您的文件系统策略已允许读取工作区之外生成的图像/文件时，现在可以发送它们，而无需重新开放任意主机文本附件的渗漏通道。
...
- macOS 菜单栏配套应用：[OpenClaw macOS 应用](macOSOpenClawmacOS/en/platforms/macos)
- iOS 节点应用：[iOS 应用](iOSiOS/en/platforms/ios)
- Android 节点应用：[Android 应用](AndroidAndroid/en/platforms/android)
- Windows 状态：[Windows (WSL2)](WindowsWindowsWSL2/en/platforms/windows)
- Linux 状态：[Linux 应用](LinuxLinux/en/platforms/linux)
