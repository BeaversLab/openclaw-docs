...
<Note>This page is a curated index. If you are new, start with [入门指南](/en/start/getting-started). For a complete map of the docs, see [Docs hubs](/en/start/hubs).</Note>
...
- [Pairing (私信 and nodes)](/en/channels/pairing)
...
- [设备发现 and transports](/en/gateway/discovery)
