...
| 编辑 / 参考       | 1 张图片（工作流） | 1 张图片  | Flux: 1; GPT: 10; NB2: 14 | 最多 5 张图片 | 1 张图片（主题参考） | 最多 5 张图片 | -     | 最多 5 张图片 |
| 尺寸控制          | -                  | ✓         | ✓                         | ✓             | -                    | 最高 4K       | -     | -             |
| 长宽比            | -                  | -         | ✓                         | ✓             | ✓                    | -             | -     | ✓             |
| 分辨率 (1K/2K/4K) | -                  | -         | ✓                         | ✓             | -                    | -             | -     | 1K, 2K        |
...
OpenAI、OpenRouter、Google 和 xAI 通过 `images` 参数支持最多 5 张参考图片。fal 为 Flux 图生图支持 1 张参考图片，为 GPT Image 2 编辑最多支持 10 张，为 Nano Banana 2 编辑最多支持 14 张。MiniMax 和 ComfyUI 支持 1 张。
