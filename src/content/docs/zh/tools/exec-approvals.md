...
常见问题：[为什么聊天审批有两个执行审批配置？](/en/help/faq#why-are-there-two-exec-approval-configs-for-chat-approvals)
...
- [沙箱 vs 工具策略 vs 提权](/en/gateway/sandbox-vs-tool-policy-vs-elevated) — 何时使用每种方式
