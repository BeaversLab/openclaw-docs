...
[Firecrawl](/en/tools/firecrawl) 以进行反爬虫并更好地提取内容：
...
- `web_fetch` 是尽力而为的 —— 某些站点需要 [Web Browser](/en/tools/browser)
...
- [Web Browser](/en/tools/browser) -- 针对 JavaScript 重型网站的完整浏览器自动化
