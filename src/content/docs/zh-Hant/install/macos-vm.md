...
- 使用**小型 Linux VPS**作為永遠在線的 Gateway 且成本低廉。請參閱 [VPS hosting](/zh-Hant/vps)。
...
完整設定細節：[BlueBubbles channel](/zh-Hant/channels/bluebubbles)
...
為了真正的全天候運作，請考慮使用專屬的 Mac mini 或小型 VPS。請參閱 [VPS hosting](/zh-Hant/vps)。
