...
將此貼上到您的代理中，讓它重寫 `SOUL.md`。

針對 OpenClaw 工作區的路徑已修正：請使用 `SOUL.md`，而非 `http://SOUL.md`。
...
將 `AGENTS.md` 用於操作規則。將 `SOUL.md` 用於語音、立場和
風格。如果您的代理在共享頻道、公開回覆或客戶介面上工作，請確保語氣仍然適合該場合。
