...
關於 ACP 特定的行為，請參閱 [ACP Agents](/en/tools/acp-agents)。
...
- [Session Management](/en/concepts/session) -- 路由、生命週期、維護
- [ACP Agents](/en/tools/acp-agents) -- 外部 harness 生成
- [Multi-agent](/en/concepts/multi-agent) -- 多 agent 架構
