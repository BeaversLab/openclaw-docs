...
- [會話修剪](/zh-Hant/concepts/session-pruning) -- 裁剪工具結果
...
- [多代理](/zh-Hant/concepts/multi-agent) — 跨代理的路由和會話隔離
- [後台任務](/zh-Hant/automation/tasks) — 分離工作如何創建帶有會話引用的任務記錄
- [通道路由](/zh-Hant/channels/channel-routing) — 傳入消息如何路由到會話
