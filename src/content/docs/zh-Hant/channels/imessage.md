...
<Accordion title="Outbound chunking">- text chunk limit: `channels.imessage.textChunkLimit` (預設值 4000) - chunk mode: `channels.imessage.chunkMode` - `length` (預設值) - `newline` (paragraph-first splitting)</Accordion>
