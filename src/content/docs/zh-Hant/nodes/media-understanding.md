...
| 功能 | 提供者整合                                                                                                                   | 備註                                                                                                                                                                                                    |
| ---- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 圖片 | OpenAI、OpenAI Codex OAuth、Codex app-server、OpenRouter、Anthropic、Google、MiniMax、Moonshot、Qwen、Z.AI、config providers | 廠商插件註冊圖片支援；`openai/*` 可以使用 API 金鑰或 Codex OAuth 路由；`codex/*` 使用受限的 Codex 應用伺服器輪次；MiniMax 和 MiniMax OAuth 都使用 `MiniMax-VL-01`；具備圖片功能的設定提供者會自動註冊。 |
