...
如果您想要 $0/月 的選項並且不介意 ARM + 特定供應商的設定，請參閱 [Oracle Cloud 指南](/zh-Hant/platforms/oracle)。
...
- Hetzner：價格/效能比高（請參閱 [Hetzner 指南](/zh-Hant/install/hetzner)）
- Oracle Cloud：可以 $0/月 使用，但比較挑剔且僅限 ARM（請參閱 [Oracle 指南](/zh-Hant/platforms/oracle)）
...
關於其他供應商，請參閱 [頻道](/zh-Hant/channels)。
...
若要查看完整的設定指南，請參閱 [Oracle Cloud](/zh-Hant/platforms/oracle)。關於註冊提示和註冊過程的故障排除，請參閱此 [社群指南](https://gist.github.com/rssnyder/51e3cfedd730e7dd5f4a816143b25dbd)。
