...
統一記錄會修飾大多數 payload，除非子系統選擇加入 `privacy -off`。根據 Peter 關於 macOS [記錄隱私問題](https://steipete.me/posts/2025/logging-privacy-shenanigans) (2025) 的文章，這是由 `/Library/Preferences/Logging/Subsystems/` 中的 plist 控制的，並以子系統名稱作為鍵。只有新的日誌條目才會使用該標誌，因此請在重現問題之前啟用它。
...
- [Gateway logging](/zh-Hant/gateway/logging)
