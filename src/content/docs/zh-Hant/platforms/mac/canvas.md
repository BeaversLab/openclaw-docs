...
Canvas 的狀態儲存在 Application Support 下：
...
Canvas 透過 **Gateway WebSocket** 暴露出來，因此 Agent 可以：
...
- 如果您傳遞 `"/"`，Canvas 會顯示本地鷹架或 `index.html`。
