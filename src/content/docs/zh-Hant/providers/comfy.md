...
<CardGroup cols={2}>
  <Card title="映像生成" href="/zh-Hant/tools/image-generation" icon="image">
    映像生成工具的設定與用法。
  </Card>
  ...
  <Card title="提供者目錄" href="/zh-Hant/providers/index" icon="layers">
    所有提供者與模型參考的概覽。
  </Card>
  <Card title="配置參考" href="/zh-Hant/gateway/configuration-reference#agent-defaults" icon="gear">
    完整的配置參考，包括代理預設值。
  </Card>
</CardGroup>
