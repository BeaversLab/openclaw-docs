...
- For tokens, API keys, and credential snippets, follow [Secret Placeholder Conventions](/en/reference/secret-placeholder-conventions). Keep example values obviously fake so secret scanners stay quiet.
- For tokens, API keys, and credential snippets, follow [Secret Placeholder Conventions](/en/reference/secret-placeholder-conventions). Keep example values obviously fake so secret scanners stay quiet.
