...
<Warning>
  ...
  [tools allowlist config](/en/gateway/config-tools).
</Warning>
...
approval-gated workflows, compare with [Lobster](/en/tools/lobster).
...
<CardGroup cols={2}>
  ...
  <Card title="Subagents" href="/en/tools/subagents" icon="users">
    OpenClaw's native multi-agent coordination layer.
  </Card>
  <Card title="Text-to-speech" href="/en/tools/tts" icon="volume-high">
