...
Related docs: [Plugins](/en/tools/plugin), [Plugin manifest](/en/plugins/manifest), [Skills](/en/tools/skills).
...
If your tool allowlist blocks these tools, OpenProse programs will fail. See [Skills config](/en/tools/skills-config).
...
- [Markdown formatting](/en/concepts/markdown-formatting)
