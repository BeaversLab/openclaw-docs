...
selected by the daily schedule. See [Gateway concurrency](/en/reference/test/performance#benchmarks)
...
validation. See [Package Acceptance suite profiles](/en/ci/release-validation#suite-profiles)
...
[Runner registration budgets](/en/ci/capacity#runner-registration-budget) account
