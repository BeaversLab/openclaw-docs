...
[`Plugin Prerelease`](/en/ci/release-validation#plugin-prerelease) workflow and only runs from
[`Full Release Validation`](/en/ci/release-validation#full-release-validation) or an explicit manual
dispatch.
...
[package validation matrix](/en/ci/release-validation/package-acceptance).
...
and live PR state; see [Scope and routing](/en/ci/scope-and-routing).
