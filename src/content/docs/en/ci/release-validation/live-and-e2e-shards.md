...
The named live and E2E shards the release live/E2E child runs, and what each shard covers. Part of the [Release validation workflows](/en/ci/release-validation) index.
