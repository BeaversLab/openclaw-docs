...
The Full Release Validation umbrella, release publish, and Docker Release dispatch. Part of the [Release validation workflows](/en/ci/release-validation) index.
...
For targets with [test runtime selection](/en/ci/pipeline#test-runtime-selection),
...
[Dispatch](/en/reference/full-release-validation/dispatch) for both contracts.
