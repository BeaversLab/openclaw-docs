...
See [full release coverage](/en/ci/release-validation/full-release-validation)
...
The [bounded hybrid hosted offload](/en/ci/capacity#bounded-hybrid-hosted-offload) applies only to automatic CI first attempts. Full Release Validation, candidate/artifact workflows, and frozen-target workloads retain their existing coverage and runner routes.
