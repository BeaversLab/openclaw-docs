...
- **macOS system domain unavailable or system LaunchDaemon detected:** have root
  ...
  used by the service. See [Existing system LaunchDaemons](/en/gateway#existing-system-launchdaemons).
...
and state checks still follow the selected [posture](/en/cli/doctor/running#postures).
