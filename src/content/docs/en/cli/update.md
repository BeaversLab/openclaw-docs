...
the same [preservation-first recovery](/en/reference/database-schemas/integrity-and-recovery#doctor-reports-orphan-task-delivery-rows)
...
Failed update and repair attempts enter [recovery triage](/en/cli/update#recover-a-failed-update)
...
[Gateway logging](/en/gateway/logging).
...
[Doctor: Downgrading after session SQLite migration](/en/cli/doctor#downgrading-after-session-sqlite-migration).
</Warning>
...
<CardGroup cols={3}>
  <Card title="Status and run history" href="/en/cli/update/status-and-history" icon="list">
    `update status`, the durable run ledger, and the reports each run writes.
  </Card>
  <Card title="Repair and recovery" href="/en/cli/update/repair-and-recovery" icon="wrench">
    Triage after a failed update, `update repair`, and `update cleanup`.
  </Card>
  <Card title="How an update runs" href="/en/cli/update/how-updates-run" icon="gear">
    Channel switching, validation, restart handoff, and the Git checkout flow.
  </Card>
</CardGroup>

- <a id="recover-a-failed-update"></a>[Recover a failed update](/en/cli/update/repair-and-recovery#recover-a-failed-update)
- <a id="update-status"></a>[`update status`](/en/cli/update/status-and-history#update-status)
- <a id="run-history-and-reports"></a>[Run history and reports](/en/cli/update/status-and-history#run-history-and-reports)
- <a id="update-repair"></a>[`update repair`](/en/cli/update/repair-and-recovery#update-repair)
- <a id="update-cleanup"></a>[`update cleanup`](/en/cli/update/repair-and-recovery#update-cleanup)
- <a id="what-it-does"></a>[What it does](/en/cli/update/how-updates-run#what-it-does)
- <a id="validation-and-activation"></a>[Validation and activation](/en/cli/update/how-updates-run#validation-and-activation)
- <a id="durable-serving-recovery"></a>[Recovery limits](/en/cli/update/how-updates-run#durable-serving-recovery)
- <a id="legacy-package-rollback"></a>[Compatibility-checked package rollback](/en/cli/update/how-updates-run#legacy-package-rollback)
- <a id="restart-handoff"></a>[Restart handoff](/en/cli/update/how-updates-run#restart-handoff)
- <a id="control-plane-response-shape"></a>[Control-plane response shape](/en/cli/update/how-updates-run#control-plane-response-shape)
- <a id="git-checkout-flow"></a>[Git checkout flow](/en/cli/update/how-updates-run#git-checkout-flow)
- <a id="channel-selection"></a>[Channel selection](/en/cli/update/how-updates-run#channel-selection)
- <a id="update-steps"></a>[Update steps](/en/cli/update/how-updates-run#update-steps)
  - <a id="verify-clean-worktree"></a>[Verify clean worktree](/en/cli/update/how-updates-run#verify-clean-worktree)
  - <a id="resolve-the-target"></a>[Resolve the target](/en/cli/update/how-updates-run#resolve-the-target)
  - <a id="build-a-candidate"></a>[Build a candidate](/en/cli/update/how-updates-run#build-a-candidate)
  - <a id="validate-the-candidate"></a>[Validate the candidate](/en/cli/update/how-updates-run#validate-the-candidate)
  - <a id="activate-and-verify"></a>[Activate and verify](/en/cli/update/how-updates-run#activate-and-verify)
  - <a id="sync-plugins"></a>[Sync plugins](/en/cli/update/how-updates-run#sync-plugins)
- <a id="plugin-sync-details"></a>[Plugin sync details](/en/cli/update/how-updates-run#plugin-sync-details)
