...
opens [Triage](/en/cli/triage). Triage immediately starts the first directly
...
[unattended repair slot](/en/install/updating#unattended-repair-on-your-own-inference)
...
failed verification can [restore the previous package](/en/cli/update#validation-and-activation)
...
[Update troubleshooting](/en/install/update-troubleshooting).
...
old run. See [Updating](/en/install/updating#stale-update-history).
...
recovering its stale row. See [Database schemas](/en/reference/database-schemas#update-run-ledger).
...
[manual update commands](/en/install/updating#updating-from-2026.9.2-across-a-schema-bump).
See [Database schemas](/en/reference/database-schemas#schema-bumps-and-older-updaters)
...
[Before updating: create a verified backup](/en/install/updating#before-updating-create-a-verified-backup)
for backup coverage and [Doctor recovery](/en/cli/doctor#session-sqlite-migration)
...
[Downgrade finalization](/en/install/updating#roll-back-a-package-install).
...
[Unattended repair](/en/install/updating#unattended-repair-on-your-own-inference) for
...
reason. See [Automatic rollback](/en/install/updating#automatic-schema-neutral-rollback)
...
Use the recorded diagnostics and [Triage](/en/cli/triage) for remaining failures,
preserving migrated state. These temporary validation
snapshots are not a full-state backup; see [Rollback](/en/install/updating#rollback).
...
[capability-consent exemption](/en/plugins/manage-plugins#capability-consent).
...
[manual update](/en/install/updating#alternative-manual-npm-pnpm-or-bun).
