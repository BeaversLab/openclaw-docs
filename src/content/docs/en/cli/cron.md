...
<Tip>
Run `openclaw automations --help` for the full command surface. See [Automations](/en/automation/cron-jobs) for the conceptual guide.
</Tip>
...
[Automation schedules](/en/automation/cron-jobs/schedules#schedule-types) for stream lifecycle,
...
- [Automations](/en/automation/cron-jobs)
