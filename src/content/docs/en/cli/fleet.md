...
This profile separates tenant containers, but it does not protect tenants from the Fleet operator, the container runtime administrator, or a compromised host. See [Multi-tenant hosting](/en/gateway/multi-tenant-hosting) for the complete trust model and stronger isolation options.
...
- [Multi-tenant hosting](/en/gateway/multi-tenant-hosting)
