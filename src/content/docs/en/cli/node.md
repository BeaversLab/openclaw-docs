...
[Node-hosted MCP servers](/en/nodes/mcp-and-skills#node-hosted-mcp-servers).
...
For one-paste onboarding, use [`openclaw connect`](/en/cli/connect). It accepts a
...
the node host's [exec approvals](/en/tools/exec-approvals) remain separate gates.
...
[SSH-verified device auto-approval](/en/gateway/pairing#ssh-verified-device-auto-approval-default)
...
- [Connect a machine](/en/cli/connect)
- [Nodes](/en/nodes)
