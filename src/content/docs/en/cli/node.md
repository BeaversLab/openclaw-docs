...
[Node-hosted MCP servers](/en/nodes#node-hosted-mcp-servers).
...
[Gateway deployments that cannot host nodes](/en/nodes#gateway-deployments-that-cannot-host-nodes).
