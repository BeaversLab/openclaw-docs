...
Remove any remaining CLI through the [installation-specific steps](/en/install/uninstall#remove-the-cli).
...
[`openclaw backup`](/en/cli/backup) first if you may want the state back.
