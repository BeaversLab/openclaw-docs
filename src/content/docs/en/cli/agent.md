...
When your tool policy enables `browser`, local browser control works without a Gateway. Explicit Gateway or node routing and sandbox restrictions still apply; see [Node browser proxy](/en/tools/browser#node-browser-proxy-zero-config-default).
