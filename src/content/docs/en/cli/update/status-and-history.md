...
Availability checks and the durable record every update leaves behind. Part of the [`openclaw update`](/en/cli/update) reference.
...
[`openclaw update repair`](/en/cli/update/repair-and-recovery) when recovery is needed.
