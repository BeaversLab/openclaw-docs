...
Restart flags, which install owns the host service, external supervisors, and profiling. Part of the [`openclaw gateway`](/en/cli/gateway) reference.
