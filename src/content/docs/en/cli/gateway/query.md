...
The WebSocket RPC query subcommands and their shared options. Part of the [`openclaw gateway`](/en/cli/gateway) reference.
...
[project registration and listing examples](/en/web/control-ui/sessions-and-sidebar#register-an-existing-repository).
...
[`sessions_send` tool](/en/concepts/session-tool#sending-cross-session-messages),
