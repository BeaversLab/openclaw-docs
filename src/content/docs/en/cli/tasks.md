...
See [Background Tasks](/en/automation/tasks) for the lifecycle and delivery
...
[Background Tasks](/en/automation/tasks) for severity and trigger detail per
code.
...
`succeeded`, `failed`, `cancelled`, or `lost`. See [Task Flow](/en/automation/taskflow)
