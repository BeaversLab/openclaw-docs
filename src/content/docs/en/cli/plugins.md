...
[Tool Plugins](/en/plugins/tool-plugins) for the full authoring workflow.
...
<AccordionGroup>
  ...
  <Accordion title="--dangerously-force-unsafe-install">
    ...
    If a plugin you published on ClawHub is hidden or blocked by a registry scan, use the publisher steps in [ClawHub publishing](/en/clawhub/publishing). `--dangerously-force-unsafe-install` only affects installs on your own machine; it does not ask ClawHub to rescan the plugin or make a blocked release public.
