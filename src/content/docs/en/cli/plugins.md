...
<AccordionGroup>
  ...
  <Accordion title="--dangerously-force-unsafe-install">
    ...
    If a plugin you published on ClawHub is hidden or blocked by a registry scan, use the publisher steps in [ClawHub publishing](/en/clawhub/publishing). `--dangerously-force-unsafe-install` does not ask ClawHub to rescan the plugin or make a blocked release public.
