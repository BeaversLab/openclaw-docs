...
- Plugin system: [Plugins](/en/tools/plugin)
- Bundle compatibility: [Plugin bundles](/en/plugins/bundles)
...
instead of flattening. See [Config includes](/en/gateway/configuration) for the
supported shapes.
