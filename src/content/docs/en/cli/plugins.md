...
| [Uninstall and update plugins](/en/cli/plugins/uninstall-and-update) | You are removing or reloading a plugin, or updating its version and source.      |
...
- <a id="reload" />[Reload](/en/cli/plugins/uninstall-and-update#reload)
