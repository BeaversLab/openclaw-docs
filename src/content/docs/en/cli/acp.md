...
This is different from [ACP Agents](/en/tools/acp-agents), where OpenClaw runs an
...
[ACP Agents](/en/tools/acp-agents-setup#plugin-tools-mcp-bridge) and
[OpenClaw tools MCP bridge](/en/tools/acp-agents-setup#openclaw-tools-mcp-bridge).
