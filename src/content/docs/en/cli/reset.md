...
- [`openclaw backup`](/en/cli/backup) — archive state before resetting it
- [`openclaw onboard`](/en/cli/onboard) — set the install up again after a reset
- [`openclaw uninstall`](/en/cli/uninstall) — remove the install instead of resetting it
