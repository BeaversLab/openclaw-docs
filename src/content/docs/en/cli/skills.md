...
Use [`openclaw plugins`](/en/cli/plugins) for plugin packages. The standalone
[ClawHub CLI](/en/clawhub/cli) handles [publishing](/en/clawhub/publishing), registry
maintenance, and [removing ClawHub skills](/en/cli/skills#remove-a-clawhub-skill).

Related:

- Skills system: [Skills](/en/tools/skills)
- Skill authoring: [Creating skills](/en/tools/creating-skills)
- Skill Workshop: [Skill Workshop](/en/tools/skill-workshop)
...
[Workshop inventory and usage](/en/tools/skill-workshop/reference#workshop-inventory-and-usage)
...
The default [skills watcher](/en/tools/skills#snapshots-and-refresh) picks up the
...
[personal library ownership and revisions](/en/tools/skills#personal-skills-on-a-shared-gateway).
...
[Skill Workshop](/en/tools/skill-workshop).
