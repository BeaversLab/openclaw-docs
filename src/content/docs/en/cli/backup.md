...
[Restore a full archive](/en/install/backups#restore-a-full-archive) for the full
...
[Cold transcript backups](/en/install/backups#cold-transcript-backups).
...
[`backupResources`](/en/plugins/manifest/surfaces#backupresources-reference). Disabled or
...
- [Migrating an OpenClaw install](/en/install/migrating)
- [Restore a full archive](/en/install/backups#restore-a-full-archive)
