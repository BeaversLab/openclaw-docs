...
See [Voice call plugin](/en/plugins/voice-call) for provider credentials and
webhook configuration, and [Apply changes and inspect](/en/plugins/manage-plugins#apply-changes-and-inspect)
