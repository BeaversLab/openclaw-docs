...
Enabling the plugin and writing the policy artifact. Part of the [`openclaw policy`](/en/cli/policy) reference.
...
Cross-cutting notes not obvious from the [rule tables](/en/cli/policy/rules):
