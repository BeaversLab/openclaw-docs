...
- Wide-area publishing behavior: [Bonjour discovery](/en/gateway/bonjour)
- Wide-area discovery config: [`discovery.wideArea`](/en/gateway/config-runtime#wide-area-dns-sd)
