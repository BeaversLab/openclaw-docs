...
- Install: [Google Play](https://play.google.com/store/apps/details?id=ai.openclaw.app&hl=en_IN) for the app, [Getting Started](/en/start/getting-started) for the Gateway, then [Pairing](/en/channels/pairing).
