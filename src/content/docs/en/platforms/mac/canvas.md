...
The recommended agent path is [`show_widget`](/en/tools/show-widget) with
...
remain available in Control UI chat and [session dashboard](/en/web/dashboards)
...
A2UI widgets render on [session dashboards](/en/web/dashboards), where they share
