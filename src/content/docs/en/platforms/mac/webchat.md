...
[Control UI](/en/web/control-ui) in an app window. To use native SwiftUI chat,
...
personal session. See [browser sign-in and website launch links](/en/platforms/mac/remote#connect-with-your-browser).
