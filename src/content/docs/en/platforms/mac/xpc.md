...
See [remote control](/en/platforms/mac/remote#macos-app-setup) for shell examples,
...
- See: [PeekabooBridge usage](/en/platforms/mac/peekaboo) for details.
...
- [macOS IPC flow (Exec approvals)](/en/tools/exec-approvals-advanced#macos-ipc-flow)
