...
its native `openclaw-mac` helper. [Voice Wake and push-to-talk](/en/platforms/mac/voicewake#requirements)
require macOS 26 or later.

The Node-based CLI and Gateway need a [supported Node version](/en/install/node)
...
[macOS developer setup](/en/platforms/mac/dev-setup#prerequisites).
...
the Gateway's website. See [browser sign-in](/en/platforms/mac/remote#connect-with-your-browser).
...
[paired node desktops](/en/gateway/config-browser-ui-desktop#paired-node-desktops).
...
[update guide](/en/install/updating), and Discord actions. Automatic repair never
...
For a saved Gateway added with [browser sign-in](/en/platforms/mac/remote#connect-with-your-browser),
...
| Understand launchd behavior              | [Gateway on macOS](/en/platforms/mac/bundled-gateway)                                          |
| Fix permissions or signing/TCC issues    | [macOS permissions](/en/platforms/mac/permissions)                                             |
| Detect the Mac you most recently used    | [Active computer presence](/en/nodes/presence)                                                 |
...
| Present hosted widgets in the Mac panel  | [Widget panel](/en/platforms/mac/canvas)                                                       |
