...
For Gateway installation and the desktop app itself, see [Linux](/en/platforms/linux).
...
See [Updating](/en/install/updating) for Gateway update guidance.
...
in the [Linux guide](/en/platforms/linux#quick-chat).

For setup help, use [OpenClaw support](/en/help). For a reproducible plugin or
