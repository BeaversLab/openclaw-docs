...
guide](/en/platforms/linux) applies in full. This page covers the ChromeOS
...
Full server guidance lives in the [Linux guide](/en/platforms/linux) and the
...
or a global `npm i -g openclaw@latest`) rather than [Docker](/en/install/docker).
...
See [Node install guidance](/en/install/node) for the supported versions.
...
See [Environment variables](/en/help/environment) for the full precedence and
source rules.
...
- [Linux guide](/en/platforms/linux)
- [Install overview](/en/install)
- [Node install guidance](/en/install/node)
- [Gateway runbook](/en/gateway)
