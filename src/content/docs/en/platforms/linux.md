...
Full Linux server guide: [Linux Server](/en/vps). Step-by-step VPS example: [exe.dev](/en/install/exe-dev)
...
setup. The full service guidance lives in the [Gateway runbook](/en/gateway).
