...
[Trusted proxy auth](/en/gateway/trusted-proxy-auth)); use dangerous auth
...
- [Platforms](/en/platforms) — the VPS and hosting index this page sits under
- [Docker](/en/install/docker) — the container image and environment variables this Compose file uses
- [Trusted proxy auth](/en/gateway/trusted-proxy-auth) — the auth mode used behind Caddy
- [Gateway runbook](/en/gateway) — operating the Gateway once it is up
