...
[Nodes](/en/nodes/command-policy#command-policy) for the full allow/deny model.
...
Run `openclaw gateway status --json`, then inspect the local [Gateway log](/en/gateway/logging).
