...
See [Scheduled Tasks](/en/automation/cron-jobs).
...
- [Scheduled Tasks](/en/automation/cron-jobs) — precise scheduling and one-shot reminders
- [Inferred Commitments](/en/concepts/commitments) — memory-like follow-up check-ins
