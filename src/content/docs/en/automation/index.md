...
| Trigger an agent from an external service | [Webhooks](/en/automation/cron-jobs#webhooks) | Authenticated HTTP ingress, not an internal event hook |
...
See [Background Tasks](/en/automation/tasks).
...
See [Task Flow](/en/automation/taskflow).
...
See [Standing Orders](/en/automation/standing-orders).
...
[automation](/en/automation/cron-jobs). Automations are an alternative with a
schedule and instructions you choose; they do not restore inferred follow-ups.

## Related

- [Automations](/en/automation/cron-jobs) — precise scheduling and one-shot reminders
- [IMAP email trigger](/en/automation/imap) — sender-gated inbound email and isolated reader sessions
- [Background Tasks](/en/automation/tasks) — task ledger for all detached work
- [Task Flow](/en/automation/taskflow) — durable multi-step flow orchestration
- [Hooks](/en/automation/hooks) — event-driven lifecycle scripts
- [Plugin hooks](/en/plugins/hooks) — in-process tool, prompt, message, and lifecycle hooks
- [Standing Orders](/en/automation/standing-orders) — persistent agent instructions
