...
Today, the supported CLI surface for inspecting and managing detached work is [`openclaw tasks`](/en/automation/tasks).
...
- [Background Tasks](/en/automation/tasks) — detached work ledger
- [CLI: flows](/en/cli/flows) — compatibility note for the mistaken command name
- [Cron Jobs](/en/automation/cron-jobs) — scheduled jobs that may create tasks
