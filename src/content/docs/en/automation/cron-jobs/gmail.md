...
Wiring Gmail inbox events into OpenClaw through Google Pub/Sub, with a restricted reader agent for untrusted mail. Part of the [Automations](/en/automation/cron-jobs) guide.

## Gmail PubSub integration

Wire Gmail inbox triggers to OpenClaw through Google Pub/Sub and `gog gmail watch serve`. Pub/Sub calls the watcher; the watcher forwards email data to the [Gateway HTTP hook](/en/automation/cron-jobs/webhooks#webhooks). This does not load or invoke an internal `HOOK.md` handler.
