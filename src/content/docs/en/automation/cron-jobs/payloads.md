...
What a job runs and where it runs: the four payload kinds, their flags, and the four session execution styles. Part of the [Automations](/en/automation/cron-jobs) guide.
...
[scheduled write support](/en/plugins/sdk-channel-plugins#scheduled-channel-administration).
