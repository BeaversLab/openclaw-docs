...
When a job fires: the five schedule kinds, cron expression rules, dynamic cadence, and condition watchers. Part of the [Automations](/en/automation/cron-jobs) guide.
