...
Hook file layout, the handler contract, reply delivery, and the `HOOK.md` metadata fields. Part of the [Hooks](/en/automation/hooks) guide.
...
[Reply delivery](/en/automation/hooks/writing-hooks#reply-delivery) for the exact boundary.
...
| `context`    | Event-specific data described under [Event context highlights](/en/automation/hooks/event-types#event-context-highlights) |
