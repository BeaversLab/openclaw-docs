...
Diagnosing a hook that is not discovered, not eligible, or not executing. Part of the [Hooks](/en/automation/hooks) guide.
...
[Hook discovery](/en/automation/hooks/configuration#hook-discovery).
...
under [Reply delivery](/en/automation/hooks/writing-hooks#reply-delivery), not just enablement.
