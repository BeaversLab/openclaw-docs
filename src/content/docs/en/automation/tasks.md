...
> **Cron vs Heartbeat vs Tasks?** See [Cron vs Heartbeat](/en/automation/cron-vs-heartbeat) for choosing the right scheduling mechanism. This page covers **tracking** background work, not scheduling it.
...
In the current codebase, the supported operator surface is `openclaw tasks`. See [ClawFlow](/en/automation/clawflow) and [CLI: flows](/en/cli/flows) for compatibility notes that map those older references to the current task commands.
...
- [Cron Jobs](/en/automation/cron-jobs) — scheduling background work
- [Cron vs Heartbeat](/en/automation/cron-vs-heartbeat) — choosing the right mechanism
- [Heartbeat](/en/gateway/heartbeat) — periodic main-session turns
- [CLI: flows](/en/cli/flows) — compatibility note for the mistaken command name
- [CLI: Tasks](/en/cli/index#tasks) — CLI command reference
