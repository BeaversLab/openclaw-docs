...
local path. Full flag reference: [`openclaw skills`](/en/cli/skills) and
...
directory. See [Remove a ClawHub skill](/en/cli/skills#remove-a-clawhub-skill) for
...
- [`openclaw skills`](/en/cli/skills) - local skill search, install, update, and
  verification
- [`openclaw plugins`](/en/cli/plugins) - plugin search, install, update, and
  inspection
- [ClawHub publishing](/en/clawhub/publishing) - owner scope, release validation,
  and review flow
- [Creating skills](/en/tools/creating-skills) - skill authoring and publish flow
- [Building plugins](/en/plugins/building-plugins) - plugin package authoring
