...
- [Hetzner](/en/install/hetzner) -- more cores/RAM per dollar.
- [Oracle Cloud](/en/install/oracle) -- Always Free ARM tier (up to 4 OCPU, 24 GB RAM), but signup can be finicky and it is ARM-only.
...
see the [backup symbolic-link caveat](/en/cli/backup#what-gets-backed-up).
Restore verifies and extracts into a fresh staging directory; activation is a
separate offline step. See [Restore a full archive](/en/install/backups#restore-a-full-archive)
