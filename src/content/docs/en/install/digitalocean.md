...
- [Hetzner](/en/install/hetzner) — €3.79/mo, more cores/RAM per dollar.
- [Oracle Cloud](/en/install/oracle) — Always Free ARM (up to 4 OCPU, 24 GB RAM), but signup can be finicky and ARM-only.
