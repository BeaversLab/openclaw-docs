...
guides such as [GCP](/en/install/gcp) and [Hetzner](/en/install/hetzner) own VM
...
supported environment variables, use the full [Docker guide](/en/install/docker).
...
migrations against the mounted state; see [Upgrading container images](/en/install/docker#upgrading-container-images)
