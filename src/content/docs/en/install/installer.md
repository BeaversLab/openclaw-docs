...
On FreeBSD, use the npm method described in [install-cli.sh](/en/install/installer#install-clish).
...
manual builds, follow [From source](/en/install#from-source) to select the
