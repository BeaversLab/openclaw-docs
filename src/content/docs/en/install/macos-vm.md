...
This is the killer feature of running on macOS. Use [iMessage](/en/channels/imessage) with `imsg` to add Messages to OpenClaw.
...
Restart the gateway. Your agent can now send and receive iMessages. Full setup details: [iMessage channel](/en/channels/imessage).
...
- [iMessage channel](/en/channels/imessage)
