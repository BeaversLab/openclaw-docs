...
Upgrade Node before updating OpenClaw to avoid SQLite TEXT truncation. See [Node.js compatibility](/en/install/node-compatibility) for the SQLite safety floors and macOS/ARMv7 support limits.
