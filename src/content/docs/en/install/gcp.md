...
This guide uses Debian on GCP Compute Engine. Ubuntu also works; map packages accordingly. For the generic Docker flow, see [Docker](/en/install/docker).
...
<Steps>
  ...
  <Step title="Shared Docker VM runtime steps">
    ...
    - [Bake required binaries into the image](/en/install/docker-vm-runtime#bake-required-binaries-into-the-image)
    - [Build and launch](/en/install/docker-vm-runtime#build-and-launch)
    - [What persists where](/en/install/docker-vm-runtime#what-persists-where)
    - [Updates](/en/install/docker-vm-runtime#updates)
  ...
  <Step title="Access from your laptop">
    ...
    See [Docker VM Runtime](/en/install/docker-vm-runtime#what-persists-where) for the shared persistence map and [update flow](/en/install/docker-vm-runtime#updates).
