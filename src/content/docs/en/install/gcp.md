...
in [Docker VM runtime](/en/install/docker-vm-runtime).
...
<Steps>
  ...
  <Step title="Review firewall access">
    ...
    follow [Gateway security](/en/gateway/security) rather than adding a broad
...
On the VM, follow [Docker VM runtime](/en/install/docker-vm-runtime) from
...
- [Docker VM Runtime](/en/install/docker-vm-runtime#update-openclaw)
