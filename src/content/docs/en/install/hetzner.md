...
This guide assumes Ubuntu or Debian on Hetzner. On another Linux VPS, map packages accordingly. For the generic Docker flow, see [Docker](/en/install/docker).
...
The shared persistence map lives in [Docker VM Runtime](/en/install/docker-vm-runtime#what-persists-where).
