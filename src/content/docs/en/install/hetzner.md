...
[Docker VM runtime](/en/install/docker-vm-runtime) page owns container setup,
...
[Gateway security](/en/gateway/security) and [VPS hosting](/en/vps).
...
<Steps>
  <Step title="Create the server">
    ...
    image described in [Docker VM runtime](/en/install/docker-vm-runtime). Add your
  ...
  <Step title="Restrict inbound traffic">
    ...
    tailnet, follow [Gateway security](/en/gateway/security) instead of opening the
...
On the VPS, follow [Docker VM runtime](/en/install/docker-vm-runtime) from
...
- [Updating](/en/install/docker-vm-runtime#update-openclaw)
