...
<Steps>
  ...
  <Step title="Run doctor">
    ...
    [Doctor](/en/gateway/doctor) checks for config or state issues after the import.
...
- [Migration guide](/en/install/migrating): all migration paths.
- [Migrating from Hermes](/en/install/migrating-hermes): the other cross-system import path.
- [Onboarding](/en/cli/onboard): wizard flow and non-interactive flags.
- [Doctor](/en/gateway/doctor): post-migration health check.
- [Agent workspace](/en/concepts/agent-workspace): where `AGENTS.md`, `USER.md`, and skills live.
