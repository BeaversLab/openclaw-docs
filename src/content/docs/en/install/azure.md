...
<Steps>
  ...
  <Step title="Install OpenClaw (in the VM shell)">
    ...
    The installer installs Node and dependencies if not already present, installs OpenClaw, and launches onboarding. See [Install](/en/install) for details.
  ...
  <Step title="Verify the gateway">
    ...
    If your organization already has GitHub Copilot licenses, you can choose the GitHub Copilot provider during onboarding instead of a separate model API key. See [GitHub Copilot provider](/en/providers/github-copilot).
