...
when a new version can restart each process. Part of the [Updating](/en/install/updating) guide.
...
[update workflow](/en/install/updating). The managed replacement consumes existing
