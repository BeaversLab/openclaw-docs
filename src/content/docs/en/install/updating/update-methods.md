...
Install-type switching, the source-server reference script, the installer, and manual package-manager updates. Part of the [Updating](/en/install/updating) guide.
...
Create a [verified backup](/en/install/updating/rollback-and-recovery#before-updating-create-a-verified-backup)
