...
Downgrades, automatic rollback, verified pre-update backups, and triage when an update leaves you stuck. Part of the [Updating](/en/install/updating) guide.
...
During recovery, prevent an enabled [auto-updater](/en/install/updating/automatic-updates#auto-updater) from immediately
...
installed identity, while its historical failed run remains unchanged. See [Triage](/en/cli/triage#installation-target-and-embedded-handoff) for the
