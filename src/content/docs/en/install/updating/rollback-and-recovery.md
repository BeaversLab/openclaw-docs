...
Use the installation's [manual package-manager update procedure](/en/install/updating/update-methods#alternative-manual-npm-pnpm-or-bun)
...
[post-failure triage](/en/install/updating#unattended-repair-on-your-own-inference)
...
[Triage](/en/cli/triage#installation-target-and-embedded-handoff) for installation
