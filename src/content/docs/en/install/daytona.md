...
Pairing codes expire after 1 hour. Full reference: [Telegram](/en/channels/telegram).
...
personal-number mode, and self-chat details: [WhatsApp](/en/channels/whatsapp).
...
- [Gateway remote access](/en/gateway/remote)
- [Gateway security](/en/gateway/security)
- [Updating OpenClaw](/en/install/updating)
