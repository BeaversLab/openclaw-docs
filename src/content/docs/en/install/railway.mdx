...
- [Telegram](/en/channels/telegram) (fastest -- just a bot token)
- [All channels](/en/channels)
...
This creates a portable backup archive with OpenClaw state plus any configured workspace. See [Backup](/en/cli/backup) for details.
