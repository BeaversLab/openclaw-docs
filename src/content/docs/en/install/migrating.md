...
<AccordionGroup>
  ...
  <Accordion title="Remote mode">
    ...
    Migrate the gateway host itself, not your local laptop. See [FAQ](/en/help/faq#where-things-live-on-disk).
  </Accordion>
...
- [Matrix migration](/en/install/migrating-matrix)
- [Uninstall](/en/install/uninstall)
