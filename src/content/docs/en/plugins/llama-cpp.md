...
Managed local models automatically use structured [Tool Search](/en/tools/tool-search)
...
declarations](/en/gateway/config-tools#custom-provider-capability-declarations).
...
- [LM Studio](/en/providers/lmstudio)
- [Llama Cpp plugin reference](/en/plugins/reference/llama-cpp) — manifest and config reference for the managed and external llama.cpp servers
