...
it to use Beam. See [Apply changes and inspect](/en/plugins/manage-plugins#apply-changes-and-inspect).
...
**`404 Not Found`** The Beam plugin is disabled, runtime application failed, or the request is reaching another Gateway. Check the enablement result and [inspect the plugin](/en/plugins/manage-plugins#apply-changes-and-inspect).
