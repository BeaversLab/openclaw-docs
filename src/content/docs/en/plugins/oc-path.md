...
The bundled `oc-path` plugin adds the [`openclaw path`](/en/cli/path) CLI for the
...
[CLI reference](/en/cli/path) for the full grammar, verb-by-verb flag list, and
...
- [`openclaw path` CLI reference](/en/cli/path)
