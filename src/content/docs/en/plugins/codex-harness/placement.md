...
How Codex sessions place native execution off the Gateway while the app-server, model connection, and transcript stay Gateway-owned. Part of the [Codex harness](/en/plugins/codex-harness) guide; [Where each section moved](/en/plugins/codex-harness#where-each-section-moved) lists every section.
...
Node.js release and npm. See [Bundle installation](/en/gateway/cloud-workers#bundle-installation)
