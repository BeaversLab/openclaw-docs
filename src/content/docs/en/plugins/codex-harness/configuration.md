...
The Codex harness configuration map and the turn-level behavior each setting controls. Part of the [Codex harness](/en/plugins/codex-harness) guide; [Where each section moved](/en/plugins/codex-harness#where-each-section-moved) lists every section.
...
[deployment shape and fail-closed routing](/en/plugins/codex-harness/routing),
[guardian approval policy](/en/plugins/codex-harness/app-server), and
[native Codex plugins and Computer Use](/en/plugins/codex-harness/native-features).
