...
What the Codex harness owns during a turn, and what stays with OpenClaw. Part of the [Codex harness](/en/plugins/codex-harness) guide; [Where each section moved](/en/plugins/codex-harness#where-each-section-moved) lists every section.
