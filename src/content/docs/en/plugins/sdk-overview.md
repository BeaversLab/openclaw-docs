...
<Tip>
Looking for a how-to guide instead? Start with [Building plugins](/en/plugins/building-plugins), use [Channel plugins](/en/plugins/sdk-channel-plugins) for channel plugins, [Provider plugins](/en/plugins/sdk-provider-plugins) for provider plugins, and [Plugin hooks](/en/plugins/hooks) for tool or lifecycle hook plugins.
</Tip>
