...
How final assistant text reaches the source conversation, and what happens when a Codex turn settles without one. Part of the [Codex harness runtime](/en/plugins/codex-harness-runtime) guide; [Where each section moved](/en/plugins/codex-harness-runtime#where-each-section-moved) lists every section.
...
[reply-media capability](/en/plugins/sdk-agent-harness/attempt-runtime#reply-attachments-from-a-remote-workspace)
