...
Thread binding rules for ordinary and supervised Codex sessions, including safe continuation from an existing native thread. Part of the [Codex harness runtime](/en/plugins/codex-harness-runtime) guide; [Where each section moved](/en/plugins/codex-harness-runtime#where-each-section-moved) lists every section.
