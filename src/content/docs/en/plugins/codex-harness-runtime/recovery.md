...
What OpenClaw does about registered Codex app-server children when the Gateway stops without cleaning up. Part of the [Codex harness runtime](/en/plugins/codex-harness-runtime) guide; [Where each section moved](/en/plugins/codex-harness-runtime#where-each-section-moved) lists every section.
