...
Sending messages into a running Codex turn, and uploading Codex thread logs with diagnostics. Part of the [Codex harness runtime](/en/plugins/codex-harness-runtime) guide; [Where each section moved](/en/plugins/codex-harness-runtime#where-each-section-moved) lists every section.
