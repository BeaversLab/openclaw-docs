...
Who owns compaction on a Codex turn, and what the OpenClaw transcript mirror keeps. Part of the [Codex harness runtime](/en/plugins/codex-harness-runtime) guide; [Where each section moved](/en/plugins/codex-harness-runtime#where-each-section-moved) lists every section.
