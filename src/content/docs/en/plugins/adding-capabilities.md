...
<Info>
  ...
  load pipeline, runtime helpers), see [Plugin internals](/en/plugins/architecture).
</Info>
...
- [Plugin internals](/en/plugins/architecture) — capability model, ownership, load pipeline, runtime helpers.
