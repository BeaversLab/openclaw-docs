...
[Building plugins](/en/plugins/building-plugins), [Channel Plugins](/en/plugins/sdk-channel-plugins),
or [Provider Plugins](/en/plugins/sdk-provider-plugins) instead.
...
`api.registerTool` examples in [Building Plugins](/en/plugins/building-plugins).
...
behavior in place. See [Progress drafts](/en/concepts/progress-drafts).
...
[Code Mode](/en/tools/code-mode) and [Tool Search](/en/tools/tool-search) turn this
...
After later source or manifest edits, use [plugin Reload](/en/cli/plugins#reload).
...
- [ClawHub publishing](/en/clawhub/publishing)
