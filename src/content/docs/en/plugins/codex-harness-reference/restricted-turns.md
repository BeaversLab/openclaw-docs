...
Which tool policies push a Codex turn onto the restricted native surface. Part of the [Codex harness reference](/en/plugins/codex-harness-reference); [Where each section moved](/en/plugins/codex-harness-reference#where-each-section-moved) lists every section.
