...
Which credential a Codex turn uses, and what the app-server child process inherits. Part of the [Codex harness reference](/en/plugins/codex-harness-reference); [Where each section moved](/en/plugins/codex-harness-reference#where-each-section-moved) lists every section.
...
[Credentials and account ownership](/en/plugins/codex-harness/native-features#credentials-and-account-ownership).
...
list above. Other agents [inherit the shared profile](/en/auth-credential-semantics#agent-copy-portability),
