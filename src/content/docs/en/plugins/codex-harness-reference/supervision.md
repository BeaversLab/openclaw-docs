...
Native session discovery for the sidebar and the agent-facing supervision policy. Part of the [Codex harness reference](/en/plugins/codex-harness-reference); [Where each section moved](/en/plugins/codex-harness-reference#where-each-section-moved) lists every section.
