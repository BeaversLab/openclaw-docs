...
normal config writes apply the same [utility-model migration](/en/gateway/config-agents/models#agentsdefaultsmodel).
...
See [Model providers](/en/concepts/model-providers) for other inference options.
