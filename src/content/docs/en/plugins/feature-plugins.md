...
Enable the [Custom plugin UI lab](/en/plugins/feature-plugins#enable-custom-plugin-ui) before opening the
...
Backend changes use [plugin update or Reload](/en/cli/plugins/uninstall-and-update)
...
For the underlying manifest fields, see [Plugin manifest](/en/plugins/manifest).
For install, update, and removal, see [Manage plugins](/en/plugins/manage-plugins).
