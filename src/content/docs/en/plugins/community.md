...
by the community, published on [ClawHub](/en/tools/clawhub) or npm, and
...
[QQ Bot](/en/channels/qqbot) for normal installs; install this external plugin only
...
<Steps>
  <Step title="Publish to ClawHub or npm">
    ...
    Publish to [ClawHub](/en/tools/clawhub) (preferred) or npm.
...
- [Install and Configure Plugins](/en/tools/plugin) — how to install any plugin
- [Building Plugins](/en/plugins/building-plugins) — create your own
