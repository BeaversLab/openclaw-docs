...
tools, providers, hooks, or other capabilities. Use [ClawHub](/en/clawhub) as the
...
Use [Manage plugins](/en/plugins/manage-plugins) for common install, update,
inspect, and uninstall examples. Use [`openclaw plugins`](/en/cli/plugins) for the
...
- [Manage plugins](/en/plugins/manage-plugins) - command examples
- [ClawHub publishing](/en/clawhub/publishing) - publish and release rules
