...
[ClawHub](/en/clawhub) as the primary discovery surface for public community
plugins.
...
inspect, and uninstall examples. Use [`openclaw plugins`](/en/cli/plugins) for
...
- [ClawHub publishing](/en/clawhub/publishing) - owners, scopes, releases,
  review, package validation, and package transfer
- [Building plugins](/en/plugins/building-plugins) - the plugin package shape
  and first publish workflow
- [Plugin manifest](/en/plugins/manifest) - native plugin manifest fields
