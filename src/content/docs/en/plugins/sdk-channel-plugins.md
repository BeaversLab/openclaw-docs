...
[Channel outbound API](/en/plugins/sdk-channel-outbound).
...
[Channel ingress API](/en/plugins/sdk-channel-ingress) for the API design,
...
See [Channel outbound API](/en/plugins/sdk-channel-outbound#durable-ingress-monitors)
