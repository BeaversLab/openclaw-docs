...
reader to the [Control UI](/en/web/control-ui). It is separate from the
[GitHub Copilot model provider](/en/providers/github-copilot).
...
[Plugin SDK](/en/plugins/sdk-overview/host-hooks#docked-link-readers). The plugin owns URL matching, GitHub API
