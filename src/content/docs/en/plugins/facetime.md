...
[SecretRef](/en/gateway/secrets) instead of storing the key in configuration.
...
See [FaceTime recovery and removal](/en/plugins/facetime-recovery) to restore the
...
[driver recovery steps](/en/plugins/facetime-recovery#recover-a-failed-driver-update).
...
Follow [FaceTime recovery and removal](/en/plugins/facetime-recovery) to restart the
...
| Setup reports debugger attachment is blocked | Check developer-tools access and SIP debugging status in [Prepare the Mac](/en/plugins/facetime#prepare-the-mac).                                         |
| Audio driver installation fails              | Verify full Xcode is installed at `/Applications/Xcode.app`, then follow [driver recovery](/en/plugins/facetime-recovery#recover-a-failed-driver-update). |
...
| Slow tool-backed responses                   | Use [Gateway logs](/en/logging) and [session inspection](/en/cli/sessions) to distinguish agent response time from tool execution time.                      |
...
- [Configuration reference](/en/plugins/reference/facetime)
- [FaceTime recovery and removal](/en/plugins/facetime-recovery)
- [Plugin management](/en/plugins/manage-plugins)
- [Secrets](/en/gateway/secrets)
