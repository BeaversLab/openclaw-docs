...
- Chrome participation uses a signed-in Chrome profile, optionally on a paired node. Twilio participation dials a phone number plus PIN/DTMF through the [Voice call plugin](/en/plugins/voice-call); it cannot dial a Meet URL directly.
...
[Google Meet transports and hosts](/en/plugins/google-meet/transports) — Chrome, Chrome node, and Twilio transports, the Parallels macOS VM topology, and the host audio tools they need.

- <a id="local-gateway-%2B-parallels-chrome"></a><a id="local-gateway-+-parallels-chrome"></a>[Local Gateway + Parallels Chrome](/en/plugins/google-meet/transports#local-gateway-%2B-parallels-chrome)
- <a id="common-failure-checks"></a>[Common failure checks](/en/plugins/google-meet/transports#common-failure-checks)
- <a id="install-notes"></a>[Install notes](/en/plugins/google-meet/transports#install-notes)
- <a id="transports"></a>[Transports](/en/plugins/google-meet/transports#transports)
- <a id="chrome"></a>[Chrome](/en/plugins/google-meet/transports#chrome)
- <a id="twilio"></a>[Twilio](/en/plugins/google-meet/transports#twilio)

### Google Meet OAuth and artifacts

[Google Meet OAuth and artifacts](/en/plugins/google-meet/oauth-and-artifacts) — Google Cloud credentials, the refresh token, OAuth verification, and reading Meet artifacts, attendance, and exports.

- <a id="oauth-and-preflight"></a>[OAuth and preflight](/en/plugins/google-meet/oauth-and-artifacts#oauth-and-preflight)
- <a id="create-google-credentials"></a>[Create Google credentials](/en/plugins/google-meet/oauth-and-artifacts#create-google-credentials)
- <a id="create-or-select-a-project"></a>[Create or select a project](/en/plugins/google-meet/oauth-and-artifacts#create-or-select-a-project)
- <a id="enable-the-google-meet-rest-api"></a>[Enable the Google Meet REST API](/en/plugins/google-meet/oauth-and-artifacts#enable-the-google-meet-rest-api)
- <a id="configure-the-oauth-consent-screen"></a>[Configure the OAuth consent screen](/en/plugins/google-meet/oauth-and-artifacts#configure-the-oauth-consent-screen)
- <a id="add-the-requested-scopes"></a>[Add the requested scopes](/en/plugins/google-meet/oauth-and-artifacts#add-the-requested-scopes)
- <a id="create-an-oauth-client-id"></a>[Create an OAuth client ID](/en/plugins/google-meet/oauth-and-artifacts#create-an-oauth-client-id)
- <a id="copy-the-client-id-and-client-secret"></a>[Copy the client ID and client secret](/en/plugins/google-meet/oauth-and-artifacts#copy-the-client-id-and-client-secret)
- <a id="mint-the-refresh-token"></a>[Mint the refresh token](/en/plugins/google-meet/oauth-and-artifacts#mint-the-refresh-token)
- <a id="verify-oauth-with-doctor"></a>[Verify OAuth with doctor](/en/plugins/google-meet/oauth-and-artifacts#verify-oauth-with-doctor)
- <a id="resolve%2C-preflight%2C-and-read-artifacts"></a><a id="resolve-preflight-and-read-artifacts"></a>[Resolve, preflight, and read artifacts](/en/plugins/google-meet/oauth-and-artifacts#resolve%2C-preflight%2C-and-read-artifacts)
- <a id="live-smoke-test"></a>[Live smoke test](/en/plugins/google-meet/oauth-and-artifacts#live-smoke-test)
- <a id="create-examples"></a>[Create examples](/en/plugins/google-meet/oauth-and-artifacts#create-examples)

### Google Meet configuration

[Google Meet configuration](/en/plugins/google-meet/config) — Plugin config defaults, optional overrides, and the ElevenLabs and Twilio config examples.

- <a id="config"></a>[Config](/en/plugins/google-meet/config#config)
- <a id="defaults"></a>[Defaults](/en/plugins/google-meet/config#defaults)
- <a id="optional-overrides"></a>[Optional overrides](/en/plugins/google-meet/config#optional-overrides)

### Google Meet tool and modes

[Google Meet tool and modes](/en/plugins/google-meet/tool-and-modes) — Tool actions for agents, session status fields, and the agent and bidi talk-back modes.

- <a id="tool"></a>[Tool](/en/plugins/google-meet/tool-and-modes#tool)
- <a id="agent-and-bidi-modes"></a>[Agent and bidi modes](/en/plugins/google-meet/tool-and-modes#agent-and-bidi-modes)

### Google Meet troubleshooting

[Google Meet troubleshooting](/en/plugins/google-meet/troubleshooting) — The pre-flight live test checklist and fixes for join, speech, creation, and Twilio failures.

- <a id="live-test-checklist"></a>[Live test checklist](/en/plugins/google-meet/troubleshooting#live-test-checklist)
- <a id="troubleshooting"></a>[Troubleshooting](/en/plugins/google-meet/troubleshooting#troubleshooting)
- <a id="agent-cannot-see-the-google-meet-tool"></a>[Agent cannot see the Google Meet tool](/en/plugins/google-meet/troubleshooting#agent-cannot-see-the-google-meet-tool)
- <a id="no-connected-google-meet-capable-node"></a>[No connected Google Meet-capable node](/en/plugins/google-meet/troubleshooting#no-connected-google-meet-capable-node)
- <a id="browser-opens-but-agent-cannot-join"></a>[Browser opens but agent cannot join](/en/plugins/google-meet/troubleshooting#browser-opens-but-agent-cannot-join)
- <a id="meeting-creation-fails"></a>[Meeting creation fails](/en/plugins/google-meet/troubleshooting#meeting-creation-fails)
- <a id="agent-joins-but-does-not-talk"></a>[Agent joins but does not talk](/en/plugins/google-meet/troubleshooting#agent-joins-but-does-not-talk)
- <a id="twilio-setup-checks-fail"></a>[Twilio setup checks fail](/en/plugins/google-meet/troubleshooting#twilio-setup-checks-fail)
- <a id="twilio-call-starts-but-never-enters-the-meeting"></a>[Twilio call starts but never enters the meeting](/en/plugins/google-meet/troubleshooting#twilio-call-starts-but-never-enters-the-meeting)

## Related

- [Meeting plugins overview](/en/plugins/meeting-plugins)
- [Voice call plugin](/en/plugins/voice-call)
- [Talk mode](/en/nodes/talk)
- [ElevenLabs](/en/providers/elevenlabs) — the speech and transcription provider used in the Meet config examples
