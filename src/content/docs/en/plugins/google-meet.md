...
A strict dial plan delegated to the [Voice call plugin](/en/plugins/voice-call). It does not parse Meet pages for phone numbers; Google Meet must expose a phone dial-in number and PIN for the meeting.
