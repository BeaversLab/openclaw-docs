...
[Bound native session ownership](/en/plugins/sdk-agent-harness#bound-native-session-ownership) separately
...
[Codex Harness](/en/plugins/codex-harness). It checks the initialize handshake and
...
[runtime media contract](/en/plugins/sdk-runtime) for limits and older-host behavior.
