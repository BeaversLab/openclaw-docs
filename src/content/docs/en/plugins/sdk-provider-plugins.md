...
<Tip>
  ...
  harness](/en/plugins/sdk-agent-harness) instead of putting daemon protocol
  details in core.
</Tip>
...
<Steps>
  ...
  <Step title="Register the provider">
    ...
    timeline](/en/plugins/sdk-migration/removal-timeline) for the dates and gates
    ...
    catalogs](/en/plugins/sdk-provider-plugins/model-catalogs).
  ...
  <Step title="Add runtime hooks (as needed)">
    ...
    families](/en/plugins/sdk-provider-plugins/hook-families), then wire individual
    hooks with [Provider hook wiring](/en/plugins/sdk-provider-plugins/runtime-hooks).
  ...
  <Step title="Add extra capabilities (optional)">
    ...
    **hybrid-capability** plugin - the recommended pattern for company plugins
    ...
    capabilities](/en/plugins/sdk-provider-plugins/voice-and-audio). Register
    embeddings, generation, fetch, and search from [Provider media and
    search](/en/plugins/sdk-provider-plugins/media-and-search).
...
- [Plugin Internals](/en/plugins/architecture-internals#provider-runtime-hooks) - hook details and bundled examples
...
[Provider model catalogs](/en/plugins/sdk-provider-plugins/model-catalogs) — Live model discovery, catalog helpers, pricing normalization, and the single-provider entry helper.

- <a id="live-model-discovery"></a>[Live model discovery](/en/plugins/sdk-provider-plugins/model-catalogs#live-model-discovery)

### Provider hook families

[Provider hook families](/en/plugins/sdk-provider-plugins/hook-families) — Shared replay, stream, and tool-compat family builders and the SDK seams behind them.

- <a id="sdk-seams-powering-the-family-builders"></a>[SDK seams powering the family builders](/en/plugins/sdk-provider-plugins/hook-families#sdk-seams-powering-the-family-builders)

### Provider hook wiring

[Provider hook wiring](/en/plugins/sdk-provider-plugins/runtime-hooks) — Per-hook wiring for auth exchange, headers, transport identity, usage, and the hook order table.

- <a id="token-exchange"></a>[Token exchange](/en/plugins/sdk-provider-plugins/runtime-hooks#token-exchange)
- <a id="custom-headers"></a>[Custom headers](/en/plugins/sdk-provider-plugins/runtime-hooks#custom-headers)
- <a id="native-transport-identity"></a>[Native transport identity](/en/plugins/sdk-provider-plugins/runtime-hooks#native-transport-identity)
- <a id="usage-and-billing"></a>[Usage and billing](/en/plugins/sdk-provider-plugins/runtime-hooks#usage-and-billing)
- <a id="common-provider-hooks"></a>[Common provider hooks](/en/plugins/sdk-provider-plugins/runtime-hooks#common-provider-hooks)

### Provider voice capabilities

[Provider voice capabilities](/en/plugins/sdk-provider-plugins/voice-and-audio) — Speech, realtime transcription, realtime voice, and media understanding capabilities.

- <a id="speech-tts"></a>[Speech (TTS)](/en/plugins/sdk-provider-plugins/voice-and-audio#speech-tts)
- <a id="realtime-transcription"></a>[Realtime transcription](/en/plugins/sdk-provider-plugins/voice-and-audio#realtime-transcription)
- <a id="realtime-voice"></a>[Realtime voice](/en/plugins/sdk-provider-plugins/voice-and-audio#realtime-voice)
- <a id="media-understanding"></a>[Media understanding](/en/plugins/sdk-provider-plugins/voice-and-audio#media-understanding)

### Provider media and search

[Provider media and search](/en/plugins/sdk-provider-plugins/media-and-search) — Embeddings, image and video generation, web fetch, and web search capabilities.

- <a id="embeddings"></a>[Embeddings](/en/plugins/sdk-provider-plugins/media-and-search#embeddings)
- <a id="image-and-video-generation"></a>[Image and video generation](/en/plugins/sdk-provider-plugins/media-and-search#image-and-video-generation)
- <a id="web-fetch-and-search"></a>[Web fetch and search](/en/plugins/sdk-provider-plugins/media-and-search#web-fetch-and-search)

## Related

- [Plugin SDK setup](/en/plugins/sdk-setup)
- [Building plugins](/en/plugins/building-plugins)
- [Building channel plugins](/en/plugins/sdk-channel-plugins)
