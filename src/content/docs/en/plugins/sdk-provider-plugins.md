...
<Tip>
  ...
  events, pair the provider with an [agent harness](/en/plugins/sdk-agent-harness)
...
<Steps>
  ...
  <Step title="Add runtime hooks (as needed)">
    ...
    <Accordion title="All available provider hooks">
      ...
      For detailed descriptions and real-world examples, see [Internals: Provider Runtime Hooks](/en/plugins/architecture-internals#provider-runtime-hooks).
    </Accordion>
