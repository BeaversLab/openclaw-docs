...
See [Building plugins](/en/plugins/building-plugins) for native plugin authoring
and [Plugins](/en/tools/plugin) for the main install workflow.
...
- [Plugins](/en/tools/plugin) - install, configure, and troubleshoot plugins
- [Manage plugins](/en/plugins/manage-plugins) - common plugin CLI examples
- [Plugin inventory](/en/plugins/plugin-inventory) - generated bundled and external plugin list
- [Plugin manifest](/en/plugins/manifest) - native plugin manifest schema
- [Building plugins](/en/plugins/building-plugins) - create a native plugin
