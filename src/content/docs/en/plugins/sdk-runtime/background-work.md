...
Start agent work in the background: hook-dispatched turns for external content, subagent runs, and the Task Flow records that track them. Part of the [Plugin runtime helpers](/en/plugins/sdk-runtime) reference.
...
<AccordionGroup>
  ...
  <Accordion title="api.runtime.tasks">
    ...
    workflows, use [managed Lobster execution](/en/automation/taskflow#run-a-managed-lobster-workflow).
    ...
    **State without a child**
    ...
    [Task Flow](/en/automation/taskflow) for durability and cancellation.
