...
Channel-specific runtime helpers, available when a channel plugin is loaded. Part of the [Plugin runtime helpers](/en/plugins/sdk-runtime) reference; [Channel plugins](/en/plugins/sdk-channel-plugins) is the step-by-step guide.
