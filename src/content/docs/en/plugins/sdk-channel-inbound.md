...
- `buildChannelInboundEventContext(...)`: projects normalized channel facts
  ...
  [channel ingress](/en/plugins/sdk-channel-ingress) resolver result as
...
[removal timeline](/en/plugins/sdk-migration/removal-timeline). New plugins should
...
See [Broadcast groups](/en/channels/broadcast-groups) for the operator config and
[Inbound mention policy](/en/plugins/sdk-channel-plugins#inbound-mention-policy)
...
[Channel outbound API](/en/plugins/sdk-channel-outbound) for new preview paths.
...
- [Channel ingress API](/en/plugins/sdk-channel-ingress) — the resolver whose result this page consumes as `channelIngress`
- [Channel outbound API](/en/plugins/sdk-channel-outbound) — the send side of the same channel plugin
- [Building channel plugins](/en/plugins/sdk-channel-plugins) — the full channel plugin walkthrough
