...
Follow the dated removal-eligibility window in [Migration](/en/plugins/sdk-migration).
...
- [Channel inbound API](/en/plugins/sdk-channel-inbound) — the receive side that records and dispatches before a reply is sent
- [Channel ingress API](/en/plugins/sdk-channel-ingress) — the resolver that produces the participant identity a send is attributed to
- [Building channel plugins](/en/plugins/sdk-channel-plugins) — the full channel plugin walkthrough
- [Plugin SDK subpaths](/en/plugins/sdk-subpaths) — which subpath exports each helper
- [Plugin SDK migration](/en/plugins/sdk-migration) — removal-eligibility windows for legacy outbound exports
