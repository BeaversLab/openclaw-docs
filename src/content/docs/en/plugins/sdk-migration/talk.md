...
The unified Talk session controller, its supported session combinations, and the method map from the removed Talk families. Part of the [Plugin SDK migration](/en/plugins/sdk-migration) guide.
