...
The ordered migration steps. Work through them in order; each step is self-contained. Part of the [Plugin SDK migration](/en/plugins/sdk-migration) guide.
...
<Steps>
  ...
  <Step title="Replace with focused imports">
    ...
    see [Retained channel facade mappings](/en/plugins/sdk-migration/import-paths#retained-channel-facade-mappings)
