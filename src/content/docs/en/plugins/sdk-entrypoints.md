...
- External session catalogs use
  ...
  [session creator](/en/plugins/sdk-runtime); the host bounds and stores that snapshot
  ...
  Use
  [`api.runtime.agent.resolveSessionCatalogCreateTarget(...)`](/en/plugins/sdk-runtime#api-runtime-agent)
...
unconfigured. See
[Setup and Config](/en/plugins/sdk-setup#setup-entry) for when this matters.
...
- [Setup and Config](/en/plugins/sdk-setup) - manifest and setup entry loading
