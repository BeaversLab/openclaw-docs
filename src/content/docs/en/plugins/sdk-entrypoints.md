...
All plugin APIs are [experimental](/en/plugins/sdk-overview#api-stability),
including these entry helpers. Pin and test the OpenClaw host versions your
plugin supports.

<Tip>
  **Looking for a walkthrough?** See [Tool Plugins](/en/plugins/tool-plugins),
  [Channel Plugins](/en/plugins/sdk-channel-plugins), or
  [Provider Plugins](/en/plugins/sdk-provider-plugins) for step-by-step guides.
</Tip>
...
- <a id="tool-policy-vocabulary" />[Tool policy vocabulary](/en/plugins/sdk-entrypoints/tool-policy-and-sandbox#tool-policy-vocabulary)
- <a id="sandbox-bind-parsing" />[Sandbox bind parsing](/en/plugins/sdk-entrypoints/tool-policy-and-sandbox#sandbox-bind-parsing)
- <a id="package-entries" />[Package entries](/en/plugins/sdk-entrypoints/package-entries#package-entries)
- <a id="definetoolplugin" />[defineToolPlugin](/en/plugins/sdk-entrypoints/define-tool-plugin#definetoolplugin)
- <a id="definepluginentry" />[definePluginEntry](/en/plugins/sdk-entrypoints/define-plugin-entry#definepluginentry)
- <a id="native-provider-factories" />[Native provider factories](/en/plugins/sdk-entrypoints/native-providers#native-provider-factories)
- <a id="computer-use-providers" />[Computer Use providers](/en/plugins/sdk-entrypoints/native-providers#computer-use-providers)
- <a id="definechannelpluginentry" />[defineChannelPluginEntry](/en/plugins/sdk-entrypoints/define-channel-plugin-entry#definechannelpluginentry)
- <a id="definesetuppluginentry" />[defineSetupPluginEntry](/en/plugins/sdk-entrypoints/define-setup-plugin-entry#definesetuppluginentry)
- <a id="registration-mode" />[Registration mode](/en/plugins/sdk-entrypoints/registration-mode#registration-mode)
...
- [Plugin SDK overview](/en/plugins/sdk-overview) - registration API and subpath reference
- [Plugin runtime helpers](/en/plugins/sdk-runtime) - `api.runtime` and `createPluginRuntimeStore`
- [Plugin setup and config](/en/plugins/sdk-setup) - manifest and setup entry loading
- [Building channel plugins](/en/plugins/sdk-channel-plugins) - building the `ChannelPlugin` object
- [Building provider plugins](/en/plugins/sdk-provider-plugins) - provider registration and hooks
- [Decision models](/en/plugins/sdk-overview/capabilities#decision-models-contract-version-1) - `openclaw/plugin-sdk/decisions` and the typed decision provider contract
