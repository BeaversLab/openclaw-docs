...
See [Run Codex on a paired device](/en/plugins/codex-harness#run-codex-on-a-paired-device)
and [Run Codex on a cloud worker](/en/plugins/codex-harness#run-codex-on-a-cloud-worker).
