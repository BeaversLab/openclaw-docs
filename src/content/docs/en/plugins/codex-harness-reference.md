...
or login. See [Native CLI starts](/en/web/control-ui/sessions-and-sidebar#start-a-native-coding-cli).
...
[Computer Use](/en/plugins/codex-computer-use) is enabled, or when `homeScope` is
...
See [Run Codex on a paired device](/en/plugins/codex-harness/placement#run-codex-on-a-paired-device)
and [Run Codex on a cloud worker](/en/plugins/codex-harness/placement#run-codex-on-a-cloud-worker).
...
one. It delivers the [settled-tool fallback](/en/plugins/codex-harness-runtime#final-answers-after-settled-tool-work)
...
See [Hook boundaries](/en/plugins/codex-harness-runtime#hook-boundaries) for recovery.
