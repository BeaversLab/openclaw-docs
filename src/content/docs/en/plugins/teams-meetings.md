...
Talk-back uses the same local audio prerequisites as the [Google Meet plugin](/en/plugins/google-meet): macOS, the `BlackHole 2ch` virtual audio device, and SoX.
