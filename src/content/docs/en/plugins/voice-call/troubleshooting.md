...
Fixes for setup, webhook exposure, credentials, signature verification, Google Meet dial-in, and silent realtime calls. Part of the [Voice call plugin](/en/plugins/voice-call) guide.
...
[Hot reload](/en/gateway/configuration/hot-reload)). After application, run:
