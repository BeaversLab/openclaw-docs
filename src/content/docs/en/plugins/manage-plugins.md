...
rules, and edge cases, see [`openclaw plugins`](/en/cli/plugins).
...
- **Installed** shows the full local inventory grouped by category (channels,
  ...
  [MCP servers](/en/cli/mcp) with the same menu-driven enable, disable, and remove
...
- [Plugins](/en/tools/plugin) - install, configure, restart, and troubleshoot
