...
[`openclaw plugins`](/en/cli/plugins#update).
...
- [ClawHub publishing](/en/clawhub/publishing) explains owners, scopes, releases,
  review, package validation, and package transfer.
- [Building plugins](/en/plugins/building-plugins) shows the plugin package shape
  and first publish workflow.
- [Plugin manifest](/en/plugins/manifest) defines native plugin manifest fields.
