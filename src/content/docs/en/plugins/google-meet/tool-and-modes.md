...
Tool actions for agents, session status fields, and the agent and bidi talk-back modes. Part of the [Google Meet plugin](/en/plugins/google-meet) guide.
