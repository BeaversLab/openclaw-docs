...
For compatible bundle layouts, see [Plugin bundles](/en/plugins/bundles).
...
See the full plugin system guide: [Plugins](/en/tools/plugin).
...
order](/en/gateway/configuration-reference#plugin-scan-order). If two discoveries
