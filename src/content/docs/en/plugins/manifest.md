...
This page covers the **native OpenClaw plugin manifest**, `openclaw.plugin.json`. For compatible bundle layouts (Agent Plugins, Codex, Claude, Cursor), see [Plugin bundles](/en/plugins/bundles).
...
See [Plugins](/en/tools/plugin) for the full plugin system guide, and [Capability model](/en/plugins/architecture#public-capability-model) for the native capability model and current external-compatibility guidance.
...
- QA runner metadata the shared [`openclaw qa`](/en/concepts/qa-e2e-automation) host can inspect
...
[Manifest model fields](/en/plugins/manifest/models) — Manifest model catalog, shorthand family, id normalization, and pricing fields.

- <a id="modelsupport-reference"></a>[`modelSupport`](/en/plugins/manifest/models#modelsupport-reference)
- <a id="modelcatalog-reference"></a>[`modelCatalog`](/en/plugins/manifest/models#modelcatalog-reference)
- <a id="modelidnormalization-reference"></a>[`modelIdNormalization`](/en/plugins/manifest/models#modelidnormalization-reference)
- <a id="modelpricing-reference"></a>[`modelPricing`](/en/plugins/manifest/models#modelpricing-reference)
- <a id="openclaw-provider-index"></a>[OpenClaw Provider Index](/en/plugins/manifest/models#openclaw-provider-index)

### Provider fields

[Manifest provider fields](/en/plugins/manifest/providers) — Manifest generation, media-understanding, endpoint, and request provider metadata.

- <a id="generation-provider-metadata-reference"></a>[`imageGenerationProviderMetadata`, `videoGenerationProviderMetadata`, `musicGenerationProviderMetadata`](/en/plugins/manifest/providers#generation-provider-metadata-reference)
- <a id="mediaunderstandingprovidermetadata-reference"></a>[`mediaUnderstandingProviderMetadata`](/en/plugins/manifest/providers#mediaunderstandingprovidermetadata-reference)
- <a id="providerendpoints-reference"></a>[`providerEndpoints`](/en/plugins/manifest/providers#providerendpoints-reference)
- <a id="providerrequest-reference"></a>[`providerRequest`](/en/plugins/manifest/providers#providerrequest-reference)

### Setup and auth fields

[Manifest setup and auth fields](/en/plugins/manifest/setup-and-auth) — Manifest setup descriptors, auth choices, conversation discovery, and config UI hints.

- <a id="native-conversation-discovery"></a>[`setup.nativeSessionCatalog`](/en/plugins/manifest/setup-and-auth#native-conversation-discovery)
- <a id="providerauthchoices-reference"></a>[`providerAuthChoices`](/en/plugins/manifest/setup-and-auth#providerauthchoices-reference)
- <a id="setup-reference"></a>[`setup`, `providerUsageAuthEnvVars`](/en/plugins/manifest/setup-and-auth#setup-reference)
- <a id="setup.providers-reference"></a><a id="setup-providers-reference"></a>[`setup.providers`](/en/plugins/manifest/setup-and-auth#setup-providers-reference)
- <a id="setup-fields"></a>[`setup` field table](/en/plugins/manifest/setup-and-auth#setup-fields)
- [`configGroups`](/en/plugins/manifest/setup-and-auth#configgroups-reference)
- <a id="uihints-reference"></a>[`uiHints`](/en/plugins/manifest/setup-and-auth#uihints-reference)

### Capability fields

[Manifest capability fields](/en/plugins/manifest/capabilities) — Manifest capability ownership, tool availability metadata, and activation planning.

- <a id="contracts-reference"></a>[`contracts`](/en/plugins/manifest/capabilities#contracts-reference)
- [`decisionModels`](/en/plugins/manifest/capabilities#decision-models-reference)
- <a id="tool-metadata-reference"></a>[`toolMetadata`](/en/plugins/manifest/capabilities#tool-metadata-reference)
- <a id="activation-reference"></a>[`activation`](/en/plugins/manifest/capabilities#activation-reference)

### Host surface fields

[Manifest host surface fields](/en/plugins/manifest/surfaces) — Manifest fields for icons, CLI, MCP, Control UI, dashboard, QA, channel, and backup surfaces.

- <a id="plugin-icon"></a>[Plugin icon, `doctorContract`, `doctorHealthChecks`, `sessionRouteStateOwners`](/en/plugins/manifest/surfaces#plugin-icon)
- <a id="transcript-sources-reference"></a>[`transcriptSources`](/en/plugins/manifest/surfaces#transcript-sources-reference)
- <a id="backupresources-reference"></a>[`backupResources`](/en/plugins/manifest/surfaces#backupresources-reference)
- <a id="mcp-server-reference"></a>[`mcpServers`](/en/plugins/manifest/surfaces#mcp-server-reference)
- <a id="controlui-reference"></a>[`controlUi`](/en/plugins/manifest/surfaces#controlui-reference)
- [`themes`](/en/plugins/manifest/surfaces#themes)
- <a id="dashboard-reference"></a>[`dashboard`](/en/plugins/manifest/surfaces#dashboard-reference)
- <a id="catalog-reference"></a>[`catalog`](/en/plugins/manifest/surfaces#catalog-reference)
- <a id="clicommands-reference"></a>[`cliCommands`](/en/plugins/manifest/surfaces#clicommands-reference)
- <a id="commandaliases-reference"></a>[`commandAliases`](/en/plugins/manifest/surfaces#commandaliases-reference)
- <a id="qarunners-reference"></a>[`qaRunners`](/en/plugins/manifest/surfaces#qarunners-reference)
- <a id="channelconfigs-reference"></a>[`channelConfigs`](/en/plugins/manifest/surfaces#channelconfigs-reference)
- [`channelAccountKeyPolicies`](/en/plugins/manifest/surfaces#channelaccountkeypolicies-reference)
- <a id="replacing-another-channel-plugin"></a>[`channelConfigs.<id>.preferOver`](/en/plugins/manifest/surfaces#replacing-another-channel-plugin)

### Config and secret fields

[Manifest config and secret fields](/en/plugins/manifest/config-and-secrets) — Manifest dangerous-flag, SecretRef migration, and secret provider preset metadata.

- <a id="configcontracts-reference"></a>[`configContracts`](/en/plugins/manifest/config-and-secrets#configcontracts-reference)
- <a id="secretproviderintegrations-reference"></a>[`secretProviderIntegrations`](/en/plugins/manifest/config-and-secrets#secretproviderintegrations-reference)

### Manifest and package.json fields

[Manifest versus package.json](/en/plugins/manifest/package-json) — Which pre-runtime metadata lives in package.json, and which duplicate plugin id wins.

- <a id="manifest-versus-package.json"></a><a id="manifest-versus-package-json"></a>[Manifest versus `package.json`](/en/plugins/manifest/package-json#manifest-versus-package-json)
- <a id="package.json-fields-that-affect-discovery"></a><a id="package-json-fields-that-affect-discovery"></a>[`package.json#openclaw` fields](/en/plugins/manifest/package-json#package-json-fields-that-affect-discovery)
- <a id="discovery-precedence-(duplicate-plugin-ids)"></a><a id="discovery-precedence-duplicate-plugin-ids"></a>[Discovery precedence](/en/plugins/manifest/package-json#discovery-precedence-duplicate-plugin-ids)
...
| `kind`                               | No       | `PluginKind \| PluginKind[]` | Declares one or more exclusive plugin kinds (`"memory"`, `"context-engine"`) used by [`plugins.slots.*`](/en/gateway/configuration-reference#plugins). A plugin that owns both slots declares both kinds in one array.                                                                                                                                                                              |
...
| `secretProviderIntegrations`         | No       | `Record<string, object>`     | Declarative [SecretRef](/en/gateway/secrets) exec provider presets that setup or install surfaces can offer without hardcoding provider-specific integrations in core.                                                                                                                                                                                                                              |
...
| `backupResources`                    | No       | `object[]`                   | Manifest-owned durable or regenerable state- or agent-relative backup resources. Applied only for effectively activated, loadable plugins without executing their runtime. See [backupResources reference](/en/plugins/manifest/surfaces#backupresources-reference).                                                                                                                                |
...
| `dashboard`                          | No       | `object`                     | Dashboard widget data bindings and action verbs. Each entry is validated against a Gateway method registered by this plugin with the required read or write scope. See [dashboard reference](/en/plugins/manifest/surfaces#dashboard-reference).                                                                                                                                                    |
| `mcpServers`                         | No       | `Record<string, object>`     | Static MCP server definitions contributed while this plugin is enabled. Relative command arguments and working directories resolve from the plugin root. Operator `mcp.servers` entries override or disable definitions with the same name. See [MCP server reference](/en/plugins/manifest/surfaces#mcp-server-reference).                                                                         |
| `themes`                             | No       | `object[]`                   | Static theme IDs, names, descriptions, and plugin-relative JSON sources. Enabled plugins contribute to the shared settings and agent theme catalog; plugin reload refreshes palette edits without a Gateway restart. See [Themes](/en/plugins/manifest/surfaces#themes).                                                                                                                            |
...
| `transcriptSources`                  | No       | `Record<string, object>`     | Static transcript source names and auto-start locator requirements for IDs declared in `contracts.transcriptSourceProviders`. See [Transcript sources reference](/en/plugins/manifest/surfaces#transcript-sources-reference).                                                                                                                                                                       |
| `configContracts`                    | No       | `object`                     | Manifest-owned config behavior consumed by generic core helpers: dangerous-flag detection, SecretRef migration targets, and legacy config-path narrowing. See [configContracts reference](/en/plugins/manifest/config-and-secrets#configcontracts-reference).                                                                                                                                       |
...
| `channelAccountKeyPolicies`          | No       | `Record<string, object>`     | Stored account-key selection rules for declared channels. See [account-key policies](/en/plugins/manifest/surfaces#channelaccountkeypolicies-reference).                                                                                                                                                                                                                                            |
...
| `configGroups`                       | No       | `object[]`                   | Author-defined Settings sections with unique ids, titles, optional integer order, and immediate config property names. See [configGroups](/en/plugins/manifest/setup-and-auth#configgroups-reference).                                                                                                                                                                                              |
...
the full plugin entry. See the [typed SDK contract](/en/plugins/sdk-subpaths#capability-catalog-entry).
...
See [Configuration reference](/en/gateway/configuration-reference#plugins) for the full `plugins.*` schema.
...
- Declare exclusive plugin kind in this manifest. Bundled plugins use manifest kinds without loading their runtime during enablement. Runtime-entry `OpenClawPluginDefinition.kind` was deprecated on 2026-07-25 and remains only as a compatibility fallback for older external plugins; its removal gate is 2026-10-01. See the [compatibility policy](/en/plugins/sdk-migration/compatibility-policy#compatibility-policy).
...
- For runtime wizard metadata that requires provider code, see [Provider runtime hooks](/en/plugins/architecture-internals#provider-runtime-hooks).
...
<CardGroup cols={3}>
  <Card title="Building plugins" href="/en/plugins/building-plugins" icon="rocket">
    Getting started with plugins.
  </Card>
  <Card title="Plugin architecture" href="/en/plugins/architecture" icon="diagram-project">
    Internal architecture and capability model.
  </Card>
  <Card title="SDK overview" href="/en/plugins/sdk-overview" icon="book">
    Plugin SDK reference and subpath imports.
  </Card>
  <Card title="Model fields" href="/en/plugins/manifest/models" icon="list">
    Manifest model catalog, shorthand family, id normalization, and pricing fields.
  </Card>
  <Card title="Provider fields" href="/en/plugins/manifest/providers" icon="list">
    Manifest generation, media-understanding, endpoint, and request provider metadata.
  </Card>
  <Card title="Setup and auth fields" href="/en/plugins/manifest/setup-and-auth" icon="list">
    Manifest setup descriptors, auth choices, conversation discovery, and config UI hints.
  </Card>
  <Card title="Capability fields" href="/en/plugins/manifest/capabilities" icon="list">
    Manifest capability ownership, tool availability metadata, and activation planning.
  </Card>
  <Card title="Host surface fields" href="/en/plugins/manifest/surfaces" icon="list">
    Manifest fields for icons, CLI, MCP, Control UI, dashboard, QA, channel, and backup surfaces.
  </Card>
  <Card title="Config and secret fields" href="/en/plugins/manifest/config-and-secrets" icon="list">
    Manifest dangerous-flag, SecretRef migration, and secret provider preset metadata.
  </Card>
  <Card title="Manifest vs package.json" href="/en/plugins/manifest/package-json" icon="list">
    Which pre-runtime metadata lives in package.json, and which duplicate plugin id wins.
  </Card>
  <Card title="Plugin setup and config" href="/en/plugins/sdk-setup" icon="sliders">
    Packaging and config schemas that consume this manifest.
  </Card>
  <Card title="Plugin entry points" href="/en/plugins/sdk-entrypoints" icon="door-open">
    `definePluginEntry` and the other entry helpers a plugin's code exports.
  </Card>
  <Card title="Tool plugins" href="/en/plugins/tool-plugins" icon="wrench">
    Declaring `contracts.tools` for agent tools.
  </Card>
  <Card title="Manage plugins" href="/en/plugins/manage-plugins" icon="plug">
    Installing and enabling the plugins this manifest describes.
  </Card>
  <Card title="Backup" href="/en/cli/backup" icon="box-archive">
