...
See [Advanced exec approvals](/en/tools/exec-approvals-advanced#plugin-approval-forwarding)
...
See [Codex harness runtime](/en/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations)
...
- [Plugin hooks](/en/plugins/hooks/tool-policy#tool-call-policy)
- [Building plugins](/en/plugins/building-plugins#registering-tools)
- [Advanced exec approvals](/en/tools/exec-approvals-advanced#plugin-approval-forwarding)
- [Gateway protocol](/en/gateway/protocol)
- [Codex harness runtime](/en/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations)
