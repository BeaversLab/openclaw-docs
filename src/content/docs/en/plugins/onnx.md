...
[decision model API](/en/plugins/sdk-overview/capabilities#decision-models-contract-version-1).
...
See [Decision models](/en/concepts/decision-models) for the model role, rubric
