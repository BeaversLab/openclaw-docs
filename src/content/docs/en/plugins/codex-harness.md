...
[Agent runtimes](/en/concepts/agent-runtimes). The short version is:
...
For the plugin hook semantics themselves, see [Plugin hooks](/en/plugins/hooks)
and [Plugin guard behavior](/en/tools/plugin).
...
See [Codex Computer Use](/en/plugins/codex-computer-use) for the distinction
...
[Codex Computer Use](/en/plugins/codex-computer-use) for marketplace choices,
...
thread ids together in one reply. See [Diagnostics export](/en/gateway/diagnostics)
...
preamble, links to [Diagnostics Export](/en/gateway/diagnostics), and requests
...
[Steering queue](/en/concepts/queue-steering).
