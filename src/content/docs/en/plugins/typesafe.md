...
See [Decision models](/en/concepts/decision-models) for the model role, available
...
[secret refresh flow](/en/gateway/secrets) after changing a credential.
...
[decision runtime](/en/plugins/sdk-overview/capabilities#decision-models-contract-version-1).
...
your normal [tool policy](/en/tools) when an agent should make explicit evaluations.
...
Use the supported [plugin management flow](/en/plugins/manage-plugins) to replace
