...
See [Discord voice](/en/channels/discord#voice-mode).
...
configured realtime provider and model. See [Discord voice](/en/channels/discord#voice-mode)
...
See [Meeting Notes CLI](/en/cli/meeting-notes) for the full command reference.
...
- [Meeting Notes CLI](/en/cli/meeting-notes)
- [Discord voice](/en/channels/discord#voice-mode)
- [Plugin management](/en/tools/plugin)
