...
**`404 Not Found`** The plugin is disabled, runtime application failed, or the request is going to a different Gateway process. Check the enablement result and [inspect the plugin](/en/plugins/manage-plugins#apply-changes-and-inspect).
...
- [Plugin manifest](/en/plugins/manifest/capabilities#contracts-reference)
- [SDK subpaths](/en/plugins/sdk-subpaths)
