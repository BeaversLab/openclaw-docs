...
bundled Zalo Bot/webhook integration - see [Zalo](/en/channels/zalo).
...
application result; see [Apply changes and inspect](/en/plugins/manage-plugins#apply-changes-and-inspect).
...
See [Zalo personal channel config](/en/channels/zalouser) for DM/group access
...
- [Zalo personal channel config](/en/channels/zalouser)
- [Zalo (official Bot/webhook channel)](/en/channels/zalo)
