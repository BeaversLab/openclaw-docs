...
[Control UI](/en/web/control-ui): agent-sized work cards, assignment to agents,
...
it before opening the dashboard. See [Apply changes and inspect](/en/plugins/manage-plugins#apply-changes-and-inspect).
...
See [Workboard CLI](/en/cli/workboard) for full flags, JSON output, Gateway
...
[Dashboards](/en/web/dashboards)). The agent pins them with its `dashboard` tool
