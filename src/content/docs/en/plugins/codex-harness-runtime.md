...
[Codex harness](/en/plugins/codex-harness). For config fields, see
...
history scrub. See [Workspace bootstrap files](/en/plugins/codex-harness-reference#workspace-bootstrap-files).
...
[Codex process recovery](/en/plugins/codex-harness-runtime/recovery) — Orphaned Codex app-server process detection and cleanup after a hard Gateway stop.

- <a id="recovery-after-a-hard-gateway-stop"></a>[Recovery after a hard Gateway stop](/en/plugins/codex-harness-runtime/recovery#recovery-after-a-hard-gateway-stop)

### Codex thread bindings and supervision

[Codex thread bindings and supervision](/en/plugins/codex-harness-runtime/threads) — How OpenClaw binds native Codex threads, changes models, and continues supervised sessions.

- <a id="thread-bindings-and-model-changes"></a>[Thread bindings and model changes](/en/plugins/codex-harness-runtime/threads#thread-bindings-and-model-changes)
- <a id="supervision-and-safe-continuation"></a>[Supervision and safe continuation](/en/plugins/codex-harness-runtime/threads#supervision-and-safe-continuation)

### Codex replies and final answers

[Codex replies and final answers](/en/plugins/codex-harness-runtime/replies) — Visible reply delivery, heartbeat turns, and bounded final-answer recovery.

- <a id="visible-replies-and-heartbeats"></a>[Visible replies and heartbeats](/en/plugins/codex-harness-runtime/replies#visible-replies-and-heartbeats)
- <a id="final-answers-after-settled-tool-work"></a>[Final answers after settled tool work](/en/plugins/codex-harness-runtime/replies#final-answers-after-settled-tool-work)

### Codex hook boundaries

[Codex hook boundaries](/en/plugins/codex-harness-runtime/hooks) — Which hook layer owns each Codex turn event, and what the native hook relay can do.

- <a id="hook-boundaries"></a>[Hook boundaries](/en/plugins/codex-harness-runtime/hooks#hook-boundaries)

### Codex sandbox process streaming

[Codex sandbox process streaming](/en/plugins/codex-harness-runtime/sandbox-streaming) — Experimental native sandbox execution streaming and node-backed remote exec.

- <a id="experimental-sandbox-process-streaming"></a>[Experimental sandbox process streaming](/en/plugins/codex-harness-runtime/sandbox-streaming#experimental-sandbox-process-streaming)

### Codex runtime v1 support contract

[Codex runtime v1 support contract](/en/plugins/codex-harness-runtime/v1-support-contract) — What is and is not supported in Codex runtime v1, with the reason for each boundary.

- <a id="v1-support-contract"></a>[V1 support contract](/en/plugins/codex-harness-runtime/v1-support-contract#v1-support-contract)

### Codex native permissions and elicitations

[Codex native permissions and elicitations](/en/plugins/codex-harness-runtime/permissions) — Native permission decisions, remembered approvals, and MCP elicitation limits.

- <a id="native-permissions-and-mcp-elicitations"></a>[Native permissions and MCP elicitations](/en/plugins/codex-harness-runtime/permissions#native-permissions-and-mcp-elicitations)

### Codex queue steering and feedback upload

[Codex queue steering and feedback upload](/en/plugins/codex-harness-runtime/queue-and-feedback) — Active-run queue steering on Codex turns and the Codex feedback upload path.

- <a id="queue-steering"></a>[Queue steering](/en/plugins/codex-harness-runtime/queue-and-feedback#queue-steering)
- <a id="codex-feedback-upload"></a>[Codex feedback upload](/en/plugins/codex-harness-runtime/queue-and-feedback#codex-feedback-upload)

### Codex compaction and transcript mirror

[Codex compaction and transcript mirror](/en/plugins/codex-harness-runtime/compaction) — Native Codex compaction, the OpenClaw transcript mirror, and continuity projection.

- <a id="compaction-and-transcript-mirror"></a>[Compaction and transcript mirror](/en/plugins/codex-harness-runtime/compaction#compaction-and-transcript-mirror)
...
- [Trajectory export](/en/tools/trajectory)
