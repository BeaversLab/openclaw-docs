...
| Embedded Pi extension  | `api.registerEmbeddedExtensionFactory(...)`      | [SDK Overview](/en/plugins/sdk-overview#registration-api)                          |
...
See [SDK Overview hook decision semantics](/en/plugins/sdk-overview#hook-decision-semantics) for details.
