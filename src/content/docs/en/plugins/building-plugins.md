...
<CardGroup cols={2}>
  ...
  <Card title="Feature plugin" icon="panels-top-left" href="/en/plugins/feature-plugins">
...
```
    ...
    Choose one [catalog category](/en/plugins/manifest#catalog-categories) for the
  ...
  <Step title="Test the package install">
    ...
    [Plugin dependency resolution](/en/plugins/dependency-resolution) for
...
`npm pack --dry-run`. See the [activity icon contract](/en/plugins/manifest/surfaces#inline-activity-icons)
...
[Code Mode](/en/tools/code-mode) and [Tool Search](/en/tools/tool-search). Catalog
...
[Tool plugins](/en/plugins/tool-plugins#output-contracts) for the full contract.
