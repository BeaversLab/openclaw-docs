...
<CardGroup cols={3}>
  ...
  <Card title="Tool / hook plugin" icon="wrench" href="/en/plugins/hooks">
...
<Steps>
  <Step title="Create the package and manifest">
    ...
    [Manifest](/en/plugins/manifest) for the full schema. The canonical ClawHub
  ...
  <Step title="Write the entry point">
    ...
    `defineChannelPluginEntry` - see [Channel Plugins](/en/plugins/sdk-channel-plugins).
    For full entry point options, see [Entry Points](/en/plugins/sdk-entrypoints).
