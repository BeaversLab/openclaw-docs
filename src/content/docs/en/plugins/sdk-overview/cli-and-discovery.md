...
CLI backends. Part of the [Plugin SDK overview](/en/plugins/sdk-overview).
...
helper; see [retained SDK contracts](/en/plugins/sdk-migration/compatibility-policy#retained-helper-contracts).
