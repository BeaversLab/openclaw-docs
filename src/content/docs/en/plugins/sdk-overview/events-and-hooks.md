...
each hook result. Part of the [Plugin SDK overview](/en/plugins/sdk-overview).
...
shutdown, see [Safe external cron projection](/en/plugins/hooks/lifecycle#safe-external-cron-projection).
