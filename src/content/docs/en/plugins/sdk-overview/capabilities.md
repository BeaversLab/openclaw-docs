...
Start with [Decision models](/en/concepts/decision-models) for model choices,
...
The [ONNX plugin](/en/plugins/onnx) supplies local classifiers; the
[TypeSafe AI plugin](/en/plugins/typesafe) supplies hosted Jev and local System One
