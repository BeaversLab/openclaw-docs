...
<Steps>
  ...
  <Step title="Migrate approval-native handlers to capability facts">
    ...
    See [Channel Plugins](/en/plugins/sdk-channel-plugins) for the current
  ...
  <Step title="Replace with focused imports">
    ...
    see [Retained channel facade mappings](/en/plugins/sdk-migration#retained-channel-facade-mappings)
...
Use the topical SDK guides linked from [SDK overview](/en/plugins/sdk-overview)
...
[Channel outbound API](/en/plugins/sdk-channel-outbound) for the outbound contract.
...
the [Plugin SDK subpath catalog](/en/plugins/sdk-subpaths), and import `zod`
