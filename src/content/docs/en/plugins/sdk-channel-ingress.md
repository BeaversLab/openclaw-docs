...
The [security audit](/en/gateway/security/audit-checks) counts configured `allowFrom`
...
- [Channel inbound API](/en/plugins/sdk-channel-inbound) — the receive path that consumes this resolver result as `channelIngress`
