...
| `qa mantis`                                         | Before/after verification runner for live transport bugs, with Discord status-reactions evidence, Crabbox desktop/browser smoke, and Slack-in-VNC smoke. See [Mantis](/en/concepts/mantis) and [Mantis Slack Desktop Runbook](/en/concepts/mantis-slack-desktop-runbook). |
...
layout for this lane live in [Matrix QA](/en/concepts/qa-matrix). At a glance: it
...
[Mantis Slack Desktop Runbook](/en/concepts/mantis-slack-desktop-runbook).
...
Matrix has a [dedicated page](/en/concepts/qa-matrix) because of its scenario
...
[Slack channel quick setup](/en/channels/slack#quick-setup); the QA Driver/SUT
...
[Testing → Shared Telegram credentials via Convex](/en/help/testing#shared-telegram-credentials-via-convex-v1)
...
scorecard context, see [Maturity scorecard](/en/maturity/scorecard).
