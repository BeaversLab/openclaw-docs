...
<CardGroup cols={2}>
  <Card title="Context engine" href="/en/concepts/context-engine" icon="puzzle-piece">
    Custom context injection via plugins.
  </Card>
  <Card title="Compaction" href="/en/concepts/compaction" icon="compress">
  ...
  <Card title="Agent loop" href="/en/concepts/agent-loop" icon="arrows-rotate">
