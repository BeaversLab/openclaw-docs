...
See also: [Slash commands](/en/tools/slash-commands), [Token use & costs](/en/reference/token-use), [Compaction](/en/concepts/compaction).
...
[Context Engine](/en/concepts/context-engine) for the full
...
- [Context Engine](/en/concepts/context-engine) — custom context injection via plugins
- [Compaction](/en/concepts/compaction) — summarizing long conversations
- [System Prompt](/en/concepts/system-prompt) — how the system prompt is built
- [Agent Loop](/en/concepts/agent-loop) — the full agent execution cycle
