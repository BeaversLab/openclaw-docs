...
configure it as a context engine first; see [Context engine](/en/concepts/context-engine).
...
<AccordionGroup>
  <Accordion title="Embedding provider switched or stopped working">
    ...
    deterministic. See [Memory Search](/en/concepts/memory-search) for the full
