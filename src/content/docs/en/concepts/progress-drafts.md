...
<Note>
  ...
  [Streaming and chunking](/en/concepts/streaming#channel-mapping) for the full
...
migration, see [Streaming and chunking](/en/concepts/streaming).
...
[Streaming and chunking](/en/concepts/streaming#commentary-progress-lane) for the
...
[`utilityModel`](/en/gateway/config-agents/models#agents-defaults-model), or the primary
...
final-only delivery. See [Streaming and chunking](/en/concepts/streaming) for the
...
- [Streaming and chunking](/en/concepts/streaming)
- [Messages](/en/concepts/messages)
- [Channel configuration](/en/gateway/config-channels)
