...
`memorySearch.documentInputType`; see the [Memory configuration reference](/en/reference/memory-config#provider-specific-config).
...
content. See the [Memory configuration reference](/en/reference/memory-config) for
setup.
...
[configuration reference](/en/reference/memory-config) for details.
