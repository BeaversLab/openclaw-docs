...
[Memory configuration reference](/en/reference/memory-config#multimodal-memory-gemini)
for setup.

## Session memory search

For exact full-text recall from session transcripts, use [`sessions_search`](/en/concepts/session-search)
...
[`sessions_search`](/en/concepts/session-search) for transcript search across agents
