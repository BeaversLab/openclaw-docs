...
- [ONNX](/en/plugins/onnx) runs local CPU classifiers in a persistent subprocess.
...
- [TypeSafe AI](/en/plugins/typesafe) connects to hosted Jev or a local System One
...
See the [SDK contract](/en/plugins/sdk-overview/capabilities#decision-models-contract-version-1)
...
[ONNX lifecycle and runtime](/en/plugins/onnx#lifecycle-and-runtime) for cache settings
and the effect of active cancellation. For missing TypeSafe credentials, follow
its [setup instructions](/en/plugins/typesafe#enable-and-configure).
...
The [provider contract](/en/plugins/sdk-overview/capabilities#decision-models-contract-version-1)
owns the full SDK rules; the [manifest reference](/en/plugins/manifest/capabilities#decision-models-reference)
owns discovery fields. For existing integrations, use the [ONNX](/en/plugins/onnx)
or [TypeSafe AI](/en/plugins/typesafe) setup pages.
