...
and allowed hosts; there is no plaintext fallback. See [Secrets](/en/tools/secrets).
...
Reusable secrets and backup recovery codes use [protected entry](/en/tools/secrets).
