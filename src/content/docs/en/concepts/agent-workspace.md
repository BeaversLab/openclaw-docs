...
- `SOUL.md`
  ...
  - Guide: [SOUL.md Personality Guide](/en/concepts/soul)
...
- `BOOT.md`
  - Optional startup checklist run automatically on gateway restart (when [internal hooks](/en/automation/hooks) are enabled).
