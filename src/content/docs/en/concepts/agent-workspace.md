...
<AccordionGroup>
  ...
  <Accordion title="MEMORY.md — curated long-term memory (optional)">
    Curated long-term memory. Only load in the main, private session (not shared/group contexts). See [Memory](/en/concepts/memory) for the workflow and automatic memory flush.
  </Accordion>
