...
- Multi-agent routing can use different workspaces per agent via `agents.list[].workspace`. See [Channel routing](/en/channels/channel-routing) for routing configuration.
