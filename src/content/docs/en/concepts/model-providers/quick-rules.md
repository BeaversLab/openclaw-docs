...
<AccordionGroup>
  ...
  <Accordion title="OpenAI provider/runtime split">
    ...
    See [OpenAI implicit agent runtime](/en/providers/openai/runtimes#implicit-agent-runtime) and [Codex harness](/en/plugins/codex-harness). If the provider/runtime split is confusing, read [Agent runtimes](/en/concepts/agent-runtimes) first.
