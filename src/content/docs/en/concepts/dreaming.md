...
<Note>
Phase policy, thresholds, and storage behavior are internal implementation details (not user-facing config). See [Memory configuration reference](/en/reference/memory-config#dreaming) for the full key list.
</Note>
