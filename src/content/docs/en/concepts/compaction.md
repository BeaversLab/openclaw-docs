...
notes to [memory](/en/concepts/memory) files. This prevents context loss.
</Info>
...
[Session pruning](/en/concepts/session-pruning) is a lighter-weight complement that
...
guide the summary, or enable the [memory flush](/en/concepts/memory) so notes
survive.
