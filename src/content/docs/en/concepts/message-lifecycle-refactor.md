...
current API, use [Channel outbound API](/en/plugins/sdk-channel-outbound) and
[Channel inbound API](/en/plugins/sdk-channel-inbound). This page tracks what
...
[Channel inbound API](/en/plugins/sdk-channel-inbound). New plugin code should
...
- [Progress drafts](/en/concepts/progress-drafts)
- [Retry policy](/en/concepts/retry)
- [Channel outbound API](/en/plugins/sdk-channel-outbound)
- [Channel inbound API](/en/plugins/sdk-channel-inbound)
