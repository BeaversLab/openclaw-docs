...
<Columns>
  <Card title="Channels" icon="message-square" href="/en/channels">
    Discord, iMessage, Signal, Slack, Telegram, WhatsApp, WebChat, and more with a single Gateway.
  </Card>
  <Card title="Plugins" icon="plug" href="/en/tools/plugin">
    Official plugins add Matrix, Nextcloud Talk, Nostr, Twitch, Zalo, and dozens more with one install command.
  </Card>
  <Card title="Routing" icon="route" href="/en/concepts/multi-agent">
    Multi-agent routing with isolated sessions.
  </Card>
  <Card title="Media" icon="image" href="/en/nodes/images">
    Images, audio, video, documents, and image/video generation.
  </Card>
  <Card title="Apps and UI" icon="monitor" href="/en/platforms">
...
- Many [model providers](/en/providers) (Anthropic, OpenAI, Google, and more) — the
...
- [Inline audio and video playback](/en/nodes/media-playback) across the Control UI, iOS/macOS, Android, and the Linux companion
...
<CardGroup cols={2}>
  <Card title="Experimental features" href="/en/concepts/experimental-features" icon="flask">
    Opt-in features that have not yet shipped to the default surface.
  </Card>
  <Card title="Agent runtime" href="/en/concepts/agent" icon="robot">
