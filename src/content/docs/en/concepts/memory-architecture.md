...
[Memory overview](/en/concepts/memory), [Dreaming](/en/concepts/dreaming),
[Active memory](/en/concepts/active-memory),
[User model](/en/concepts/user-model), and
...
[Compaction](/en/concepts/compaction)). When sessions end, their transcripts
...
[Dreaming](/en/concepts/dreaming); this section explains the architecture.
...
The blocking recall sub-agent from [Active memory](/en/concepts/active-memory)
...
See [User model](/en/concepts/user-model) for the full contract.
...
- **Time-based intents** ("remind me Friday") become cron jobs via
  [scheduled tasks](/en/automation/cron-jobs) at the moment they are uttered.
...
injected per turn. See [Standing intents](/en/concepts/standing-intents).
