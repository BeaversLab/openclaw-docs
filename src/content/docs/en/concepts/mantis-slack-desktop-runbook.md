...
[Mantis](/en/concepts/mantis) Slack desktop QA is the real-UI lane for Slack-class
...
- [QA overview](/en/concepts/qa-e2e-automation)
- [Slack channel](/en/channels/slack)
