...
[/concepts/agent-runtimes](/en/concepts/agent-runtimes).
...
- Requires OpenRouter API key from auth profiles or `OPENROUTER_API_KEY` (see [/environment](/en/help/environment))
