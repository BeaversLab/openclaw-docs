...
| `qa character-eval`                                 | Run the character QA scenario across multiple live models with a judged report. See [Reporting](/en/concepts/qa-e2e-automation/qa-reporting#reporting).                                                                                                                |
...
| `qa matrix`                                         | QA Lab Matrix catalog scenarios against a disposable Tuwunel homeserver. See [Matrix live lane](/en/concepts/qa-e2e-automation/operator-flow#matrix-live-lane).                                                                                                        |
