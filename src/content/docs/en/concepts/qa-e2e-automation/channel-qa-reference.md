...
[Matrix live lane](/en/concepts/qa-e2e-automation/operator-flow#matrix-live-lane).
...
- `discord-thread-reply-filepath-attachment` - opt-in Mantis scenario; see
  [Discord Mantis scenarios](/en/concepts/qa-e2e-automation/operator-flow#discord-mantis-scenarios).
