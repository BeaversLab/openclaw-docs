...
[Channel QA reference](/en/concepts/qa-e2e-automation/channel-qa-reference),
[Slack QA](/en/concepts/qa-e2e-automation/slack-qa), and [WhatsApp QA](#whatsapp-qa). Pass
...
[Setting up the Slack workspace](/en/concepts/qa-e2e-automation/slack-qa#setting-up-the-slack-workspace) for app
and scope provisioning.

Operational env vars and the Convex broker endpoint contract live in
[Testing → Shared Telegram credentials via Convex](/en/help/testing/qa-runners#shared-telegram-credentials-via-convex-v1)
