...
| Need                                            | Use                                      |
| ----------------------------------------------- | ---------------------------------------- |
| "Remind me at 3 PM"                             | [Scheduled tasks](/en/automation/cron-jobs) |
| "Ping me in 20 minutes"                         | [Scheduled tasks](/en/automation/cron-jobs) |
| "Run this report every weekday"                 | [Scheduled tasks](/en/automation/cron-jobs) |
...
See [`openclaw commitments`](/en/cli/commitments) for the full command reference.
...
- Remember that exact reminders are skipped by commitment extraction and should
  appear under [scheduled tasks](/en/automation/cron-jobs) instead.
...
- [`openclaw commitments`](/en/cli/commitments)
- [Configuration reference](/en/gateway/configuration-reference#commitments)
