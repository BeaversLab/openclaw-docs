...
Use [commitments](/en/concepts/commitments) for inferred, short-lived follow-ups.
...
[Commitments](/en/concepts/commitments) are opt-in, short-lived follow-up
...
heartbeat. Explicit reminders still use [scheduled tasks](/en/automation/cron-jobs).
