...
Use [commitments](/en/concepts/commitments) for inferred, short-lived follow-ups. Use [scheduled tasks](/en/automation/cron-jobs) for exact reminders, timed checks, and recurring work. Memory can still summarize the durable context around either path.
...
See [Memory Wiki](/en/plugins/memory-wiki).
