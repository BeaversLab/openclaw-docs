...
<CardGroup cols={2}>
  <Card title="Presence" href="/en/concepts/presence" icon="signal">
  ...
  <Card title="Heartbeat" href="/en/gateway/heartbeat" icon="heart-pulse">
    The system-owned automation that runs periodic agent turns, and the notification rules for its target chat.
  </Card>
  <Card title="Groups" href="/en/channels/groups" icon="users">
