...
GitHub Copilot CLI; see [GitHub Copilot agent runtime](/en/plugins/copilot) for
...
For the OpenAI-family prefix split, see [OpenAI](/en/providers/openai) and
[Model providers](/en/concepts/model-providers). For the Codex runtime support
contract, see [Codex harness runtime](/en/plugins/codex-harness-runtime#v1-support-contract).
...
decision, see [GitHub Copilot agent runtime](/en/plugins/copilot).
...
[Codex harness runtime](/en/plugins/codex-harness-runtime#v1-support-contract).
...
- [Code Mode](/en/tools/code-mode) — an experimental agent-runtime feature with automatic per-model activation
- [Agent runtime architecture](/en/agent-runtime-architecture) — code layout, module boundaries, and how the built-in runtime is selected
