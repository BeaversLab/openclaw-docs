...
coding harness, see [Session synchronization and attachment](/en/concepts/session-attachment).
...
| Value                      | Behavior                                                 |
| -------------------------- | -------------------------------------------------------- |
| `main` (default)           | All DMs share the [main session](/en/concepts/main-session) |
...
[Agent View DMs](/en/channels/slack/threads-and-sessions#agent-view-dms).
...
routing, or [thread-bound sessions](/en/tools/subagents#thread-bound-sessions) to
...
| `main`                | Route groups, rooms, and channels into the agent's [main session](/en/concepts/main-session) |
...
[Active Memory](/en/concepts/active-memory#remember-across-conversations) for setup
and runtime details.
...
sequence](/en/cli/doctor#session-sqlite-migration) for inspection and validation.
...
- [Session search](/en/concepts/session-search) - full-text recall across past transcripts
- [Session Pruning](/en/concepts/session-pruning) - trimming tool results
- [Compaction](/en/concepts/compaction) - summarizing long conversations
- [Session Tools](/en/concepts/session-tool) - agent tools for cross-session work
...
- [Multi-agent sandbox and tools](/en/tools/multi-agent-sandbox-tools) - per-agent sandbox and tool restrictions, including session visibility
- [Transcript hygiene](/en/reference/transcript-hygiene) - in-memory, provider-specific transcript sanitization applied before a run
