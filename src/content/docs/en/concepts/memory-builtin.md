...
Consider switching to [QMD](/en/concepts/memory-qmd) if you need reranking, query
expansion, or want to index directories outside the workspace.

Consider [Honcho](/en/concepts/memory-honcho) if you want cross-session memory with
