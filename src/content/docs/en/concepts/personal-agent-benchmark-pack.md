...
needs no new runner: it reuses the private QA stack ([QA overview](/en/concepts/qa-e2e-automation)),
the synthetic [QA channel](/en/channels/qa-channel), and the existing
...
- [QA channel](/en/channels/qa-channel) — the synthetic channel these scenarios run on
- [QA overview](/en/concepts/qa-e2e-automation) — the wider QA stack and scenario authoring
