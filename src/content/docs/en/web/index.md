...
Capabilities live in [Control UI](/en/web/control-ui). The rest of this page focuses on bind modes, security, and web-facing surfaces.
...
See [Admin HTTP RPC](/en/plugins/admin-http-rpc) for the auth model, allowed methods, and WebSocket comparison.
...
- With Serve, Tailscale identity headers can satisfy Control UI/WebSocket auth
  ...
  [Tailscale](/en/gateway/tailscale) and [Security](/en/gateway/security). This
