...
Local and data-URL agent avatars use [authenticated avatar URLs](/en/web/control-ui/security-model#avatar-route-auth) in this response and in browser identity RPCs, keeping startup JSON small. Native and CLI RPC clients retain their inline avatar representation.
