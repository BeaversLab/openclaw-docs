...
See [Cloud Worker Desktop](/en/gateway/cloud-workers/desktop) for worker desktop
...
[Public session transcripts](/en/web/urls#public-session-transcripts).
...
[Gateway CLI](/en/cli/gateway/query#gateway-call-%3Cmethod%3E). Registration requires
