...
[Session synchronization and attachment](/en/concepts/session-attachment).
...
[Multi-user mode](/en/concepts/multi-user#world-readable-session-links).
...
[Behind a login proxy](/en/web/urls#behind-a-login-proxy). Keep all other routes protected.
...
the [terminal session lifecycle](/en/web/control-ui/panels#operator-terminal).
...
- [Beam plugin](/en/plugins/beam)
- [Dashboard](/en/web/dashboard)
- [Session dashboards](/en/web/dashboards)
