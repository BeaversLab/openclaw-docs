...
[model inventory contract](/en/concepts/models#selection-source-and-fallback-strictness);
...
- [SecretRef credential surface](/en/reference/secretref-credential-surface) - which credential fields accept a SecretRef instead of a raw secret value
