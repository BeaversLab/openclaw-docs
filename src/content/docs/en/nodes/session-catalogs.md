...
The bundled [Session Share plugin](/en/plugins/session-share) publishes selected
...
source. It is separate from hosting new sessions on a node, described in [Session hosting](/en/nodes/session-hosting).
