...
See [Tools and custom providers](/en/gateway/config-tools) for profiles, env vars, and custom base URLs.
...
- [Mistral](/en/providers/mistral) — Voxtral audio transcription, one of the audio-capable providers above
