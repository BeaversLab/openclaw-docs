...
[Image and media support](/en/nodes/images),
[Media understanding](/en/nodes/media-understanding), and [Talk mode](/en/nodes/talk).
...
| Linux companion | Control UI inside the companion WebView             | Codec availability comes from GStreamer. Released packages include or declare the expected codec plugins; see [Linux media codecs](/en/platforms/linux#media-codecs).                                                                                                                      |
...
[Image and media support](/en/nodes/images#limits-and-errors).
...
[Linux media codecs](/en/platforms/linux#media-codecs). The `.deb` depends on the
