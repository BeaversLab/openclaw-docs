...
Apple Watch also retains **Talk to Claw**, the separate [one-turn companion flow](/en/platforms/ios#talk-to-claw-with-the-iphone): native dictation, text relayed through the iPhone, and system-voice readback. **Talk on Watch** is the separately enabled realtime path; see [standalone voice setup](/en/platforms/ios#standalone-voice).
