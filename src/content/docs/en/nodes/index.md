...
not need direct network access to Ollama. See [Ollama node-local inference](/en/providers/ollama#node-local-inference)
...
[Gateway configuration reference](/en/gateway/configuration-reference#gateway-field-details)
