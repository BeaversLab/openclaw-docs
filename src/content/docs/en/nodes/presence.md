...
This is separate from [system presence](/en/concepts/presence), which is the live
...
For TCC recovery, see [macOS permissions](/en/platforms/mac/permissions). For node
connection and command failures, see [Node troubleshooting](/en/nodes/troubleshooting).

## Related

- [Nodes](/en/nodes)
- [Nodes CLI](/en/cli/nodes)
- [System presence](/en/concepts/presence)
- [Gateway protocol](/en/gateway/protocol/presence#presence)
