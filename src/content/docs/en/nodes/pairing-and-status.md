...
[Gateway command policy](/en/nodes/command-policy) or [local exec approvals](/en/tools/exec-approvals).
...
[capability approval lifecycle](/en/gateway/pairing#how-capability-approval-works).
