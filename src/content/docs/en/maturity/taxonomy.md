...
<AccordionGroup>
  ...
  <Accordion title="OpenClaw App SDK - M2 Alpha - 6 areas">
    ...
    [External Apps](/en/gateway/external-apps), [Protocol](/en/gateway/protocol), [Index](/en/gateway/security/index)
    ...
    [External Apps](/en/gateway/external-apps), [Typebox](/en/concepts/typebox), [Protocol](/en/gateway/protocol)
