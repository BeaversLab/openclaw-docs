...
| **Start**      | `openclaw onboard`                     | [Download the macOS app](/en/platforms/macos#download) | [Install the Linux app](/en/platforms/linux) |
...
step by step in [Onboarding (CLI)](/en/start/wizard#guided-default).
...
Full reference: [Onboarding (CLI)](/en/start/wizard)
CLI command docs: [`openclaw onboard`](/en/cli/onboard)

## macOS app onboarding

[Download the macOS app](/en/platforms/macos#download), then open it. If its
...
Full reference: [Onboarding (macOS App)](/en/start/onboarding)

## Linux app onboarding

[Install the Linux desktop companion](/en/platforms/linux), then open it. The
...
[First-run setup](/en/platforms/linux#first-run-setup) for recovery details.

Platform and remote-access details: [Linux app](/en/platforms/linux) and
