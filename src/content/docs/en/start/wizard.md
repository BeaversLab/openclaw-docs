...
<Tabs>
  <Tab title="QuickStart (defaults)">
    ...
    - DM isolation: `session.dmScope: "per-channel-peer"` for new setups. Details: [CLI setup reference](/en/start/wizard-cli-reference#outputs-and-internals)
