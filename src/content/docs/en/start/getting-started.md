...
[security guide](/en/gateway/security). That is the only onboarding prompt when
...
/>
    ...
    <Note>
    Other install methods (Docker, Nix, npm): [Install](/en/install).
    </Note>
  ...
  <Step title="Complete onboarding">
    ...
    **Custom setup** for the full guided flow. Provider sign-in and optional
    ...
    See [Onboarding (CLI)](/en/start/wizard) for the full reference.
  ...
  <Step title="Send your first message">
    ...
    [Telegram](/en/channels/telegram) (just a bot token). See [Channels](/en/channels)
    for all options.
...
To read the findings yourself instead, run [`openclaw doctor`](/en/cli/doctor). For symptom-first routes, see [Troubleshooting](/en/help/troubleshooting).
...
<Columns>
  ...
  <Card title="Pairing and safety" href="/en/channels/pairing" icon="shield">
    Control who can message your agent.
  </Card>
  <Card title="Configure the Gateway" href="/en/gateway/configuration" icon="settings">
    Models, tools, sandbox, and advanced settings.
  </Card>
  <Card title="Browse tools" href="/en/tools" icon="wrench">
...
- [Personal assistant setup](/en/start/openclaw) - end-to-end guide to a dedicated number that behaves like an always-on assistant
- [Triage](/en/cli/triage)
