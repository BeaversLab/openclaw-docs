...
- `codex-cli` is no longer a bundled CLI backend; use `openai/*` with the Codex app-server runtime instead (see [Live: Codex app-server harness smoke](/en/help/testing-live/acp-and-codex#live-codex-app-server-harness-smoke)).
