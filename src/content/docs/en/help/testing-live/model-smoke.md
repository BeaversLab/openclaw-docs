...
[Live: model matrix](/en/help/testing-live/long-context-and-matrix#live-model-matrix-what-we-cover)
...
- How to select models:
  - `OPENCLAW_LIVE_MODELS=modern` runs the curated high-signal priority list (see [Live: model matrix](/en/help/testing-live/long-context-and-matrix#live-model-matrix-what-we-cover))
