...
- [QA overview](/en/concepts/qa-e2e-automation) - architecture, command surface, scenario authoring, and Matrix profiles.
...
- `pnpm openclaw qa matrix`
  ...
  - Full CLI, profile/scenario catalog, env vars, and artifact layout:
    [Matrix smoke lanes](/en/concepts/qa-e2e-automation#matrix-smoke-lanes).
