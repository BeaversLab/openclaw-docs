...
<AccordionGroup>
  ...
  <Accordion title="Do you support Claude subscription auth (Claude Pro or Max)?">
    ...
    Setup-token is still supported. Claude CLI migration is simpler when the gateway host already runs Claude Code. See [Anthropic](/en/providers/anthropic) and [OAuth](/en/concepts/oauth).
