...
<AccordionGroup>
  ...
  <Accordion title="How can I use different models or settings for different tasks?">
    ...
    you set the optional [model selection scope](/en/gateway/config-agents#agentsdefaultsmodelselectionscope).
...
<AccordionGroup>
  ...
  <Accordion title="Can I keep DMs personal but make groups public/sandboxed with one agent?">
    ...
    Setup walkthrough: [Groups: personal DMs + public groups](/en/channels/groups#pattern-personal-dms-public-groups-single-agent). Key reference: [Gateway configuration](/en/gateway/config-agents#agentsdefaultssandbox).
