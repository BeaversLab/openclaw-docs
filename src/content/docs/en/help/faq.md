...
<AccordionGroup>
  ...
  <Accordion title="How do I bind a host folder into the sandbox?">
    ...
    See [Sandboxing](/en/gateway/sandboxing#custom-bind-mounts) and [Sandbox vs Tool Policy vs Elevated](/en/gateway/sandbox-vs-tool-policy-vs-elevated#bind-mounts-security-quick-check).
