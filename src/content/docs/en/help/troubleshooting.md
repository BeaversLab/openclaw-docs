...
`openclaw status --all`. Full profile/group table: [Tool profiles](/en/gateway/config-tools#tool-profiles).
...
<AccordionGroup>
  ...
  <Accordion title="Gateway will not start or service installed but not running">
    ...
    Deep pages: [Gateway service not running](/en/gateway/troubleshooting#gateway-service-not-running), [Background process](/en/gateway/background-process), [Configuration](/en/gateway/configuration)
