...
Deeper docs: [Blocked plugin path ownership](/en/tools/plugin#blocked-plugin-path-ownership), [Docker: Permissions and EACCES](/en/install/docker#shell-helpers-optional)
...
<AccordionGroup>
  ...
  <Accordion title="Exec suddenly asks for approval">
    ...
    Deep pages: [Exec](/en/tools/exec), [Exec approvals](/en/tools/exec-approvals), [Security: What the audit checks](/en/gateway/security#what-the-audit-checks-high-level)
  ...
  <Accordion title="Browser tool fails">
    ...
    Deep pages: [Browser tool fails](/en/gateway/troubleshooting#browser-tool-fails), [Missing browser command or tool](/en/tools/browser#missing-browser-command-or-tool), [Browser: Linux troubleshooting](/en/tools/browser-linux-troubleshooting), [Browser: WSL2/Windows remote CDP troubleshooting](/en/tools/browser-wsl2-windows-remote-cdp-troubleshooting)
