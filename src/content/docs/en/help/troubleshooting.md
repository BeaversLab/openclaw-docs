...
and run `openclaw status --all` again. See [Tools](/en/tools) for the profile
...
go to [/gateway/troubleshooting#anthropic-429-extra-usage-required-for-long-context](/en/gateway/troubleshooting#anthropic-429-extra-usage-required-for-long-context).
...
- [Plugin path ownership](/en/tools/plugin#blocked-plugin-path-ownership)
- [Docker permissions](/en/install/docker#permissions-and-eacces)
...
- [Automation Troubleshooting](/en/automation/cron-jobs#troubleshooting) — cron and heartbeat issues
