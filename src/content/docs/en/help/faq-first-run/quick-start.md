...
[FAQ: providers, hardware, and hosting](/en/help/faq-first-run/providers-and-hosting).
...
<a id="i-am-stuck" />
  ...
  <Accordion title="What runtime do I need?">
    ...
    [Node.js](/en/install/node) for the maintained requirement. `pnpm` is the repo package manager.
