...
troubleshooting, see the main [FAQ](/en/help/faq).
...
<AccordionGroup>
  ...
  <Accordion title="What model do you recommend?">
    ...
    behavior (see [Security](/en/gateway/security)). Route cheaper models to
    routine/low-stakes chat by agent role.

    Route models per agent and use sub-agents to parallelize long tasks (each
    sub-agent consumes its own tokens). See [Models](/en/concepts/models),
    [Sub-agents](/en/tools/subagents), [MiniMax](/en/providers/minimax), and
  ...
  <Accordion title="How do I switch models without wiping my config?">
    ...
    unless you explicitly choose a broader [model selection scope](/en/gateway/config-agents/models#agentsdefaultsmodelselectionscope).
    ...
    Docs: [Models](/en/concepts/models), [Configure](/en/cli/configure),
    [Config](/en/cli/config), [Doctor](/en/gateway/doctor).
  ...
  <Accordion title="Can I use self-hosted models (llama.cpp, vLLM, Ollama)?">
    ...
    [llmman](/en/providers/llmman) is the alternative when you want models pulled
    ...
    Docs: [Ollama](/en/providers/ollama), [llmman](/en/providers/llmman),
    [Local models](/en/gateway/local-models),
  ...
  <Accordion title="How do I switch models on the fly (without restarting)?">
    ...
    Without a scope flag, the optional [model selection scope](/en/gateway/config-agents/models#agentsdefaultsmodelselectionscope)
    applies; leaving it unset keeps the change in the current session, including for owners/admins. See
    [Slash commands](/en/tools/slash-commands) for the
  ...
  <Accordion title="If two providers expose the same model id, which one does /model use?">
    ...
    See [Models](/en/concepts/models) and [Model failover](/en/concepts/model-failover).
  ...
  <Accordion title="How do I configure fast mode for GPT 5.5?">
    ...
    See [Thinking and fast mode](/en/tools/thinking) and the Fast mode section
    under Advanced configuration on the [OpenAI](/en/providers/openai) provider
    page.
  ...
  <Accordion title='Why do I see "Unknown model: minimax/MiniMax-M3"?'>
    ...
    [MiniMax](/en/providers/minimax) provider page for the full fix checklist,
  ...
  <Accordion title="Can I use MiniMax as my default and OpenAI for complex tasks?">
    ...
    **Option B: separate agents** — Agent A defaults to MiniMax, Agent B
    ...
    Docs: [Models](/en/concepts/models), [Multi-Agent Routing](/en/concepts/multi-agent),
    [MiniMax](/en/providers/minimax), [OpenAI](/en/providers/openai).
  ...
  <Accordion title="How do I define/override model shortcuts (aliases)?">
    ...
    shared global default. Bare selections follow the [model selection scope](/en/gateway/config-agents/models#agentsdefaultsmodelselectionscope).
  ...
  <Accordion title="How do I add models from other providers like OpenRouter or Z.AI?">
    ...
    **No API key found for provider after adding a new agent**
    ...
    [Auth credential semantics](/en/auth-credential-semantics#agent-copy-portability).
    ...
    See [Multi-Agent Routing](/en/concepts/multi-agent) for the
  ...
  <Accordion title='What does "No credentials found for profile anthropic:default" mean?'>
    ...
    **Fix checklist:**
    ...
    - Run `openclaw models status --agent <agentId>` for that agent's model
      ...
      see [Read status correctly](/en/cli/models#read-status-correctly).
...
<AccordionGroup>
  <Accordion title="What is an auth profile?">
    ...
    [Models CLI](/en/cli/models#auth-profiles).
  ...
  <Accordion title="OAuth vs API key - what is the difference?">
    - **OAuth / CLI login** often uses subscription access where the
      ...
      see [Anthropic](/en/providers/anthropic) for the current billing-pause
...
- [FAQ](/en/help/faq) — the main FAQ
- [FAQ — quick start and first-run setup](/en/help/faq-first-run)
