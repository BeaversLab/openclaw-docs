...
<AccordionGroup>
  ...
  <Accordion title="How do I switch models on the fly (without restarting)?">
    ...
    Without a scope flag, the optional [model selection scope](/en/gateway/config-agents#agentsdefaultsmodelselectionscope)
  ...
  <Accordion title="How do I define/override model shortcuts (aliases)?">
    ...
    shared global default. Bare selections follow the [model selection scope](/en/gateway/config-agents#agentsdefaultsmodelselectionscope).
