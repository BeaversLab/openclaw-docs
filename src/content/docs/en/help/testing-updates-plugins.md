...
For the broader test runner map, see [Testing](/en/help/testing). For live provider
keys and network-touching suites, see [Testing live](/en/help/testing-live).
...
[Node auto-updates](/en/cli/node#automatic-updates) for the operator contract.
...
[Schema bumps and older updaters](/en/reference/database-schemas#schema-bumps-and-older-updaters).
...
migration contract](/en/cli/doctor#session-sqlite-migration); the observer never
...
replacement or background update campaigns; see [Updating](/en/install/updating)
...
force publication. See [older updater schema handling](/en/reference/database-schemas#schema-bumps-and-older-updaters).
...
See [release qualification](/en/ci/release-validation#suite-profiles) for the exact
...
- [Testing](/en/help/testing) - the full testing kit: suites, live lanes, and Docker runners
- [Release policy](/en/reference/RELEASING) - the release process this checklist gates
