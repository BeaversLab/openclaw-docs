...
See [Workspace `.env` files](/en/gateway/security#workspace-env-files) for the security rationale.
...
See [Configuration: Env var substitution](/en/gateway/configuration-reference#env-var-substitution) for full details.
