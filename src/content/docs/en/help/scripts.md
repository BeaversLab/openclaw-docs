...
Auth monitoring is covered in [Authentication](/en/gateway/authentication). The scripts under `scripts/` are optional extras for systemd/Termux phone workflows.
