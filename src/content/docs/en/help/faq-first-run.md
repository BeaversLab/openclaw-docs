...
<AccordionGroup>
  ...
  <Accordion title="Does it run on Raspberry Pi?">
    ...
    laptop/phone for local screen/camera/canvas or command execution. See [Nodes](/en/nodes).
  ...
  <Accordion title="What does onboarding actually do?">
    ...
    or missing auth. Full breakdown: [Onboarding (CLI)](/en/start/wizard).
...
<AccordionGroup>
  ...
  <Accordion title="How does Codex auth work?">
    ...
    too. See [Model providers](/en/concepts/model-providers) and [Onboarding (CLI)](/en/start/wizard).
  </Accordion>
  ...
  <Accordion title="How do I set up Gemini CLI OAuth?">
    ...
    OAuth tokens are stored in auth profiles on the gateway host. Details: [Google](/en/providers/google), [Model providers](/en/concepts/model-providers).
