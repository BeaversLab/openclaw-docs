...
<a id="i-am-stuck" />
  ...
  <Accordion title="Does it run on Raspberry Pi?">
    ...
    also present hosted widgets in its native panel. See [Nodes](/en/nodes).

    Full setup walkthrough: [Raspberry Pi](/en/install/raspberry-pi).
  ...
  <Accordion title="Any tips for Raspberry Pi installs?">
    ...
    Full guide: [Raspberry Pi](/en/install/raspberry-pi). Also see [Linux](/en/platforms/linux).
  ...
  <Accordion title="It is stuck on wake up my friend / onboarding will not hatch. What now?">
    ...
    points at the right Gateway. See [Remote access](/en/gateway/remote).
  ...
  <Accordion title="How do I try the latest bits?">
    ...
    Docs: [Update](/en/cli/update), [Development channels](/en/install/development-channels), [Install](/en/install).
  ...
  <Accordion title="Installer stuck? How do I get more feedback?">
    ...
    `-Trace 0` instead. Full flag reference: [Installer flags](/en/install/installer).
  ...
  <Accordion title="Windows install says git not found or openclaw not recognized">
    ...
    **2) openclaw is not recognized after install**
    ...
    installer and WSL2 Gateway paths are both supported. Docs: [Windows](/en/platforms/windows).
  ...
  <Accordion title="What does onboarding actually do?">
    ...
    offers two lanes after a one-line pointer to the [security guide](/en/gateway/security):
    ...
    is in [Onboarding (CLI)](/en/start/wizard#what-classic-onboarding-configures).
    ...
    Full breakdown: [Onboarding (CLI)](/en/start/wizard).
  ...
  <Accordion title="Do I need a Claude or OpenAI subscription to run this?">
    ...
    [Qwen Cloud](/en/providers/qwen), [MiniMax](/en/providers/minimax), [Z.AI (GLM)](/en/providers/zai),
  ...
  <Accordion title="Can I use Claude Max subscription without an API key?">
    ...
    [Anthropic](/en/providers/anthropic) for the current billing detail and links to
  ...
  <Accordion title="Do you support Claude subscription auth (Claude Pro or Max)?">
    ...
    has changed over time; see [Anthropic](/en/providers/anthropic) for the current state and
    ...
    subscription-style hosted options: [OpenAI](/en/providers/openai), [Qwen Cloud](/en/providers/qwen),
...
<AccordionGroup>
  <Accordion title="Why am I seeing HTTP 429 rate_limit_error from Anthropic?">
    ...
    [Anthropic 429 extra usage required for long context](/en/gateway/troubleshooting#anthropic-429-extra-usage-required-for-long-context).
  ...
  <Accordion title="Is AWS Bedrock supported?">
    ...
    provider entry. See [Amazon Bedrock](/en/providers/bedrock) and [Model providers](/en/providers/models).
  ...
  <Accordion title="How does Codex auth work?">
    ...
    models too. See [Model providers](/en/concepts/model-providers) and
  ...
  <Accordion title="Can I use Gemini CLI or Antigravity OAuth?">
    ...
    Details: [Google](/en/providers/google), [Model providers](/en/concepts/model-providers).
  ...
  <Accordion title="Is a local model OK for casual chats?">
    ...
    can locally (LM Studio) - see [Local models](/en/gateway/local-models). Smaller/quantized
    models raise prompt-injection risk - see [Security](/en/gateway/security).
  </Accordion>
  ...
  <Accordion title="Do I have to buy a Mac Mini to install this?">
    ...
    You only need a Mac **for macOS-only tools**. For iMessage, use [iMessage](/en/channels/imessage)
  ...
  <Accordion title="Do I need a Mac mini for iMessage support?">
    ...
    Mac works. Use [iMessage](/en/channels/imessage) with `imsg`; the Gateway can run on that
  ...
  <Accordion title="Telegram: what goes in allowFrom?">
    ...
    See [Telegram access control](/en/channels/telegram#access-control-and-activation).

  </Accordion>

  <Accordion title="Can multiple people use one WhatsApp number with different OpenClaw instances?">
    Yes, via **multi-agent routing**. Bind each sender's WhatsApp DM (`peer: { kind: "direct", id: "+15551234567" }`) to a different `agentId`, giving each person their own workspace and session store. Replies still come from the **same WhatsApp account**; DM access control (`channels.whatsapp.dmPolicy` / `channels.whatsapp.allowFrom`) is global per account. See [Multi-Agent Routing](/en/concepts/multi-agent) and [WhatsApp](/en/channels/whatsapp).
  </Accordion>
  ...
  <Accordion title='Can I run a "fast chat" agent and an "Opus for coding" agent?'>
    ...
    [Multi-Agent Routing](/en/concepts/multi-agent). See also [Models](/en/concepts/models) and
  ...
  <Accordion title="Can I switch between npm and git installs later?">
    ...
    Backup tips: [Where things live on disk](/en/help/faq#where-things-live-on-disk).
  ...
  <Accordion title="Should I run the Gateway on my laptop or a VPS?">
    ...
    **VPS / cloud**
    ...
    trade-off is headless browser vs a visible window. See [Browser](/en/tools/browser).
  ...
  <Accordion title="How important is it to run OpenClaw on a dedicated machine?">
    ...
    **node** for local screen/camera/exec tools. See [Nodes](/en/nodes) and [Security](/en/gateway/security).
  ...
  <Accordion title="Can I run OpenClaw in a VM and what are the requirements?">
    ...
    with broad tooling compatibility. See [Windows](/en/platforms/windows), [VPS hosting](/en/vps).
    Running macOS in a VM: see [macOS VM](/en/install/macos-vm).
