...
<AccordionGroup>
  <Accordion title="I am stuck, fastest way to get unstuck">
    ...
    Quick debug loop: [First 60 seconds if something is broken](/en/help/faq#first-60-seconds-if-something-is-broken).
  ...
  <Accordion title="Can I migrate my setup to a new machine (Mac mini) without redoing onboarding?">
    ...
    **Important:** if you only commit/push your workspace to GitHub, you're backing
    ...
    Related: [Migrating](/en/install/migrating), [Where things live on disk](/en/help/faq#where-things-live-on-disk),
...
<AccordionGroup>
  ...
  <Accordion title="Do I have to buy a Mac Mini to install this?">
    ...
    You only need a Mac **for macOS-only tools**. For iMessage, use [iMessage](/en/channels/imessage) with `imsg` on any Mac signed into Messages. If the Gateway runs on Linux or elsewhere, set `channels.imessage.cliPath` to an SSH wrapper that runs `imsg` on that Mac. If you want other macOS-only tools, run the Gateway on a Mac or pair a macOS node.
  ...
  <Accordion title="Do I need a Mac mini for iMessage support?">
    ...
    any Mac works. **Use [iMessage](/en/channels/imessage)** with `imsg`; the Gateway can run on that Mac, or it can run elsewhere with an SSH wrapper `cliPath`.
    ...
    Docs: [iMessage](/en/channels/imessage), [Nodes](/en/nodes),
  ...
  <Accordion title="Can I switch between npm and git installs later?">
    ...
    Backup tips: see [Backup strategy](/en/help/faq#where-things-live-on-disk).
