...
<AccordionGroup>
  ...
  <Accordion title="I saw reports about exposed OpenClaw instances. What should I check?">
    ...
    Public binds without auth, open DMs/groups with tools, and exposed browser control are the findings to fix first. Details: [openclaw security audit](/en/gateway/security/running-the-audit#openclaw-security-audit).
