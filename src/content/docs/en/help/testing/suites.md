...
required check. See [surface ratchets](/en/ci/local-proof#surface-ratchets) for
...
<AccordionGroup>
  ...
  <Accordion title="Fast local iteration">
    ...
    - Local worker auto-scaling is intentionally conservative and backs off
      ...
      still apply. See [CI worker sizing](/en/ci/capacity#vitest-worker-sizing)
  ...
  <Accordion title="Perf debugging">
    ...
    - `pnpm test:perf:profile:runner` writes runner CPU+heap profiles for
      ...
      Both commands print their output directory; see [Test performance tooling](/en/reference/test/performance#test-performance-tooling)
