...
If your config still contains `channels.bluebubbles`, migrate it to `channels.imessage`. The legacy `/channels/bluebubbles` docs URL redirects to [Coming from BlueBubbles](/en/channels/imessage-from-bluebubbles), which has the full config translation table and cutover checklist.
...
- [Coming from BlueBubbles](/en/channels/imessage-from-bluebubbles)
