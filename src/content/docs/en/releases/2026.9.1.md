...
On a fresh local install, the recommended Quick Start path can reuse verified Claude Code or Codex access, or an existing provider key, and open the web dashboard after one choice. The [installation](/en/install) and [guided setup](/en/start/wizard) flow keeps the Gateway in the current terminal until you stop it with Ctrl+C, preserves the configuration afterward, and leaves background service installation as an explicit later step.
...
![Conceptual 2026.9.1 explainer: Quick Start reuses usable AI access while leaving service installation for later. Conceptual flow, not a terminal capture. Headless setup provides a one-time dashboard link and an SSH tunnel template.](https://github.com/user-attachments/assets/c490d5f0-e0c0-41bb-a625-d1962ddabd4c)

_Quick Start reuses usable AI access while leaving service installation for later. Conceptual illustration, not a screenshot. Conceptual flow, not a terminal capture. Headless setup provides a one-time dashboard link and an SSH tunnel template._
...
![Published 2026.9.1 interface: A proposed Harbor welcome route renders from Mermaid inside the published conversation. Fictional Harbor data; no live task execution.](https://github.com/user-attachments/assets/8c738afe-4d5f-4c8a-95e8-79aca5092ea5)

_A proposed Harbor welcome route renders from Mermaid inside the published conversation. Published 2026.9.1 interface with fictional Harbor data; no live task execution._
...
![Published 2026.9.1 interface: The draft, agent workspace, model, and effort controls stay together on New Session. Fictional Harbor data; no live task execution.](https://github.com/user-attachments/assets/2193783b-9495-4f7d-b260-8663c66b9891)

_The draft, agent workspace, model, and effort controls stay together on New Session. Published 2026.9.1 interface with fictional Harbor data; no live task execution._
...
![Conceptual 2026.9.1 explainer: A bounded, sanitized failure record carries useful context into the triage conversation. Conceptual flow. JSON, --yes, background, and managed-service runs remain diagnostic-only.](https://github.com/user-attachments/assets/7237e4b3-69d9-412b-9225-3ba8ebf47d5a)

_A bounded, sanitized failure record carries useful context into the triage conversation. Conceptual illustration, not a screenshot. Conceptual flow. JSON, --yes, background, and managed-service runs remain diagnostic-only._
...
Messaging in [channels](/en/channels) is less about whether a reply was technically sent and more about whether it arrived in the right conversation with its context, controls, and final outcome intact. This release carries that work across approvals, thread routing, rich replies, queues, restarts, voice, and the failure paths that used to leave either the person or the operator guessing.
...
![Conceptual 2026.9.1 explainer: The explicit memory reset path removes rebuildable search data while keeping durable sources. Conceptual boundary. Confirmation is required; non-interactive use requires --yes. A later rebuild may use a paid embedding provider.](https://github.com/user-attachments/assets/d0649c3a-058a-420b-b954-7631687cc3e5)

_The explicit memory reset path removes rebuildable search data while keeping durable sources. Conceptual illustration, not a screenshot. Conceptual boundary. Confirmation is required; non-interactive use requires --yes. A later rebuild may use a paid embedding provider._
...
![Published 2026.9.1 interface: The real library distinguishes private, shared, and team-owned Harbor skills. Fictional Harbor data; no live task execution.](https://github.com/user-attachments/assets/579d1f9e-c660-4beb-b19c-dcac860cc142)

_The real library distinguishes private, shared, and team-owned Harbor skills. Published 2026.9.1 interface with fictional Harbor data; no live task execution._
...
The native apps take two visible steps forward in this release. [Android](/en/platforms/android) gets a much fuller everyday workspace for chat, sessions, navigation, and appearance, while Android, [iPhone and iPad](/en/platforms/ios), and [macOS](/en/platforms/macos) can turn Mermaid source into readable diagrams inside the conversation. Around those larger changes, reconnects hold on to accepted work, voice stays with the turn that started it, and several platform-specific setup and helper paths handle failure more cleanly.
...
![Conceptual 2026.9.1 explainer: The 9.1 native experience brings everyday conversation controls into reachable places. Conceptual feature map—not an Android screenshot. No current native UI is presented as historical 9.1 evidence.](https://github.com/user-attachments/assets/11aef2d0-ede4-4b8e-800a-99febff8ad9b)

_The 9.1 native experience brings everyday conversation controls into reachable places. Conceptual illustration, not a screenshot. Conceptual feature map—not an Android screenshot. No current native UI is presented as historical 9.1 evidence._
...
![Published 2026.9.1 interface: Model, utility model, fallback, thinking, and Fast Mode share the Defaults card. Fictional Harbor data; no live task execution.](https://github.com/user-attachments/assets/f7fdec9e-c58e-417d-941a-fddabcedff06)

_Model, utility model, fallback, thinking, and Fast Mode share the Defaults card. Published 2026.9.1 interface with fictional Harbor data; no live task execution._
...
![Conceptual 2026.9.1 explainer: With cron.skipMissedJobs enabled, downtime does not trigger a backlog of recurring garden reminders. Conceptual timeline. This is opt-in: unset or false retains the existing catch-up behavior.](https://github.com/user-attachments/assets/4aa5ac9d-8db2-4ebe-8251-fe600ac80b10)

_With cron.skipMissedJobs enabled, downtime does not trigger a backlog of recurring garden reminders. Conceptual illustration, not a screenshot. Conceptual timeline. This is opt-in: unset or false retains the existing catch-up behavior._
...
![Published 2026.9.1 interface: Four fictional Harbor conversations populate the real session catalog; no benchmark is implied. Fictional Harbor data; no live task execution.](https://github.com/user-attachments/assets/08c6c1fc-1ac7-4c72-bef6-f677f44b71e6)

_Four fictional Harbor conversations populate the real session catalog; no benchmark is implied. Published 2026.9.1 interface with fictional Harbor data; no live task execution._
