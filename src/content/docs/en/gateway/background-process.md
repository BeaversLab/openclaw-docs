...
[session, agent, or shared lifetime](/en/gateway/sandboxing#modes-scope-and-backend). It joins the local
...
In [Code Mode](/en/tools/code-mode), `process` returns its structured details directly.
