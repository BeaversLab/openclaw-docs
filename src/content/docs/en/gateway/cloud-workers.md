...
- [Dispatching a cloud session](/en/gateway/cloud-workers/dispatching-a-session) — the four eligibility gates, the Control UI **Place** picker, cloud child sessions, and which runtimes support cloud placement.
