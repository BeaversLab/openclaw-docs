...
[plugin guide](/en/plugins/onepassword) for manual configuration, custom targets,
...
[plugin setup flow](/en/gateway/1password#resolve-config-secrets-with-the-plugin). Manual exec
