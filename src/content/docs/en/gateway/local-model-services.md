...
Replace `command` with the result of `which llmman` on the machine running OpenClaw. Full llmman setup: [llmman](/en/providers/llmman).
...
<CardGroup cols={2}>
  ...
  <Card title="llmman" href="/en/providers/llmman" icon="cpu">
