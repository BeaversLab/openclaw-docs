...
See [llama.cpp Provider](/en/plugins/llama-cpp).
...
Replace `command` with the result of `which inferrs` on the machine running OpenClaw. Full inferrs setup: [Inferrs](/en/providers/inferrs).
...
Full setup, context sizing, and verification commands: [ds4](/en/providers/ds4).
...
<CardGroup cols={2}>
  ...
  <Card title="Inferrs" href="/en/providers/inferrs" icon="cpu">
