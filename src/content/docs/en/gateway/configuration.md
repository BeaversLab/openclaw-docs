...
<AccordionGroup>
  ...
  <Accordion title="Restrict skills per agent">
    ...
    - See [Skills](/en/tools/skills), [Skills config](/en/tools/skills-config), and
      the [Configuration Reference](/en/gateway/config-agents#agents-defaults-skills).
  ...
  <Accordion title="Configure per-channel health monitoring">
    ...
    - See [Health Checks](/en/gateway/health) for operational debugging and the [full reference](/en/gateway/configuration-reference#gateway) for all fields.
  ...
  <Accordion title="Configure sessions and resets">
    ...
    - See [full reference](/en/gateway/config-agents#session) for all fields.
  ...
  <Accordion title="Enable sandboxing">
    ...
    See [Sandboxing](/en/gateway/sandboxing) for the full guide and [full reference](/en/gateway/config-agents#agentsdefaultssandbox) for all options.
  ...
  <Accordion title="Configure multi-agent routing">
    ...
    See [Multi-Agent](/en/concepts/multi-agent) and [full reference](/en/gateway/config-agents#multi-agent-routing) for binding rules and per-agent access profiles.
