...
[Configuration reference](/en/gateway/configuration-reference#diagnostics).
...
See the [Gateway RPC method reference](/en/gateway/protocol#rpc-method-families)
...
- [Configuration reference](/en/gateway/configuration-reference#diagnostics) - full `diagnostics.*` field reference
