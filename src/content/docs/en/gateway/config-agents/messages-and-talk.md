...
Batching is a bounded timing heuristic, not a guarantee that every part of a long message becomes one turn. See [Inbound debouncing](/en/concepts/messages#inbound-debouncing) and [Telegram inbound text batching](/en/channels/telegram/messaging#inbound-text-batching).
