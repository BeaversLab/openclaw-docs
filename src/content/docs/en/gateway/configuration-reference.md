...
Core config reference for `~/.openclaw/openclaw.json`. For a task-oriented overview, see [Configuration](/en/gateway/configuration).
...
[Configuration](/en/gateway/configuration) for task-oriented guidance and this page
...
[Configuration - channels](/en/gateway/config-channels) for `channels.*`,
...
[Configuration - agents](/en/gateway/config-agents) for:
...
- `plugins.entries.codex.config.codexPlugins.plugins.<key>.marketplaceName`:
  ...
  [Native Codex plugins](/en/plugins/codex-native-plugins#manual-first-party-marketplace-entries)
