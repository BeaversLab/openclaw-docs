...
before starting the Gateway again. See [activation behavior](/en/gateway/secrets/operations#activation-triggers).
The [1Password integration](/en/gateway/secrets/integration-examples#1password) retains
