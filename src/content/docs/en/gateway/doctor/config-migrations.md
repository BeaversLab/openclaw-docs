...
model value into a different embedding model. See [llama.cpp](/en/plugins/llama-cpp).
...
<AccordionGroup>
  ...
  <Accordion title="2. Legacy config key migrations">
    ...
    <Note>
      ...
      [configuration reference](/en/gateway/configuration-reference) before doctor
      can proceed.
    </Note>
