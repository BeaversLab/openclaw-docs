...
<AccordionGroup>
  <Accordion title="3. Legacy state migrations (disk layout)">
    ...
    Doctor then repairs missing canonical workspace metadata on managed-worktree sessions after session-key repairs have settled. Startup reports those pending repairs without applying them. Current schema opening, readiness validation, transcript projections, and live-run recovery remain with their runtime owners.
