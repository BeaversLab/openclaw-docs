...
<Tabs>
  <Tab title="--yes">
    ...
    Accept default non-service repairs without prompting and enter maintenance under the [service-preservation and installation-drift rules](/en/cli/doctor/recovery#gateway-service-recovery).
  ...
  <Tab title="--fix">
    ...
    Apply recommended non-service repairs without prompting (`--repair` is an alias) and enter maintenance under the [service-preservation and installation-drift rules](/en/cli/doctor/recovery#gateway-service-recovery).
