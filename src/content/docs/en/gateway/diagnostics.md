...
yourself. See [Codex harness](/en/plugins/codex-harness/commands#inspect-codex-threads-locally).
...
individual child-command timings. See [Slow worktree cleanup](/en/logging#slow-worktree-cleanup)
