...
[`openclaw audit --execution <id> --explain`](/en/cli/audit). Use `--run <id>
...
See [Audit records](/en/cli/audit) for the full field reference and query filters.

## Message lifecycle events

Set [`logging.audit.messages`](/en/gateway/configuration-reference#audit) to choose what
...
[OpenTelemetry](/en/gateway/opentelemetry) or channel-level tooling.
...
- CLI: [`openclaw audit`](/en/cli/audit) with filters for agent, session, run,
...
- [Audit records CLI](/en/cli/audit)
- [Configuration reference](/en/gateway/configuration-reference#audit)
- [Gateway protocol](/en/gateway/protocol#audit-ledger-rpc)
- [OpenTelemetry](/en/gateway/opentelemetry)
