...
- Clients that connect without the required device identity. The current Control UI can create and sign identity over plain HTTP; see [Insecure HTTP](/en/web/control-ui#insecure-http).
