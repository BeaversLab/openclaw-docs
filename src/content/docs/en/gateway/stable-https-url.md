...
If you need a public URL, use [Tailscale Funnel](/en/gateway/tailscale#public-internet-funnel-shared-password) instead. Funnel is public, and OpenClaw requires password auth for it.
