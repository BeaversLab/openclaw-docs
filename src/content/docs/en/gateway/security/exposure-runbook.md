...
This runbook turns the broader [Security](/en/gateway/security) guidance into an
...
documented for the deployment. See [Security audit checks](/en/gateway/security/audit-checks)
