...
Follow [Install the packages](/en/gateway/clients#install-the-packages) for the
...
[Building a Gateway client](/en/gateway/clients). For apps
...
separate from [scheduled agent heartbeats](/en/gateway/heartbeat); disabling agent
