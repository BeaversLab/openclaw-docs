...
<AccordionGroup>
  ...
  <Accordion title="Automation, skills, and tools">
    ...
    - Skills and tools: `commands.list`, `skills.*`, `tools.catalog`, `tools.effective`, `tools.invoke`. See [Operator helper methods](/en/gateway/protocol/operator-methods#operator-helper-methods).
