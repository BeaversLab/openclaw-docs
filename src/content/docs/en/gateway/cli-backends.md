...
Docker installs need Claude Code installed and logged in inside the persisted container home, not only on the host. See [Claude CLI backend in Docker](/en/install/docker#claude-cli-backend-in-docker).
