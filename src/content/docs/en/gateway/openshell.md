...
bridge as the generic [SSH backend](/en/gateway/sandboxing#ssh-backend). It adds
...
[Sandboxing](/en/gateway/sandboxing) for the full matrix.
...
- [Sandboxing](/en/gateway/sandboxing) -- modes, scopes, and backend comparison
- [Sandbox vs Tool Policy vs Elevated](/en/gateway/sandbox-vs-tool-policy-vs-elevated) -- debugging blocked tools
- [Multi-Agent Sandbox and Tools](/en/tools/multi-agent-sandbox-tools) -- per-agent overrides
- [Sandbox CLI](/en/cli/sandbox) -- `openclaw sandbox` commands
