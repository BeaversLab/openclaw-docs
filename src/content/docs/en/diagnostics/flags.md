...
See [Environment variables](/en/help/environment) for where OpenClaw reads
...
See [Logging](/en/logging) for the full log-path resolution, rotation, and
redaction model.
...
- [Gateway diagnostics](/en/gateway/diagnostics)
