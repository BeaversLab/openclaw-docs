...
Chrome. See [`openclaw browser`](/en/cli/browser) for the full `browser extension`
...
[`browser.profiles`](/en/gateway/config-browser-ui-desktop#browser) and permits
...
[`browser.extensionRelay.allowLegacyAuth=true`](/en/gateway/config-browser-ui-desktop#browser)
...
See [Browser](/en/tools/browser) for the full profile model and the managed
