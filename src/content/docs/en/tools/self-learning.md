...
follow. [Skill Workshop](/en/tools/skill-workshop) owns the agent's learned skills.
...
one Workshop slot within the [shared background work budget](/en/concepts/queue#background-work).
...
backups keep their [restore path](/en/tools/skill-workshop#changes-and-recovery).
...
Weekly [collection review](/en/tools/skill-workshop#collection-review) uses the
...
See [Skills config](/en/tools/skills-config#workshop-skills-workshop) for ranges and
...
- [Skill Workshop](/en/tools/skill-workshop) for proposal lifecycle and storage
- [Creating skills](/en/tools/creating-skills) for hand-authored skills
- [Skills config](/en/tools/skills-config) for every `skills.*` setting
- [Skills CLI](/en/cli/skills) for Workshop commands
