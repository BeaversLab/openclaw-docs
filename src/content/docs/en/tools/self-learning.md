...
[Skill Workshop](/en/tools/skill-workshop) proposals. It does not train model
...
[Skill Workshop](/en/tools/skill-workshop) for the complete lifecycle and storage
model.
...
[Skills config](/en/tools/skills-config#workshop-skills-workshop).
...
- [Skill Workshop](/en/tools/skill-workshop) for proposal review, approval, and
  storage
- [Creating skills](/en/tools/creating-skills) for hand-authored skills and
  `SKILL.md` structure
- [Skills config](/en/tools/skills-config) for all `skills.*` settings
- [Skills CLI](/en/cli/skills) for Workshop and curator commands
