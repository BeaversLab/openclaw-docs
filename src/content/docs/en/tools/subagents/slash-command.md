...
chat **Tasks** tab, and the [Tasks page](/en/automation/tasks#control-ui). They do not
...
[Thread supporting channels](/en/tools/subagents/thread-bound-sessions#thread-supporting-channels).
