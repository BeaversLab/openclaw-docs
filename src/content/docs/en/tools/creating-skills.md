...
OpenClaw loads skills from several roots in a defined [precedence order](/en/tools/skills#loading-order).
...
team setup. See [personal skills and revisions](/en/tools/skills#personal-skills-on-a-shared-gateway)
...
[Skills — Gating](/en/tools/skills#gating).
...
<AccordionGroup>
  <Accordion title="Gating options">
    ...
    Full reference: [Skills — Gating](/en/tools/skills#gating).
  ...
  <Accordion title="Environment and API keys">
    ...
    [sandboxed env vars](/en/tools/skills-config#sandboxed-skills-and-env-vars).
...
live, use [Skill Workshop](/en/tools/skill-workshop) proposals instead of writing
`SKILL.md` directly.
...
See [Skill Workshop](/en/tools/skill-workshop) for the full proposal lifecycle.
...
<Steps>
  ...
  <Step title="Publish">
    ...
    [ClawHub — Publishing](/en/clawhub/publishing) and
    [ClawHub CLI](/en/clawhub/cli) for the full flow, owner scoping, and other
...
<CardGroup cols={2}>
  <Card title="Skills reference" href="/en/tools/skills" icon="puzzle-piece">
