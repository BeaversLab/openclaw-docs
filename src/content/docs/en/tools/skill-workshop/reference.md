...
store. See [Self-learning](/en/tools/self-learning#cost-and-privacy) for model usage
and privacy.
...
[manual backup recovery procedure](/en/tools/skill-workshop/collection-review#when-an-older-backup-cannot-be-restored-automatically)
