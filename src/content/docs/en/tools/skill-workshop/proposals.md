...
[manual recovery guidance](/en/tools/skill-workshop/collection-review#when-an-older-backup-cannot-be-restored-automatically)
...
unbounded operator [CLI command](/en/tools/skill-workshop/authoring#cli).
...
[Self-learning and approval settings](/en/tools/skill-workshop/configuration) instead.
