...
See [Schema bumps and older updaters](/en/reference/database-schemas#schema-bumps-and-older-updaters)
and [Downgrade recovery](/en/reference/database-schemas#downgrade-recovery).
...
grant themselves. See [Personal library authoring](/en/tools/skill-workshop/personal-library).
