...
[ACP agents - setup](/en/tools/acp-agents-setup) only when the harness should
...
[Codex harness troubleshooting](/en/plugins/codex-harness#troubleshooting).
</Note>
