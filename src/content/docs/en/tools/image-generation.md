...
of `api.openai.com`, see [Azure OpenAI endpoints](/en/providers/openai#azure-openai-endpoints)
...
- [Configuration Reference](/en/gateway/configuration-reference#agent-defaults) — `imageGenerationModel` config
