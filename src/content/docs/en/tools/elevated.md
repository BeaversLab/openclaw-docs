...
<CardGroup cols={2}>
  ...
  <Card title="Sandbox vs Tool Policy vs Elevated" href="/en/gateway/sandbox-vs-tool-policy-vs-elevated" icon="scale-balanced">
    How the three gates compose during a tool call.
  </Card>
  <Card title="Multi-agent sandbox and tools" href="/en/tools/multi-agent-sandbox-tools" icon="shield">
    Per-agent sandbox and tool limits.
  </Card>
  <Card title="Thinking levels" href="/en/tools/thinking" icon="brain">
