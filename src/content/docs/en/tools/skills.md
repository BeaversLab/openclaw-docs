...
See [Plugins](/en/tools/plugin) for discovery/config and [Tools](/en/tools) for
...
its proposals. Full guide: [Skill Workshop plugin](/en/plugins/skill-workshop).
...
[Sandboxing](/en/gateway/sandboxing) for the agent-side controls.
</Warning>
...
schema: [Skills config](/en/tools/skills-config).

## Related

- [ClawHub](/en/tools/clawhub) — public skills registry
- [Creating skills](/en/tools/creating-skills) — building custom skills
- [Plugins](/en/tools/plugin) — plugin system overview
- [Skill Workshop plugin](/en/plugins/skill-workshop) — generate skills from agent work
