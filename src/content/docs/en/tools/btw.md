...
questions report it through the configured [diagnostics pipeline](/en/gateway/opentelemetry).
...
<CardGroup cols={2}>
  ...
  <Card title="Session" href="/en/concepts/session" icon="comments">
    Session keys, history, and persistence semantics.
  </Card>
  <Card title="Steer command" href="/en/tools/steer" icon="arrow-right">
