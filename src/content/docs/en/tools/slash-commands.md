...
- `/compact [instructions]` compacts the session context. See [/concepts/compaction](/en/concepts/compaction).
...
- `/btw <question>` asks a side question without changing future session context. See [/tools/btw](/en/tools/btw).
...
- `/tts on|off|status|provider|limit|summary|audio|help` controls TTS. See [/tools/tts](/en/tools/tts).
