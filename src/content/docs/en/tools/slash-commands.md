...
The setting also accepts `"agent"` and `"global"`; it does not grant permission to write configured defaults. See [Model selection scope](/en/gateway/config-agents#agentsdefaultsmodelselectionscope).
