...
<AccordionGroup>
  ...
  <Accordion title="Discovery and status">
    ...
    | `/goal [status\|start\|pause\|resume\|complete\|block\|clear] ...` | Manage the current session's durable [goal](/en/tools/goal) |
...
| `/codex status\|models\|threads\|resume\|compact\|review\|diagnostics\|account\|mcp\|skills` | Control the Codex app-server harness. See [Codex harness](/en/plugins/codex-harness)   |
