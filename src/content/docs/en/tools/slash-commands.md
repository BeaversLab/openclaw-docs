...
<AccordionGroup>
  <Accordion title="Sessions and runs">
    ...
    - `/export-trajectory [path]` exports a JSONL [trajectory bundle](/en/tools/trajectory) for the current session. Alias: `/trajectory`.
  </Accordion>
...
- `/codex status|models|threads|resume|compact|review|account|mcp|skills` inspects and controls the bundled Codex app-server harness. See [Codex harness](/en/plugins/codex-harness).
- QQBot-only commands:
  - `/bot-ping`
  - `/bot-version`
  - `/bot-help`
