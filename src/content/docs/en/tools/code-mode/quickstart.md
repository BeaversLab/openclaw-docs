...
[Code Mode executors](/en/tools/code-mode/executors) before choosing: `node:vm`
is not a security boundary.

See [Automatic per-model activation](/en/tools/code-mode/configuration#automatic-per-model-activation) for the
