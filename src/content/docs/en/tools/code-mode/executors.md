...
See [Code Mode configuration](/en/tools/code-mode/configuration) for activation
...
[Code Mode internals](/en/tools/code-mode/internals#run-and-snapshot-lifecycle)
...
- [Code Mode quickstart](/en/tools/code-mode/quickstart)
- [Code Mode configuration](/en/tools/code-mode/configuration)
