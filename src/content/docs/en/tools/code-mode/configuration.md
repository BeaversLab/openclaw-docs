...
`true` or `"auto"` explicitly, or use an [agent or model override](/en/tools/code-mode/quickstart#override-one-model).
...
4. Resolve activation using the [agent and model precedence](/en/tools/code-mode/quickstart#override-one-model).
