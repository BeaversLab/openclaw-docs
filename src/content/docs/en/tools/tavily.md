...
<CardGroup cols={2}>
  <Card title="Web Search overview" href="/en/tools/web" icon="magnifying-glass">
    All providers and auto-detection rules.
  </Card>
  <Card title="Firecrawl" href="/en/tools/firecrawl" icon="fire">
    Search plus scraping with content extraction.
  </Card>
  <Card title="Exa Search" href="/en/tools/exa-search" icon="binoculars">
