...
- **No clobber:** create fails if the target already exists in that agent's
  ...
  For same-named skills, [loading order](/en/tools/skills#loading-order) determines
...
[Self-learning](/en/tools/self-learning). Set `skills.workshop.autonomous.mode` to
...
See [Self-learning](/en/tools/self-learning) for enablement, eligibility, privacy and cost details,
...
See [Self-learning](/en/tools/self-learning) for the complete autonomous review behavior and safety
model.
