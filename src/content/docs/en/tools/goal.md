...
A goal is not a task queue. Use [Task Flow](/en/automation/taskflow),
[tasks](/en/automation/tasks), [cron jobs](/en/automation/cron-jobs), or
[standing orders](/en/automation/standing-orders) when work should run detached,
...
- [TUI](/en/web/tui)
- [Session tool](/en/concepts/session-tool)
- [Compaction](/en/concepts/compaction)
- [Task Flow](/en/automation/taskflow)
