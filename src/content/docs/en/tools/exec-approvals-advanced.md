...
For the core policy and approval flow, see [Exec approvals](/en/tools/exec-approvals).
...
FAQ: [Why are there two exec approval configs for chat approvals?](/en/help/faq-first-run#why-are-there-two-exec-approval-configs-for-chat-approvals)
...
- [Exec approvals](/en/tools/exec-approvals) — core policy and approval flow
- [Exec tool](/en/tools/exec)
- [Elevated mode](/en/tools/elevated)
- [Skills](/en/tools/skills) — skill-backed auto-allow behavior
