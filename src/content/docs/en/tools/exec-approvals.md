...
FAQ: [Why are there two exec approval configs for chat approvals?](/en/help/faq#why-are-there-two-exec-approval-configs-for-chat-approvals)
...
- [Exec](/en/tools/exec) — shell command execution tool
- [Sandboxing](/en/gateway/sandboxing) — sandbox modes and workspace access
- [Security](/en/gateway/security) — security model and hardening
- [Sandbox vs Tool Policy vs Elevated](/en/gateway/sandbox-vs-tool-policy-vs-elevated) — when to use each
