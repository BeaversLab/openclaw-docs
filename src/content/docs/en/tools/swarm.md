...
[Code Mode](/en/tools/code-mode) script. Use normal JavaScript or TypeScript
...
See [Code Mode activation](/en/tools/code-mode#activation) and
[Sub-agents](/en/tools/subagents) if a script reports that `sessions_spawn` is
unavailable.
