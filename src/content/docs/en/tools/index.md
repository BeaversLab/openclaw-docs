...
| Teach an agent a workflow                   | [Skills](#choose-tools-skills-or-plugins)      | [Skills](/en/tools/skills) and [Creating skills](/en/tools/creating-skills)   |
...
| Search a large PI tool catalog              | [Tool Search](/en/tools/tool-search)              | [Tool Search](/en/tools/tool-search)                                       |
...
<Steps>
  ...
  <Step title="Use a skill when the agent needs instructions">
    ...
    [Skills](/en/tools/skills) | [Creating skills](/en/tools/creating-skills) | [Skills config](/en/tools/skills-config)
...
| Large PI catalogs      | Search and call many eligible tools without sending every schema to the model | `tool_search_code`, `tool_search`, `tool_describe`                   | [Tool Search](/en/tools/tool-search)                                      |
...
- [Elevated exec](/en/tools/elevated) documents controlled execution outside the
  sandbox.
- [Sandbox vs tool policy vs elevated](/en/gateway/sandbox-vs-tool-policy-vs-elevated) explains which layer controls file and process access.
...
2. Check provider-specific restrictions in
   [Tools and custom providers](/en/gateway/config-tools) and confirm the selected
   [model provider](/en/concepts/model-providers) supports the tool shape.
3. Check channel permissions, sandbox state, and elevated access with
   [Sandbox vs tool policy vs elevated](/en/gateway/sandbox-vs-tool-policy-vs-elevated) and [Elevated exec](/en/tools/elevated).
...
- [Automation](/en/automation) for cron, tasks, heartbeat, commitments, hooks, standing orders, and Task Flow
- [Agents](/en/concepts/agent) for the agent model, sessions, memory, and multi-agent coordination
- [Tools and custom providers](/en/gateway/config-tools) for the canonical tool policy reference
...
- [Tool Search](/en/tools/tool-search) for compact PI tool catalog discovery
