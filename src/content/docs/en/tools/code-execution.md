...
a notebook session. For fresh X data, run [`x_search`](/en/tools/web#x_search)
first and pipe the result in.

For local execution, use [`exec`](/en/tools/exec) instead.
...
<CardGroup cols={2}>
  ...
  <Card title="Code Mode" href="/en/tools/code-mode" icon="code">
