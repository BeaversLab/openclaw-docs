...
[plugin manifest](/en/plugins/manifest/surfaces#themes). Definitions never contain
...
- [Plugin theme declarations](/en/plugins/manifest/surfaces#themes)
- [Manage plugins](/en/plugins/manage-plugins)
- [Control UI](/en/web/control-ui)
- [Screen tool](/en/tools/screen)
