...
For full policy details and examples, see [Exec approvals](/en/tools/exec-approvals#safe-bins-stdin-only) and [Safe bins versus allowlist](/en/tools/exec-approvals#safe-bins-versus-allowlist).
