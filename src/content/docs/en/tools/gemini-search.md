...
When a header contains a secret, use a [SecretRef](/en/gateway/secrets) value as
...
- [Brave Search](/en/tools/brave-search) -- structured results with snippets
- [Perplexity Search](/en/tools/perplexity-search) -- structured results with domain filtering
- [Kimi search](/en/tools/kimi-search) -- Kimi web search via Moonshot
