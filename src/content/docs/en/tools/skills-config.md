...
See [Self-learning](/en/tools/self-learning) for eligibility, privacy, cost,
...
See [Skill Workshop](/en/tools/skill-workshop) for the proposal lifecycle, CLI
...
See [Loading order](/en/tools/skills#loading-order) for source precedence, including
the per-agent Workshop tier, and [Snapshots and refresh](/en/tools/skills#snapshots-and-refresh)
...
<CardGroup cols={2}>
  ...
  <Card title="Self-learning" href="/en/tools/self-learning" icon="brain">
