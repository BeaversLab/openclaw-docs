...
- If you are debugging ComfyUI-specific behavior, see [ComfyUI](/en/providers/comfy). If you are debugging shared provider behavior, start with [Google (Gemini)](/en/providers/google) or [MiniMax](/en/providers/minimax).
...
- [Configuration Reference](/en/gateway/configuration-reference#agent-defaults) - `musicGenerationModel` config
