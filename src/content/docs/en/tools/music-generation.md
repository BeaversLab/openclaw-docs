...
[MiniMax](/en/providers/minimax#music-generation).
...
[Background tasks](/en/automation/tasks#task-lifecycle) for the full state
...
[ComfyUI](/en/providers/comfy). If you are debugging shared provider
behavior, start with [fal](/en/providers/fal), [Google (Gemini)](/en/providers/google),
[MiniMax](/en/providers/minimax), or [OpenRouter](/en/providers/openrouter).
...
- [Background tasks](/en/automation/tasks) — task tracking for detached `music_generate` runs
- [ComfyUI](/en/providers/comfy)
- [Configuration reference](/en/gateway/config-agents#agent-defaults) — `agents.defaults.mediaModels.music` config
