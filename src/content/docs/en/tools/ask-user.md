...
Questions from a standalone [attached MCP client](/en/cli/attach) do not carry an
...
uses the [`secrets` tool](/en/tools/secrets), whose masked prompt stores the value
