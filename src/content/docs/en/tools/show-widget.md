...
The iframe also follows [`gateway.controlUi.embedSandbox`](/en/web/control-ui#hosted-embeds). The default `scripts` tier supports interactive widgets while preserving origin isolation.
...
- [Control UI hosted embeds](/en/web/control-ui#hosted-embeds)
- [Discord Activities](/en/channels/discord-activities)
- [macOS widget panel](/en/platforms/mac/canvas)
- [Gateway protocol client capabilities](/en/gateway/protocol#client-capabilities)
