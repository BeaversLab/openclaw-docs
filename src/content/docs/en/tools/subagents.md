...
Use top-level [`/steer <message>`](/en/tools/steer) to steer the current requester session's active run. Use `/subagents steer <id|#> <message>` when the target is a child run.
