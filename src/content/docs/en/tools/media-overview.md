...
[Media understanding](/en/nodes/media-understanding#provider-support-matrix).
</Note>
...
For live user conversations, prefer [Talk mode](/en/nodes/talk). Batch audio
