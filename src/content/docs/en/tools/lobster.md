...
see [Task Flow](/en/automation/taskflow) (`openclaw tasks flow`); for the task
activity ledger, see [Background Tasks](/en/automation/tasks).
...
on the next startup. See [Apply changes and inspect](/en/plugins/manage-plugins#apply-changes-and-inspect).
...
runtime's managed [Task Flow](/en/automation/taskflow) API instead of returning
...
[Task Flow](/en/automation/taskflow) for the runnable examples and child-linking
contract.
...
- [Plugin tool authoring](/en/plugins/building-plugins#registering-agent-tools)
...
- [Automation](/en/automation) - all automation mechanisms
- [Tools Overview](/en/tools) - all available agent tools
- [Lobster plugin reference](/en/plugins/reference/lobster) - manifest, config, and tool reference for the plugin
