...
[ClawHub](/en/tools/clawhub). Npm remains supported for direct installs and for a
...
See [Plugin dependency resolution](/en/plugins/dependency-resolution) for the
...
Both show up under `openclaw plugins list`. See [Plugin Bundles](/en/plugins/bundles) for bundle details.

If you are writing a native plugin, start with [Building Plugins](/en/plugins/building-plugins)
and the [Plugin SDK Overview](/en/plugins/sdk-overview).
...
| Plugin          | Package                    | Docs                                       |
| --------------- | -------------------------- | ------------------------------------------ |
| BlueBubbles     | `@openclaw/bluebubbles`    | [BlueBubbles](/en/channels/bluebubbles)       |
| Discord         | `@openclaw/discord`        | [Discord](/en/channels/discord)               |
| Feishu          | `@openclaw/feishu`         | [Feishu](/en/channels/feishu)                 |
| Matrix          | `@openclaw/matrix`         | [Matrix](/en/channels/matrix)                 |
| Mattermost      | `@openclaw/mattermost`     | [Mattermost](/en/channels/mattermost)         |
| Microsoft Teams | `@openclaw/msteams`        | [Microsoft Teams](/en/channels/msteams)       |
| Nextcloud Talk  | `@openclaw/nextcloud-talk` | [Nextcloud Talk](/en/channels/nextcloud-talk) |
| Nostr           | `@openclaw/nostr`          | [Nostr](/en/channels/nostr)                   |
| Synology Chat   | `@openclaw/synology-chat`  | [Synology Chat](/en/channels/synology-chat)   |
| Tlon            | `@openclaw/tlon`           | [Tlon](/en/channels/tlon)                     |
| WhatsApp        | `@openclaw/whatsapp`       | [WhatsApp](/en/channels/whatsapp)             |
...
<AccordionGroup>
  ...
  <Accordion title="Memory plugins">
    ...
    See [Memory LanceDB](/en/plugins/memory-lancedb) for OpenAI-compatible
...
Looking for third-party plugins? See [Community Plugins](/en/plugins/community).
...
- If one plugin intentionally replaces another for the same channel id, the
  ...
  the lower-priority plugin id. See [/plugins/manifest#replacing-another-channel-plugin](/en/plugins/manifest#replacing-another-channel-plugin).
...
See [`openclaw plugins` CLI reference](/en/cli/plugins) for full details.
...
[Codex harness v1 support contract](/en/plugins/codex-harness#v1-support-contract).
...
- [Plugin internals](/en/plugins/architecture) — capability model and load pipeline
- [Community plugins](/en/plugins/community) — third-party listings
