...
`/settings/secrets` page, or the [`openclaw secrets store` CLI](/en/cli/secrets).
...
- [Ask user](/en/tools/ask-user) — structured questions for non-credential decisions. A credential is never a valid answer to one
