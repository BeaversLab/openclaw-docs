...
- [`openclaw dashboard`](/en/cli/dashboard) — open the Control UI from the CLI
- [Control UI URLs](/en/web/urls) — reaching the Control UI in a browser
