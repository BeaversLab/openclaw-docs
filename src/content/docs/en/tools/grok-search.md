...
[`x_search`](/en/tools/web#x_search) with the exact post URL or status ID
...
- [x_search in Web Search](/en/tools/web#x_search) -- first-class X search via xAI
- [Gemini Search](/en/tools/gemini-search) -- AI-synthesized answers via Google grounding
- [Kimi search](/en/tools/kimi-search) — the Moonshot-backed search tool
