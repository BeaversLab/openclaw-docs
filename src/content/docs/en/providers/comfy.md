...
Prefer a [secret reference](/en/gateway/configuration-reference#secrets) for credentials.
...
`apiKey` accepts either a literal string or a [secret reference](/en/gateway/configuration-reference#secrets) object.
