...
Prefer a [secret reference](/en/gateway/config-secrets-env#secrets) for credentials.
...
`apiKey` accepts either a literal string or a [secret reference](/en/gateway/config-secrets-env#secrets) object.
...
<CardGroup cols={2}>
  ...
  <Card title="Provider Directory" href="/en/providers/index" icon="layers">
