...
For new Qwen Cloud setups, prefer [Qwen](/en/providers/qwen) with the Standard
...
Choose [Qwen](/en/providers/qwen) for new setup, broader endpoint choices, Standard
