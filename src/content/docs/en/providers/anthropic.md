...
More details: [/gateway/cli-backends](/en/gateway/cli-backends)
...
- If you see “OAuth token refresh failed …” on a Claude subscription, re-auth with a setup-token. See [/gateway/troubleshooting](/en/gateway/troubleshooting).
