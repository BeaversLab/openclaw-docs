...
see [Hosted model catalog](/en/concepts/models#hosted-catalog-updates).
...
can persist inherited costs as explicit overrides. Historical recorded costs are preserved; current pricing fills only missing costs or unknown-price zero placeholders. See [Token use and costs](/en/reference/token-use).
