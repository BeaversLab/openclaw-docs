...
For the dedicated cloud-only setup page, see [Ollama Cloud](/en/providers/ollama-cloud).
...
<Note>
For the full setup and behavior details, see [Ollama Web Search](/en/tools/ollama-search).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Memory embeddings">
    ...
    [Managed proxy](/en/security/network-proxy#gateway-loopback-mode) for the
