...
<Tabs>
  ...
  <Tab title="Codex subscription">
    **Best for:** using your ChatGPT/Codex subscription with native Codex
    ...
    [Codex harness long context](/en/plugins/codex-harness#direct-api-long-context).
...
<AccordionGroup>
  ...
  <Accordion title="Fast mode">
    ...
    [Codex harness](/en/plugins/codex-harness#shared-fast-mode-and-codex-fast-mode).
    </Note>
