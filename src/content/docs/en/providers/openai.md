...
getting mixed together, read [Agent runtimes](/en/concepts/agent-runtimes) before
changing config.
...
- **Mid-turn steering:** [Steering messages](/en/concepts/queue#queue-modes) can
...
- **Reasoning changes without rebuilding the cached prefix:** Change the
  [thinking level](/en/tools/thinking), for example with `/think high`, before
...
The native [Codex harness](/en/plugins/codex-harness) owns its own Responses loop;
...
Codex selection. See [Runtime selection](/en/concepts/agent-runtimes#runtime-selection)
...
[Memory configuration reference](/en/reference/memory-config#provider-specific-config)
...
<Tabs>
  ...
  <Tab title="Codex subscription">
    **Best for:** using your ChatGPT/Codex subscription with native Codex
    ...
    [Codex harness long context](/en/plugins/codex-harness/configuration#direct-api-long-context).
...
<Note>
See [Image Generation](/en/tools/image-generation) for shared tool parameters,
...
<Note>
See [Video Generation](/en/tools/video-generation) for shared tool parameters,
provider selection, and failover behavior.
...
<AccordionGroup>
  ...
  <Accordion title="Speech-to-text">
    ...
    See [Audio and voice notes](/en/nodes/audio#openai-transcription-alongside-chatgpt%2Fcodex-oauth)
  ...
  <Accordion title="Realtime voice">
    ...
    complete model capability parity. See the [Discord voice policy limits](/en/channels/discord#voice-channels)
    and [Voice Call tool limits](/en/plugins/voice-call#realtime-voice-conversations) before
...
<AccordionGroup>
  ...
  <Accordion title="Fast mode">
    ...
    returned. See [Thinking levels](/en/tools/thinking#fast-mode-%2Ffast) and
    [Codex harness](/en/plugins/codex-harness/commands#shared-fast-mode-and-codex-fast-mode).
    </Note>
