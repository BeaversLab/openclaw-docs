...
Chat browser sign-in uses the Gateway's managed [Tailscale HTTPS address](/en/gateway/tailscale).
...
For how OpenClaw resolves model refs and failover, see [Model selection](/en/concepts/model-providers).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Arcee" href="/en/providers/arcee" icon="server">
