...
<AccordionGroup>
  ...
  <Accordion title="Embeddings for memory search">
    ...
    [memory search](/en/concepts/memory-search). This is configured separately from the
...
<CardGroup cols={2}>
  ...
  <Card title="Bedrock Mantle" href="/en/providers/bedrock-mantle" icon="layer-group">
