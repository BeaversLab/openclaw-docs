...
[Install plugin](/en/providers/qwen#install-plugin) and
[Getting started](/en/providers/qwen#getting-started); existing Portal credentials
...
[Ollama](/en/providers/ollama) or [LM Studio](/en/providers/lmstudio) discovery flow.
</Note>
