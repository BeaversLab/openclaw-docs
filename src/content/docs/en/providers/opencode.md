...
[prepared completion helper](/en/plugins/sdk-runtime/models#prepared-completion-sdk-compatibility)
...
Price estimates also refresh through the [hosted model catalog](/en/concepts/models#hosted-catalog-updates),
...
See [OpenCode Go](/en/providers/opencode-go) for discovery, routing, and access
...
<CardGroup cols={2}>
  <Card title="OpenCode Go" href="/en/providers/opencode-go" icon="server">
  ...
  <Card title="OpenCode plugin reference" href="/en/plugins/reference/opencode" icon="plug">
