...
voice** accordion under [Voice and speech](/en/providers/openai/voice-and-speech) for its Azure
settings.
</Note>
...
routes** accordion under [Advanced configuration](/en/providers/openai/advanced#advanced-configuration).
...
accordion](/en/providers/openai/advanced#server-side-compaction-responses-api).
</Note>
