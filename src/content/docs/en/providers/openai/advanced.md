...
<AccordionGroup>
  ...
  <Accordion title="Fast mode">
    ...
    stacking as described in [context window defaults and long-context opt-in](/en/providers/openai/setup#context-window-defaults-and-long-context-opt-in). ChatGPT/Codex-credit Fast mode is a separate
