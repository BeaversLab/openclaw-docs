...
<AccordionGroup>
  ...
  <Accordion title="Realtime voice">
    ...
    not expose them. See [GPT-Live in Voice Call](/en/plugins/voice-call/realtime-and-streaming#gpt-live).
    ...
    complete model capability parity. See the [Discord voice policy limits](/en/channels/discord/voice-channels#voice-channels)
