...
MiniMax M3 is a preferred [Code Mode](/en/tools/code-mode) model on both API-key and OAuth routes. With no global Code Mode setting, the automatic tier can engage it; explicit agent or model settings still take precedence.
...
<Note>
See [Image Generation](/en/tools/image-generation) for shared tool parameters, provider selection, and failover behavior.
</Note>
...
<Note>
See [Music Generation](/en/tools/music-generation) for shared tool parameters, provider selection, and failover behavior.
</Note>
...
<Note>
See [Video Generation](/en/tools/video-generation) for shared tool parameters, provider selection, and failover behavior.
</Note>
...
<Note>
See [MiniMax Search](/en/tools/minimax-search) for full web search configuration and usage.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Music generation" href="/en/tools/music-generation" icon="music">
    Shared music tool parameters and provider selection.
  </Card>
  <Card title="Video generation" href="/en/tools/video-generation" icon="video">
    Shared video tool parameters and provider selection.
  </Card>
  <Card title="MiniMax Search" href="/en/tools/minimax-search" icon="magnifying-glass">
