...
<CardGroup cols={2}>
  <Card title="Text-to-speech" href="/en/tools/tts" icon="waveform-lines">
  ...
  <Card title="Providers" href="/en/providers" icon="grid">
