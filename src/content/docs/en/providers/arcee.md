...
Access Arcee models directly through the Arcee platform or through [OpenRouter](/en/providers/openrouter).
...
<AccordionGroup>
  ...
  <Accordion title="OpenRouter routing">
    ...
    [OpenRouter provider docs](/en/providers/openrouter) for OpenRouter-specific
