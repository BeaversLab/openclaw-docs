...
<Note>
For general provider configuration and failover behavior, see [Model Providers](/en/concepts/model-providers).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Models" href="/en/concepts/models" icon="brain">
