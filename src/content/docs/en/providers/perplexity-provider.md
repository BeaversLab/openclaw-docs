...
<Note>
This page covers the Perplexity **provider** setup. For the Perplexity **tool** (how the agent uses it), see [Perplexity search](/en/tools/perplexity-search).
</Note>
...
<AccordionGroup>
  <Accordion title="Environment variable for daemon processes">
    ...
    Gateway process can read it. See [Environment variables](/en/help/environment)
...
<CardGroup cols={2}>
  <Card title="Perplexity search tool" href="/en/tools/perplexity-search" icon="magnifying-glass">
