...
<Tabs>
  ...
  <Tab title="Copilot SDK harness plugin (copilot)">
    ...
    built-in provider. See [Copilot SDK harness](/en/plugins/copilot) for the full
    runtime contract.
...
<AccordionGroup>
  ...
  <Accordion title="Thinking levels">
    ...
    See [Thinking levels](/en/tools/thinking) for session and per-message controls.
  </Accordion>
...
[memory search](/en/concepts/memory-search). If you have a Copilot subscription and
