...
OpenCode Go is a separate paid subscription inside [OpenCode](/en/providers/opencode).
...
| Parent setup     | [OpenCode](/en/providers/opencode)                    |
...
<Tip>
See [OpenCode](/en/providers/opencode) for the shared onboarding overview and the full
