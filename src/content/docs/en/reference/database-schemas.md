...
1. Restore a backup taken before the update. [Create and verify backups](/en/cli/backup) before major updates.
...
Manual schema downgrades are for agents and operators who accept the risk. [Create and verify a backup](/en/cli/backup) before editing any database. Stop the Gateway and every process that can open the database.
