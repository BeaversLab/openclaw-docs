...
For a high-level overview, see [Onboarding (CLI)](/en/start/wizard).
...
- `session.dmScope` (behavior details: [CLI Setup Reference](/en/start/wizard-cli-reference#outputs-and-internals))
