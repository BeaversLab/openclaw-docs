...
lines in commentary or final text. See [visible reply configuration](/en/gateway/config-agents/messages-and-talk#other-message-keys).
...
- [Hosted embeds](/en/web/control-ui/chat#hosted-embeds) - how the Control UI renders `[embed ...]` and its iframe sandbox policy
- [Typebox](/en/concepts/typebox)
