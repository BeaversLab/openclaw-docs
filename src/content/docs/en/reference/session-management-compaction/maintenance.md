...
reset/deletion archives. Optional [cold transcript storage](/en/reference/session-management-compaction/maintenance#cold-transcript-storage)
...
[`--session-sqlite compact` mode](/en/cli/doctor/sqlite-maintenance#session-sqlite-migration).
...
[testing cleanup on a copy](/en/cli/sessions#test-cleanup-on-a-copy) before changing
...
[update cleanup](/en/cli/update#update-cleanup) can retire verified originals
...
[backing up cold transcripts](/en/install/backups#cold-transcript-backups).

Cold storage uses [agent schema 20](/en/reference/database-schemas/agent-schema-history#cold-transcript-storage).
...
disposal; see [Pre-update backups](/en/install/updating#before-updating-create-a-verified-backup).
