...
Follow [Monthly Gateway extended-stable publication](/en/reference/RELEASING#monthly-gateway-extended-stable-publication):
...
- [Full release validation](/en/reference/full-release-validation) - the release product-validation umbrella and its child workflows
- [Update and plugin tests](/en/help/testing-updates-plugins) - proving the installable package updates real user state before a release
