...
[capacity and disk-space requirements](/en/concepts/managed-worktrees#capacity-and-disk-space),
...
[CI runtime policy](/en/ci/pipeline#test-runtime-selection) for the removal proof.
