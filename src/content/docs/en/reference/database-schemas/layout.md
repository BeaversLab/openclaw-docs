...
[compact agent payload storage](/en/reference/database-schemas/agent-schema-history#compact-agent-payload-storage).
...
[cold transcript storage](/en/reference/session-management-compaction/maintenance#cold-transcript-storage)
for retention and restoration, and
[agent schema 20](/en/reference/database-schemas/agent-schema-history#cold-transcript-storage)
...
history already evicted by an older writer. See [ACP CLI](/en/cli/acp).
...
[Schema bumps and older updaters](/en/reference/database-schemas/versioning#schema-bumps-and-older-updaters).
