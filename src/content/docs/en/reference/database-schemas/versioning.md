...
repository receipts require [state schema 18](/en/reference/database-schemas/state-schema-history#state-schema-18).
...
[Cold transcript storage](/en/reference/database-schemas/agent-schema-history#cold-transcript-storage)
...
[incremental canonical-session validation](/en/reference/database-schemas/agent-schema-history#incremental-canonical-session-validation).
...
version, and [manual update commands](/en/install/updating#updating-from-2026.9.2-across-a-schema-bump).
