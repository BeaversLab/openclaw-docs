...
[migration inventory](/en/reference/database-schemas/worker-access-inventory) separates
...
[inventory baseline](/en/reference/database-schemas/worker-access-inventory#profile-priority-and-current-cutover-status)
...
[storage review checkpoint](/en/reference/database-schemas/storage-changes#review-checkpoint-for-material-changes).
