...
- [Memory Overview](/en/concepts/memory) -- how memory works
- [Builtin Engine](/en/concepts/memory-builtin) -- default SQLite backend
- [QMD Engine](/en/concepts/memory-qmd) -- local-first sidecar
- [Memory Search](/en/concepts/memory-search) -- search pipeline and tuning
- [Active Memory](/en/concepts/active-memory) -- enabling the memory sub-agent for interactive sessions
...
See [Active Memory](/en/concepts/active-memory) for the activation model,
...
[`session.sendPolicy`](/en/gateway/config-agents#session):
