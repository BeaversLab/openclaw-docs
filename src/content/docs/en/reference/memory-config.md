...
<CardGroup cols={2}>
  ...
  <Card title="QMD engine" href="/en/concepts/memory-qmd">
    Local-first sidecar.
  </Card>
...
[`tools.sessions.visibility`](/en/gateway/config-tools#toolssessions). The default
...
<AccordionGroup>
  ...
  <Accordion title="Scope">
    Controls which sessions can receive QMD search results. Same schema as [`session.sendPolicy`](/en/gateway/config-agents#session):
