...
uses the dated directive format in the [USER template](/en/reference/templates/USER)
instead.

- **Name:** The Clawdributors
- **Preferred address:** They/Them (collective)
- **Timezone:** Distributed globally (falls back to host timezone; see [Timezones](/en/concepts/timezone))
- **Notes:**
...
- [USER template](/en/reference/templates/USER)
