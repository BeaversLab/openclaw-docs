...
For independently scheduled or due-only checks, create [cron jobs](/en/automation/cron-jobs). Heartbeat scratch no longer supports scheduler syntax. Run `openclaw doctor --fix` to convert older `tasks:` blocks.
