...
[OpenClaw App SDK](/en/concepts/openclaw-sdk). It is intentionally separate from
the [Plugin SDK](/en/plugins/sdk-overview).
...
- [OpenClaw App SDK](/en/concepts/openclaw-sdk)
