...
5. Check `openclaw channels status --probe`, then send a DM to the Synology Chat bot. Start the Gateway if it is offline; config changes follow [hot reload](/en/gateway/configuration/hot-reload).
