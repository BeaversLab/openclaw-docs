...
For production, consider [federated authentication](/en/channels/msteams/authentication#federated-authentication-certificate-plus-managed-identity) (certificate or managed identity) instead of client secrets.
...
3. Build a **Teams app package** referencing the bot, including the [RSC permissions](/en/channels/msteams/manifest-and-permissions#current-teams-rsc-permissions-manifest).
...
- Add RSC permissions (see [RSC permissions](/en/channels/msteams/manifest-and-permissions#current-teams-rsc-permissions-manifest)).
