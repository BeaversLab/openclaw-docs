...
Check the [application result](/en/plugins/manage-plugins#apply-changes-and-inspect) before continuing.

<CardGroup cols={3}>
  <Card title="Private API actions" icon="wand-sparkles" href="/en/channels/imessage/rich-messages#private-api-actions">
...
- For advanced actions (react / edit / unsend / threaded reply / effects / polls / group ops), System Integrity Protection must be disabled — see [Enabling the imsg private API](/en/channels/imessage/private-api#enabling-the-imsg-private-api). Basic text and media send/receive work without it.
