...
`plugins install` registers and enables the plugin. The plugin still does nothing until you configure the Slack app and channel settings below. See [Plugins](/en/tools/plugin) for general plugin behavior and install rules.
