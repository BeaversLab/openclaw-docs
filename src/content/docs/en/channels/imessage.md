...
<CardGroup cols={3}>
  ...
  <Card title="Configuration reference" icon="settings" href="/en/gateway/config-channels#imessage">
...
See [ACP Agents](/en/tools/acp-agents) for shared ACP binding behavior.
...
- [Configuration reference - iMessage](/en/gateway/config-channels#imessage)
...
- [BlueBubbles removal and the imsg iMessage path](/en/announcements/bluebubbles-imessage) — announcement and migration summary
- [Coming from BlueBubbles](/en/channels/imessage-from-bluebubbles) — config translation table and step-by-step cutover
