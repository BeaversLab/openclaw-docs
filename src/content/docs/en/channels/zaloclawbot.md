...
- Node.js >= 22
- [OpenClaw](/en/install) installed (`openclaw` CLI available)
...
Check the [application result](/en/plugins/manage-plugins#apply-changes-and-inspect)
...
[hot reload](/en/gateway/configuration/hot-reload).
...
- [Zalo](/en/channels/zalo) - the bundled Zalo Bot Creator / Marketplace channel
- [Pairing](/en/channels/pairing) - DM authentication and pairing flow
- [Plugins](/en/tools/plugin) - installing and managing plugins
