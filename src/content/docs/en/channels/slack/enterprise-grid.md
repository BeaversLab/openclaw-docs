...
[Optional native slash commands](/en/channels/slack/manifest-and-scopes#optional-native-slash-commands).
...
[Actions and gates](/en/channels/slack/access-control#actions-and-gates); the configured
