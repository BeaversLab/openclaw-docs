...
<AccordionGroup>
  <Accordion title="Optional native slash commands">
    ...
    Multiple [native slash commands](/en/channels/slack/messaging#commands-and-slash-behavior) can be used instead of a single configured command with nuance:
