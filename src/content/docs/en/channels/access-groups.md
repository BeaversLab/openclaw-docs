...
More Discord-specific examples: [Discord access control](/en/channels/discord/access-control#access-control-and-routing)
...
- [Pairing](/en/channels/pairing) — the separate DM pairing flow for channel senders
- [Channels overview](/en/channels) — the channels these groups apply to
