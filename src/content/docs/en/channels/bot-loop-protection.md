...
See [SDK runtime](/en/plugins/sdk-runtime#reusable-runtime-utilities) for plugin implementation details.

## Internal agent group rounds

[Agent group threads](/en/channels/broadcast-groups) use a separate coordinator
