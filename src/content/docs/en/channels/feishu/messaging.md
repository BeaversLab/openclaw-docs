...
account, action, and [access controls](/en/channels/feishu/access-control) still apply.
...
[Group session scope and topic threads](/en/channels/feishu/advanced-configuration#group-session-scope-and-topic-threads).
