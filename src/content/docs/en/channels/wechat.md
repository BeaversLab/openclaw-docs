...
[application result](/en/plugins/manage-plugins#apply-changes-and-inspect); start the
...
`2.4.8`. If you need pairing enforcement, [temporarily disable the plugin](/en/channels/wechat#troubleshooting)
until a version with repaired pairing support is available.

For integrations that implement OpenClaw's pairing API, see [Pairing](/en/channels/pairing).
...
- Channel overview: [Chat Channels](/en/channels)
- Pairing: [Pairing](/en/channels/pairing)
- Channel routing: [Channel routing](/en/channels/channel-routing)
- Plugin architecture: [Plugin Architecture](/en/plugins/architecture)
- Channel plugin SDK: [Channel Plugin SDK](/en/plugins/sdk-channel-plugins)
