...
If you only want stock Matrix notification behavior, use `streaming.mode: "partial"` or leave streaming off. See [Matrix message behavior](/en/channels/matrix/messaging#streaming-previews).
...
- [Matrix channel setup](/en/channels/matrix)
- [Streaming concepts](/en/concepts/streaming)
