...
<AccordionGroup>
  ...
  <Accordion title="Personal-number fallback">
    Onboarding supports personal-number mode and writes a self-chat-friendly baseline: `dmPolicy: "allowlist"`, `allowFrom` including your own number, `selfChatMode: true`. See [Personal-number and self-chat behavior](/en/channels/whatsapp#personal-number-and-self-chat-behavior) for admission and safeguard rules.
  </Accordion>
</AccordionGroup>
...
<Steps>
  <Step title="Enable experimental calls">
    ...
    Add `actions.calls: true` to the WhatsApp channel config. Changes follow [hot reload](/en/gateway/configuration/hot-reload):
...
<Tabs>
  <Tab title="DM policy">
    ...
    - same-number self-DMs are allowed unless `selfChatMode: false` or `dmPolicy: "disabled"`; see [Self-chat behavior](/en/channels/whatsapp#personal-number-and-self-chat-behavior)
...
<AccordionGroup>
  ...
  <Accordion title="Read receipts">
    ...
    Per-account override: `channels.whatsapp.accounts.<id>.sendReadReceipts`. Self-chat safeguards skip read receipts even when globally enabled (see [Self-chat behavior](/en/channels/whatsapp#personal-number-and-self-chat-behavior)).
...
Primary reference: [Configuration reference - WhatsApp](/en/gateway/config-channels#whatsapp)
