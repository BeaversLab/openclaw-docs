...
For production deployments, consider using [federated authentication](/en/channels/msteams#federated-authentication-certificate-plus-managed-identity) (certificate or managed identity) instead of client secrets.
