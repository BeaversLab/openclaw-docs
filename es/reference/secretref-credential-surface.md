...
- Para los proveedores de modelos gestionados por SecretRef, las entradas generadas de `agents/*/agent/models.json` conservan marcadores no secretos (no valores secretos resueltos) para las superficies `apiKey`/encabezado.
- La persistencia de los marcadores es con autoridad de origen: OpenClaw escribe los marcadores desde la instantánea activa de la configuración de origen (pre-resolución), no desde los valores secretos resueltos en tiempo de ejecución.
