...
<Note>
  Cuando la puerta de enlace se ejecuta en otra máquina, edite los archivos del área de trabajo en
  el host de la puerta de enlace (por ejemplo, `user@gateway-host:~/.openclaw/workspace`).
</Note>
