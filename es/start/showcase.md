...
<Info>
**¿Quieres ser destacado?** Comparte tu proyecto en [#showcase en Discord](https://discord.gg/clawd) o [etiqueta a @openclaw en X](https://x.com/openclaw).
</Info>
...
<Card title="Reserva de Pistas de Pádel" icon="calendar-check" href="https://github.com/joshp123/padel-cli">
  **@joshp123** • `automation` `booking` `cli`
  ...
  Comprobador de disponibilidad de Playtomic + CLI de reservas. Nunca pierdas una pista libre de nuevo.
...
<Card title="Recepción de Contabilidad" icon="file-invoice-dollar">
  **Community** • `automation` `email` `pdf`
  ...
  Recopila PDFs del correo electrónico, prepara documentos para el asesor fiscal. Contabilidad mensual en piloto automático.
</Card>
...
<Card title="Aprendizaje de Chino xuezh" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Motor de aprendizaje de chino con comentarios de pronunciación y flujos de estudio a través de OpenClaw.
...
<Card title="Bóveda de Memoria de WhatsApp" icon="vault">
  **Comunidad** • `memory` `transcription` `indexing`
  ...
  Ingesta exportaciones completas de WhatsApp, transcribe más de 1000 notas de voz, contrasta con los registros de git y genera informes en markdown con enlaces.
</Card>
...
<Card title="Búsqueda Semántica Karakeep" icon="magnifying-glass" href="https://github.com/jamesbrooksco/karakeep-semantic-search">
  **@jamesbrooksco** • `search` `vector` `bookmarks`
  ...
  Añade búsqueda vectorial a los marcadores de Karakeep utilizando Qdrant + embeddings de OpenAI/Ollama.
</Card>

<Card title="Memoria Del-Revés-2" icon="brain">
  **Comunidad** • `memory` `beliefs` `self-model`
  
  Gestor de memoria separado que convierte archivos de sesión en memorias → creencias → modelo propio evolutivo.
</Card>
...
<Card title="Puente Telefónico Clawdia" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Asistente de voz Vapi ↔ puente HTTP OpenClaw. Llamadas telefónicas casi en tiempo real con tu agente.
</Card>
...
<Card title="Home Assistant Skill" icon="toggle-on" href="https://clawhub.com/skills/homeassistant">
  **ClawHub** • `homeassistant` `skill` `automation`
  ...
  Control y automatización de dispositivos de Home Assistant mediante lenguaje natural.
</Card>
...
<Card title="CalDAV Calendar" icon="calendar" href="https://clawhub.com/skills/caldav-calendar">
  **ClawHub** • `calendar` `caldav` `skill`
  ...
  Habilidad de calendario que utiliza khal/vdirsyncer. Integración de calendario autoalojado.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Domótica nativa de Nix con OpenClaw como interfaz, más hermosos paneles de Grafana.
...
<Card title="Aspiradora Roborock" icon="robot" href="https://github.com/joshp123/gohome/tree/main/plugins/roborock">
  **@joshp123** • `vacuum` `iot` `plugin`
  ...
  Controla tu aspiradora robot Roborock mediante una conversación natural.
...
<Card title="Marketplace StarSwap" icon="star" href="https://star-swap.com/">
  **Comunidad** • `marketplace` `astronomy` `webapp`
  ...
  Un marketplace completo para equipos de astronomía. Construido con/entorno al ecosistema OpenClaw.
</Card>
