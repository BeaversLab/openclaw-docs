...
OpenClaw es una puerta de enlace de WhatsApp + Telegram + Discord + iMessage para agentes de **Pi**. Los complementos añaden Mattermost. Esta guía es la configuración de "asistente personal": un número de WhatsApp dedicado que se comporta como su agente siempre activo.

## ⚠️ Seguridad primero

Está poniendo a un agente en posición de:

- ejecutar comandos en su máquina (dependiendo de la configuración de su herramienta Pi)
