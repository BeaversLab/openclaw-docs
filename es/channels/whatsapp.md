...
<Accordion title="Comportamiento de medios salientes">
  ...
  reescribe a `audio/ogg; codecs=opus` para la compatibilidad con notas de voz - la reproducción de
  GIF animados es compatible a través de `gifPlayback: true` en envíos de video - los subtítulos se
