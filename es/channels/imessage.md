...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="settings"
    href="/es/gateway/configuration-reference#imessage"
  >
...
<Accordion title="Fragmentación saliente">
  - límite de fragmento de texto: `channels.imessage.textChunkLimit` (predeterminado 4000) - modo de
  fragmentación: `channels.imessage.chunkMode` - `length` (predeterminado) - `newline` (división
  prioritaria de párrafos)
</Accordion>
