...
¿Necesitas la instalación completa y la configuración de desarrollo? Consulta [Inicio rápido](/en/start/quickstart).
...
- Si quieres bloquearlo, comienza con `channels.whatsapp.allowFrom` y (para grupos) las reglas de mención.
