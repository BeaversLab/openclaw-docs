...
<Info>
  Esta es una **guía del colaborador** para los desarrolladores principales de OpenClaw. Si está
  construyendo un complemento externo, consulte [Construcción de
  complementos](/es/plugins/building-plugins) en su lugar.
</Info>
