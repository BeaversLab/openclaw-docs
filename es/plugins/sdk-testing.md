...
<Tip>
  **¿Buscas ejemplos de pruebas?** Las guías prácticas incluyen ejemplos de pruebas funcionales:
  [Pruebas de complementos de canal](/es/plugins/sdk-channel-plugins#step-6-test) y [Pruebas de
  complementos de proveedor](/es/plugins/sdk-provider-plugins#step-6-test).
</Tip>
