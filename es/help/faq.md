...
- [Inicio rápido y configuración de primera ejecución]
  - [Estoy atascado, ¿cuál es la forma más rápida de solucionarlo?](#im-stuck-whats-the-fastest-way-to-get-unstuck)
  - [¿Cuál es la forma recomendada de instalar y configurar OpenClaw?](#whats-the-recommended-way-to-install-and-set-up-openclaw)
  - [¿Cómo abro el panel después de la incorporación?](#how-do-i-open-the-dashboard-after-onboarding)
  - [¿Cómo autentico el panel (token) en localhost frente a remoto?](#how-do-i-authenticate-the-dashboard-token-on-localhost-vs-remote)
  - [¿Qué tiempo de ejecución necesito?](#what-runtime-do-i-need)
  - [¿Se ejecuta en Raspberry Pi?](#does-it-run-on-raspberry-pi)
  - [¿Algún consejo para las instalaciones en Raspberry Pi?](#any-tips-for-raspberry-pi-installs)
  - [Se queda atascado en "wake up my friend" / la incorporación no se completa. ¿Qué hacer ahora?](#it-is-stuck-on-wake-up-my-friend-onboarding-will-not-hatch-what-now)
  ...
  - [No puedo acceder a docs.openclaw.ai (error SSL). ¿Qué hacer ahora?](#i-cant-access-docsopenclawai-ssl-error-what-now)
  - [¿Cuál es la diferencia entre estable y beta?](#whats-the-difference-between-stable-and-beta)
  - [¿Cómo instalo la versión beta y cuál es la diferencia entre beta y desarrollo?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [La salida exec de Windows muestra texto chino ilegible, ¿qué debo hacer](#windows-exec-output-shows-garbled-chinese-text-what-should-i-do)
  - [La documentación no respondió a mi pregunta: ¿cómo obtener una mejor respuesta?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  ...
  - [¿Qué hace realmente la incorporación (onboarding)?](#what-does-onboarding-actually-do)
  ...
  - [¿Está bien un modelo local para charlas casuales?](#is-a-local-model-ok-for-casual-chats)
  ...
  - [¿Puedo ejecutar un agente de "chat rápido" y un agente de "Opus para codificar"?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  ...
  - [¿Puedo cambiar entre las instalaciones de npm y git más tarde?](#can-i-switch-between-npm-and-git-installs-later)
...
- [¿Qué es OpenClaw?](#what-is-openclaw)
  ...
  - [¿Puede OpenClaw ayudar con la generación de prospectos, alcance, anuncios y blogs para un SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Habilidades y automatización](#skills-and-automation)
  - [¿Cómo personalizo las habilidades sin ensuciar el repositorio?](#how-do-i-customize-skills-without-keeping-the-repo-dirty)
  ...
  - [Cron o recordatorios no se ejecutan. ¿Qué debo verificar?](#cron-or-reminders-do-not-fire-what-should-i-check)
  ...
  - [¿Cómo uso mi Chrome existente con la sesión iniciada con OpenClaw?](#how-do-i-use-my-existing-signed-in-chrome-with-openclaw)
- [Sandbox y memoria](#sandboxing-and-memory)
  - [¿Existe un documento dedicado al sandbox?](#is-there-a-dedicated-sandboxing-doc)
  - [¿Cómo vinculo una carpeta del host dentro del sandbox?](#how-do-i-bind-a-host-folder-into-the-sandbox)
  - [¿Cómo funciona la memoria?](#how-does-memory-work)
  - [La memoria sigue olvidando cosas. ¿Cómo hago que persista?](#memory-keeps-forgetting-things-how-do-i-make-it-stick)
...
- [Dónde residen las cosas en el disco](#where-things-live-on-disk)
  ...
  - [Estoy en modo remoto: ¿dónde está el almacenamiento de la sesión?](#im-in-remote-mode-where-is-the-session-store)
- [Conceptos básicos de configuración](#config-basics)
  ...
  - [¿Cómo desactivo las etiquetas divertidas de la CLI?](#how-do-i-disable-funny-cli-taglines)
  ...
  - [¿Cómo ejecuto una puerta de enlace central con trabajadores especializados en varios dispositivos?](#how-do-i-run-a-central-gateway-with-specialized-workers-across-devices)
  - [¿Puede ejecutarse el navegador OpenClaw sin cabeza (headless)?](#can-the-openclaw-browser-run-headless)
  - [¿Cómo uso Brave para el control del navegador?](#how-do-i-use-brave-for-browser-control)
- [Puertas de enlace y nodos remotos](#remote-gateways-and-nodes)
  ...
  - [¿Cómo puede mi agente acceder a mi ordenador si la puerta de enlace está alojada de forma remota?](#how-can-my-agent-access-my-computer-if-the-gateway-is-hosted-remotely)
  ...
  - [¿Hay algún beneficio en usar un nodo en mi laptop personal en lugar de SSH desde un VPS?](#is-there-a-benefit-to-using-a-node-on-my-personal-laptop-instead-of-ssh-from-a-vps)
  - [¿Los nodos ejecutan un servicio de puerta de enlace?](#do-nodes-run-a-gateway-service)
  ...
  - [¿Cómo conecto un nodo Mac a una puerta de enlace remota (Tailscale Serve)?](#how-do-i-connect-a-mac-node-to-a-remote-gateway-tailscale-serve)
  - [¿Debo instalar en una segunda laptop o simplemente agregar un nodo?](#should-i-install-on-a-second-laptop-or-just-add-a-node)
- [Variables de entorno y carga de .env](#env-vars-and-env-loading)
  ...
  - ["Inicié la puerta de enlace a través del servicio y mis variables de entorno desaparecieron." ¿Qué ahora?](#i-started-the-gateway-via-the-service-and-my-env-vars-disappeared-what-now)
...
- [Sesiones y múltiples chats](#sessions-and-multiple-chats)
  ...
  - [¿Hay alguna forma de hacer un equipo de instancias de OpenClaw un CEO y muchos agentes](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  ...
  - [Estoy obteniendo errores de "contexto demasiado grande" - ¿cómo restablezco o compacto?](#im-getting-context-too-large-errors-how-do-i-reset-or-compact)
...
- [Gateway: puertos, "ya está en ejecución" y modo remoto](#gateway-ports-already-running-and-remote-mode)
  ...
  - [¿Qué significa "otra instancia de gateway ya está escuchando"?](#what-does-another-gateway-instance-is-already-listening-mean)
  ...
  - [La interfaz de control dice "no autorizado" (o se sigue reconectando). ¿Qué hago?](#the-control-ui-says-unauthorized-or-keeps-reconnecting-what-now)
  ...
  - [¿Qué significa "handshake no válido" / código 1008?](#what-does-invalid-handshake-code-1008-mean)
- [Registro y depuración](#logging-and-debugging)
  ...
  - ["Desconectado del gateway: sin motivo" - ¿qué hago?](#disconnected-from-gateway-no-reason-what-now)
  - [Telegram setMyCommands falla. ¿Qué debo verificar?](#telegram-setmycommands-fails-what-should-i-check)
...
- [Seguridad y control de acceso](#security-and-access-control)
  - [¿Es seguro exponer OpenClaw a mensajes entrantes?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
  - [¿La inyección de comandos es solo una preocupación para los bots públicos?](#is-prompt-injection-only-a-concern-for-public-bots)
  - [¿Mi bot debe tener su propia cuenta de correo electrónico, GitHub o número de teléfono?](#should-my-bot-have-its-own-email-github-account-or-phone-number)
...
- [Comandos de chat, cancelación de tareas y "no se detiene"](#chat-commands-aborting-tasks-and-it-wont-stop)
  ...
  - [¿Cómo envío un mensaje de Discord desde Telegram? ("Mensajería entre contextos denegada")](#how-do-i-send-a-discord-message-from-telegram-crosscontext-messaging-denied)
  - [¿Por qué parece que el bot "ignora" los mensajes en rápida sucesión?](#why-does-it-feel-like-the-bot-ignores-rapidfire-messages)
...
4. **Sondas profundas**
   ...
   Ejecuta comprobaciones de salud de la puerta de enlace + sondas de proveedores (requiere una puerta de enlace accesible). Consulte [Health](/es/gateway/health).
...
5. **Ver el último registro**
   ...
   Los registros de archivo son independientes de los registros del servicio; consulte [Logging](/es/logging) y [Troubleshooting](/es/gateway/troubleshooting).
...
6. **Ejecutar el doctor (reparaciones)**
   ...
   Repara/migra la configuración/el estado + ejecuta comprobaciones de salud. Consulte [Doctor](/es/gateway/doctor).
...
Esto instala OpenClaw **desde una comprobación de git (git checkout)**, por lo que el agente puede leer el código + la documentación y
...
Si descubre un error o una solución real, por favor envíe un problema de GitHub o un PR:
...
- `openclaw status`: instantánea rápida del estado de la pasarela/agente + configuración básica.
...
Bucle de depuración rápida: [Primeros 60 segundos si algo está roto](#first-60-seconds-if-somethings-broken).
...
Si aún no tiene una instalación global, ejecútela mediante `pnpm openclaw onboard`.
...
- Si pide autenticación, pegue el token de `gateway.auth.token` (o `OPENCLAW_GATEWAY_TOKEN`) en la configuración de Control UI.
- Recupérelo del host de la pasarela: `openclaw config get gateway.auth.token` (o genere uno: `openclaw doctor --generate-gateway-token`).

**No en localhost:**

- **Tailscale Serve** (recomendado): mantener bind loopback, ejecutar `openclaw gateway --tailscale serve`, abrir `https://<magicdns>/`. Si `gateway.auth.allowTailscale` es `true`, los encabezados de identidad satisfacen la autenticación de Control UI/WebSocket (sin token, asume host de pasarela confiable); las API HTTP aún requieren token/contraseña.
- **Tailnet bind**: ejecutar `openclaw gateway --bind tailnet --token "<token>"`, abrir `http://<tailscale-ip>:18789/`, pegar token en la configuración del panel.
- **Túnel SSH**: `ssh -N -L 18789:127.0.0.1:18789 user@host` y luego abrir `http://127.0.0.1:18789/` y pegar el token en la configuración de Control UI.

Consulte [Dashboard](/es/web/dashboard) y [Web surfaces](/es/web) para conocer los modos de enlace y detalles de autenticación.
...
pantalla/cámara/lienzo locales o ejecución de comandos. Consulte [Nodes](/es/nodes).
...
Documentos: [Linux](/es/platforms/linux), [Install](/es/install).
...
Si el Gateway es remoto, asegúrese de que la conexión del túnel/Tailscale esté activa y de que la
interfaz de usuario apunte al Gateway correcto. Consulte [Remote access](/es/gateway/remote).
...
2. Copie `$OPENCLAW_STATE_DIR` (predeterminado: `~/.openclaw`) desde la máquina anterior.
...
de **archivos de memoria + arranque**, pero **no** del historial de sesiones ni de la autenticación. Esos residen
...
Algunas conexiones Comcast/Xfinity bloquean incorrectamente `docs.openclaw.ai` a través de
Advanced Security de Xfinity. Desactívelo o añada `docs.openclaw.ai` a la lista de permitidos, luego vuelva a intentarlo. Más
...
Enviamos compilaciones a **beta**, las probamos y una vez que una compilación es sólida, **promovemos esa misma versión a `latest`**. Es por eso que beta y stable pueden apuntar a la **misma versión**.
...
**Beta** es la etiqueta de distribución de npm `beta` (puede coincidir con `latest`).
**Dev** es la cabeza móvil de `main` (git); cuando se publica, usa la etiqueta de distribución de npm `dev`.
...
Si se cuelga, use [Instalador atascado](/es/help/faq#installer-stuck-how-do-i-get-more-feedback)
...
Esto cambia a la rama `main` y actualiza desde la fuente.
...
Documentos: [Actualizar](/es/cli/update), [Canales de desarrollo](/es/install/development-channels),
[Instalar](/es/install).
...
- Añada ese directorio a su PATH de usuario (no se necesita el sufijo `\bin` en Windows; en la mayoría de los sistemas es `%AppData%\npm`).
...
Documentos: [Windows](/es/platforms/windows).
...
Más detalles: [Instalar](/es/install) y [Marcas del instalador](/es/install/installer).

### ¿Cómo instalo OpenClaw en Linux?

Respuesta corta: siga la guía de Linux y luego ejecute la incorporación.
...
Hub: [Plataformas](/es/platforms). Acceso remoto: [Gateway remote](/es/gateway/remote).
...
Documentos: [Actualizar](/es/cli/update), [Actualización](/es/install/updating).

### Qué hace realmente la incorporación (onboarding)
...
la beta de contexto de 1M de Anthropic (`context1m: true`). Esto solo funciona cuando su
credencial es elegible para la facturación de contexto largo (facturación de clave de API o suscripción
con Uso adicional habilitado).

Sugerencia: configure un **modelo alternativo** para que OpenClaw pueda seguir respondiendo mientras un proveedor tiene límites de tasa.
...
Esto almacena tokens OAuth en perfiles de autenticación en el host de la puerta de enlace. Detalles: [Proveedores de modelos](/es/concepts/model-providers).

### ¿Es válido un modelo local para charlas informales?

Por lo general, no. OpenClaw necesita un contexto grande + gran seguridad; las tarjetas pequeñas truncan y filtran. Si es necesario, ejecute la compilación **más grande** de MiniMax M2.5 que pueda localmente (LM Studio) y consulte [/gateway/local-models](/es/gateway/local-models). Los modelos más pequeños/cuantizados aumentan el riesgo de inyección de comandos (prompt-injection) - consulte [Seguridad](/es/gateway/security).

### ¿Cómo mantengo el tráfico del modelo alojado en una región específica

Elija endpoints anclados a la región. OpenRouter expone opciones alojadas en EE. UU. para MiniMax, Kimi y GLM; elija la variante alojada en EE. UU. para mantener los datos en la región. Aún puede listar Anthropic/OpenAI junto a estos usando `models.mode: "merge"` para que las alternativas (fallbacks) sigan disponibles mientras respeta el proveedor regional que seleccione.
...
Solo necesita una Mac **para herramientas exclusivas de macOS**. Para iMessage, use [BlueBubbles](/es/channels/bluebubbles) (recomendado); el servidor BlueBubbles se ejecuta en cualquier Mac, y la Gateway (Puerta de enlace) puede ejecutarse en Linux o en otro lugar. Si desea otras herramientas exclusivas de macOS, ejecute la Gateway en una Mac o empareje un nodo macOS.
...
Necesita **algún dispositivo macOS** conectado a Messages. **No** tiene por qué ser una Mac mini -
...
Sí. La **Mac mini puede ejecutar la Gateway**, y su MacBook Pro puede conectarse como un
**nodo** (dispositivo complementario). Los nodos no ejecutan la Gateway; proporcionan capacidades
dicionales como pantalla/cámara/lienzo (canvas) y `system.run` en ese dispositivo.
...
La incorporación (onboarding) acepta la entrada `@username` y la resuelve a un ID numérico, pero la autorización de OpenClaw usa solo IDs numéricos.
...
Sí, a través del **enrutamiento multi-agente**. Vincula el **MD** de WhatsApp de cada remitente (par `kind: "direct"`, remitente E.164 como `+15551234567`) a un `agentId` diferente, para que cada persona tenga su propio espacio de trabajo y almacenamiento de sesión. Las respuestas aún provienen de la **misma cuenta de WhatsApp**, y el control de acceso de MD (`channels.whatsapp.dmPolicy` / `channels.whatsapp.allowFrom`) es global por cuenta de WhatsApp. Consulta [Enrutamiento multi-agente](/es/concepts/multi-agent) y [WhatsApp](/es/channels/whatsapp).

### ¿Puedo ejecutar un agente de chat rápido y un Opus para agente de codificación

Sí. Utiliza el enrutamiento multi-agente: asigna a cada agente su propio modelo predeterminado, luego vincula las rutas de entrada (cuenta del proveedor o pares específicos) a cada agente. Un ejemplo de configuración se encuentra en [Enrutamiento multi-agente](/es/concepts/multi-agent). Consulta también [Modelos](/es/concepts/models) y [Configuración](/es/gateway/configuration).
...
Las versiones recientes también anteponen directorios bin comunes de usuario en los servicios systemd de Linux (por ejemplo `~/.local/bin`, `~/.npm-global/bin`, `~/.local/share/pnpm`, `~/.bun/bin`) y respetan `PNPM_HOME`, `NPM_CONFIG_PREFIX`, `BUN_INSTALL`, `VOLTA_HOME`, `ASDF_DATA_DIR`, `NVM_DIR` y `FNM_DIR` cuando están configurados.
...
Documentación: [Introducción](/es/start/getting-started), [Actualización](/es/install/updating).
...
Doctor detecta una discrepancia en el punto de entrada del servicio de puerta de enlace y ofrece reescribir la configuración del servicio para que coincida con la instalación actual (use `--repair` en automatización).

Consejos de copia de seguridad: consulte [Estrategia de copia de seguridad](/es/help/faq#whats-the-recommended-backup-strategy).
...
**Nota específica de OpenClaw:** WhatsApp/Telegram/Slack/Mattermost (complemento)/Discord funcionan bien desde un VPS. La única compensación real es el **navegador sin cabeza** frente a una ventana visible. Consulte [Navegador](/es/tools/browser).
...
Si quiere lo mejor de ambos mundos, mantenga la puerta de enlace en un host dedicado y empareje su computadora portátil como un **nodo** para herramientas locales de pantalla/cámara/ejecución. Consulte [Nodos](/es/nodes).
Para obtener orientación sobre seguridad, lea [Seguridad](/es/gateway/security).
...
Documentación: [Linux](/es/platforms/linux), [Hospedaje VPS](/es/vps).
...
Si está en Windows, **WSL2 es la configuración de estilo de máquina virtual más fácil** y tiene la mejor compatibilidad
de herramientas. Consulte [Windows](/es/platforms/windows), [Hospedaje VPS](/es/vps).
Si está ejecutando macOS en una máquina virtual, consulte [Máquina virtual macOS](/es/install/macos-vm).
...
Pida a su bot que "genere un subagente para esta tarea" o use `/subagents`.
Use `/status` en el chat para ver qué está haciendo el Gateway en este momento (y si está ocupado).

Consejo sobre tokens: las tareas largas y los subagentes consumen tokens. Si el costo es una preocupación, establezca un modelo más económico para los subagentes a través de `agents.defaults.subagents.model`.

Documentación: [Subagentes](/es/tools/subagents).
...
- Autovincular al generar: establezca `channels.discord.threadBindings.spawnSubagentSessions: true`.
...
Use **ClawHub** (CLI) o coloque las habilidades en su espacio de trabajo. La interfaz de usuario de Skills de macOS no está disponible en Linux.
...
No directamente. Las habilidades de macOS están restringidas por `metadata.openclaw.os` además de los binarios requeridos, y las habilidades solo aparecen en el mensaje del sistema cuando son elegibles en el **Gateway host**. En Linux, las habilidades solo de `darwin` (como `apple-notes`, `apple-reminders`, `things-mac`) no se cargarán a menos que anule la restricción.

Tiene tres patrones admitidos:

**Opción A: ejecutar el Gateway en una Mac (lo más sencillo).**
Ejecute el Gateway donde existen los binarios de macOS, luego conéctese desde Linux en [modo remoto](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) o a través de Tailscale. Las habilidades se cargan normalmente porque el host Gateway es macOS.

**Opción B: usar un nodo macOS (sin SSH).**
Ejecute el Gateway en Linux, empareje un nodo macOS (aplicación de barra de menús) y configure **Node Run Commands** en "Preguntar siempre" o "Permitir siempre" en la Mac. OpenClaw puede tratar las habilidades solo de macOS como elegibles cuando los binarios requeridos existen en el nodo. El agente ejecuta esas habilidades a través de la herramienta `nodes`. Si elige "Preguntar siempre", aprobar "Permitir siempre" en el mensaje agrega ese comando a la lista de permitidos.
...
ClawHub se instala en `./skills` dentro de su directorio actual (o recurre a su espacio de trabajo OpenClaw configurado); OpenClaw lo trata como `<workspace>/skills` en la siguiente sesión. Para habilidades compartidas entre agentes, colóquelas en `~/.openclaw/skills/<name>/SKILL.md`. Algunas habilidades esperan binarios instalados a través de Homebrew; en Linux eso significa Linuxbrew (consulte la entrada de FAQ de Homebrew Linux anterior). Consulte [Skills](/es/tools/skills) y [ClawHub](/es/tools/clawhub).
...
### ¿Existe un documento dedicado al sandboxing?

Sí. Consulte [Sandboxing](/es/gateway/sandboxing). Para configuración específica de Docker (puerta de enlace completa en Docker o imágenes de sandbox), consulte [Docker](/es/install/docker).
...
- Hornee las dependencias del sistema en la imagen con `OPENCLAW_DOCKER_APT_PACKAGES`.
- Instale los navegadores Playwright a través de la CLI incluida:
  `node /app/node_modules/playwright-core/cli.js install chromium`
- Establezca `PLAYWRIGHT_BROWSERS_PATH` y asegúrese de que la ruta se mantenga.

Documentos: [Docker](/es/install/docker), [Browser](/es/tools/browser).

**¿Puedo mantener los DMs personales pero hacer que los grupos públicos usen sandboxing con un agente?**

Sí: si su tráfico privado son **DMs** y su tráfico público son **grupos**.

Use `agents.defaults.sandbox.mode: "non-main"` para que las sesiones de grupo/canal (claves no principales) se ejecuten en Docker, mientras que la sesión principal de DM se mantiene en el host. Luego, restrinja qué herramientas están disponibles en las sesiones con sandboxing a través de `tools.sandbox.tools`.

Tutorial de configuración + ejemplo de configuración: [Grupos: DMs personales + grupos públicos](/es/channels/groups#pattern-personal-dms-public-groups-single-agent)

Referencia clave de configuración: [Configuración de Gateway](/es/gateway/configuration#agentsdefaultssandbox)

### ¿Cómo enlazo una carpeta del host en el entorno sandbox?

Establezca `agents.defaults.sandbox.docker.binds` en `["host:path:mode"]` (p. ej., `"/home/user/src:/src:ro"`). Los enlaces globales + por agente se combinan; se ignoran los enlaces por agente cuando `scope: "shared"`. Use `:ro` para cualquier cosa sensible y recuerde que los enlaces omiten las paredes del sistema de archivos del sandbox. Consulte [Sandboxing](/es/gateway/sandboxing#custom-bind-mounts) y [Sandbox vs Tool Policy vs Elevated](/es/gateway/sandbox-vs-tool-policy-vs-elevated#bind-mounts-security-quick-check) para ver ejemplos y notas de seguridad.
...
OpenClaw también ejecuta un **vaciado de memoria de precompactación silencioso** para recordarle al modelo
que escriba notas duraderas antes de la autocompactación. Esto solo se ejecuta cuando el espacio de trabajo
es grabable (los entornos sandbox de solo lectura lo omiten). Consulte [Memoria](/es/concepts/memory).

### La memoria sigue olvidando cosas. ¿Cómo hago que se queden?
...
Esto sigue siendo un área que estamos mejorando. Ayuda recordarle al modelo que almacene recuerdos;
sabrá qué hacer. Si sigue olvidando, verifique que Gateway esté usando el mismo
...
### ¿La búsqueda de memoria semántica requiere una clave API de OpenAI?

Solo si usa **embeddings de OpenAI**. El OAuth de Codex cubre chat/completiones y
...
Si no estableces un proveedor explícitamente, OpenClaw selecciona automáticamente un proveedor cuando puede resolver una clave de API (perfiles de autenticación, `models.providers.*.apiKey` o variables de entorno). Prefiere OpenAI si se resuelve una clave de OpenAI; de lo contrario, Gemini si se resuelve una clave de Gemini, luego Voyage y luego Mistral. Si no hay ninguna clave remota disponible, la búsqueda de memoria permanece deshabilitada hasta que la configures. Si tiene una ruta de modelo local configurada y presente, OpenClaw prefiere `local`. Ollama es compatible cuando configuras explícitamente `memorySearch.provider = "ollama"`.

Si prefieres quedarte localmente, establece `memorySearch.provider = "local"` (y opcionalmente `memorySearch.fallback = "none"`). Si deseas incrustaciones de Gemini, establece `memorySearch.provider = "gemini"` y proporciona `GEMINI_API_KEY` (o `memorySearch.remote.apiKey`). Admitimos modelos de incrustación **OpenAI, Gemini, Voyage, Mistral, Ollama o locales**; consulta [Memoria](/es/concepts/memory) para obtener detalles de configuración.

### ¿La memoria persiste para siempre? ¿Cuáles son los límites?

Los archivos de memoria residen en el disco y persisten hasta que los elimines. El límite es tu almacenamiento, no el modelo. El **contexto de la sesión** aún está limitado por la ventana de contexto del modelo, por lo que las conversaciones largas pueden compactarse o truncarse. Por eso existe la búsqueda de memoria: extrae solo las partes relevantes de vuelta al contexto.
...
- **Local de forma predeterminada:** las sesiones, los archivos de memoria, la configuración y el espacio de trabajo residen en el host de Gateway (`~/.openclaw` + tu directorio de espacio de trabajo).
...
- **Tú controlas la huella:** el uso de modelos locales mantiene los mensajes en tu máquina, pero el tráfico del canal aún pasa a través de los servidores del canal.
...
| `$OPENCLAW_STATE_DIR/credentials/oauth.json`                    | Importación de OAuth heredada (copiada en perfiles de autenticación en el primer uso) |
...
| `$OPENCLAW_STATE_DIR/secrets.json`                              | Carga secreta opcional respaldada en archivo para proveedores SecretRef `file`        |
...
### ¿Dónde deben residir AGENTSmd SOULmd USERmd MEMORYmd?
...
Si el bot "olvida" después de un reinicio, confirme que Gateway está usando el mismo
espacio de trabajo en cada inicio (y recuerde: el modo remoto usa el espacio de trabajo
del **host gateway**, no de su computadora portátil local).

Sugerencia: si deseas un comportamiento o preferencia duradero, pídele al bot que **lo escriba en
...
### ¿Pueden trabajar los agentes fuera del espacio de trabajo?
...
### Estoy en modo remoto, dónde está el almacenamiento de sesiones

El estado de la sesión pertenece al **host de la puerta de enlace**. Si estás en modo remoto, el almacenamiento de sesiones que te importa está en la máquina remota, no en tu portátil local. Consulta [Gestión de sesiones](/es/concepts/session).

## Conceptos básicos de configuración

### Qué formato tiene la configuración y dónde está
...
Si falta el archivo, utiliza valores predeterminados seguros (incluido un espacio de trabajo predeterminado de `~/.openclaw/workspace`).

### Configuré gatewaybind lan o tailnet y ahora nada escucha, la interfaz de usuario dice no autorizado

Los enlaces no loopback **requieren autenticación**. Configure `gateway.auth.mode` + `gateway.auth.token` (o use `OPENCLAW_GATEWAY_TOKEN`).
...
- `gateway.remote.token` / `.password` **no** habilitan la autenticación local de la puerta de enlace por sí mismos.
- Las rutas de llamadas locales pueden usar `gateway.remote.*` como alternativa solo cuando `gateway.auth.*` no está configurado.
- Si `gateway.auth.token` / `gateway.auth.password` están configurados explícitamente a través de SecretRef y no se resuelven, la resolución falla de forma cerrada (sin enmascaramiento alternativo remoto).
- La Interfaz de Control se autentica mediante `connect.params.auth.token` (almacenado en la configuración de la app/interfaz). Evite poner tokens en las URL.

### ¿Por qué necesito un token en localhost ahora

OpenClaw exige la autenticación por token de forma predeterminada, incluido el loopback. Si no hay ningún token configurado, el inicio de la puerta de enlace genera uno automáticamente y lo guarda en `gateway.auth.token`, por lo que **los clientes WS locales deben autenticarse**. Esto bloquea que otros procesos locales llamen a la puerta de enlace.

Si **realmente** desea un loopback abierto, configure `gateway.auth.mode: "none"` explícitamente en su configuración. Doctor puede generar un token para usted en cualquier momento: `openclaw doctor --generate-gateway-token`.
...
### ¿Cómo habilito la búsqueda web y la recuperación web
...
- Si usa listas de permitidos, añada `web_search`/`web_fetch` o `group:web`.
- `web_fetch` está habilitado de forma predeterminada (a menos que se desactive explícitamente).
- Los demonios leen las variables de entorno de `~/.openclaw/.env` (o el entorno del servicio).

Documentos: [Web tools](/es/tools/web).

### ¿Cómo ejecuto una puerta de enlace (Gateway) central con trabajadores especializados en varios dispositivos

El patrón común es **una puerta de enlace (Gateway)** (por ejemplo, Raspberry Pi) más **nodos** y **agentes**:

- **Puerta de enlace (Gateway) (central):** posee los canales (Signal/WhatsApp), el enrutamiento y las sesiones.
...
- **Subagentes:** generan trabajo en segundo plano desde un agente principal cuando desea paralelismo.
- **TUI:** conéctese a la puerta de enlace (Gateway) y cambie de agentes/sesiones.

Documentos: [Nodes](/es/nodes), [Remote access](/es/gateway/remote), [Multi-Agent Routing](/es/concepts/multi-agent), [Sub-agents](/es/tools/subagents), [TUI](/es/web/tui).
...
El valor predeterminado es `false` (con interfaz gráfica). El modo sin interfaz es más probable que active comprobaciones anti-bot en algunos sitios. Consulte [Browser](/es/tools/browser).

Headless usa el **mismo motor de Chromium** y funciona para la mayoría de las automatizaciones (formularios, clics, scraping, inicios de sesión). Las principales diferencias:
...
4. Abre la app de macOS localmente y conéctate en modo **Remoto a través de SSH** (o tailnet directa)
...
- Estado de salud del Gateway: `openclaw status`
...
Sí. No hay un puente integrado "de bot a bot", pero puede configurarlo de algunas
formas confiables:
...
vía SSH/Tailscale (ver [Acceso remoto](/es/gateway/remote)).
...
Consejo: añada una barrera de protección para que los dos bots no entren en un bucle infinito (solo menciones, listas
...
Use VPS separados solo cuando necesite un aislamiento estricto (límites de seguridad) o configuraciones muy
diferentes que no desee compartir. De lo contrario, mantenga un Gateway y
...
Sí: los nodos son la forma principal de alcanzar su laptop desde un Gateway remoto y
desbloquean más que el acceso de shell. El Gateway se ejecuta en macOS/Linux (Windows vía WSL2) y es
ligero (un pequeño VPS o una caja clase Raspberry Pi está bien; 4 GB de RAM son suficientes), por lo que una configuración
...
- **Controles de ejecución más seguros.** `system.run` está restringido por listas de permitidos/aprobaciones de nodos en ese portátil.
- **Más herramientas de dispositivo.** Los nodos exponen `canvas`, `camera` y `screen` además de `system.run`.
- **Automatización del navegador local.** Mantén el Gateway en un VPS, pero ejecuta Chrome localmente a través de un host de nodo en el portátil, o conéctate al Chrome local en el host mediante Chrome MCP.

SSH está bien para el acceso ad-hoc al shell, pero los nodos son más simples para los flujos de trabajo de agentes en curso y la automatización de dispositivos.
...
Si solo necesitas **herramientas locales** (pantalla/cámara/exec) en el segundo portátil, agrégalo como un **nodo**. Eso mantiene un solo Gateway y evita configuración duplicada. Las herramientas de nodo local actualmente son solo para macOS, pero planeamos extenderlas a otros sistemas operativos.
...
- Si no tiene ninguna copia de seguridad, vuelva a ejecutar `openclaw doctor` y reconfigure los canales/modelos.
- Si esto fue inesperado, informe de un error e incluya su última configuración conocida o cualquier copia de seguridad.
- Un agente de codificación local a menudo puede reconstruir una configuración funcional a partir de registros o historiales.
...
Esto mantiene el enlace vinculado a loopback y expone HTTPS a través de Tailscale. Consulte [Tailscale](/es/gateway/tailscale).

### ¿Cómo conecto un nodo Mac a un Gateway remoto Tailscale Serve

Serve expone la **Interfaz de usuario de Control de Gateway + WS**. Los nodos se conectan a través del mismo extremo Gateway WS.
...
Consulta [/environment](/es/help/environment) para obtener la precedencia y fuentes completas.

### Inicié el Gateway a través del servicio y mis variables de entorno desaparecieron ¿Qué hago ahora

Dos soluciones comunes:

1. Pon las claves que faltan en `~/.openclaw/.env` para que se detecten incluso cuando el servicio no herede tu entorno de shell.
...
2. O habilitar la importación de shell (`env.shellEnv.enabled: true`).
...
### ¿Existe alguna forma de crear un equipo de instancias de OpenClaw, un CEO y muchos agentes?

Sí, a través del **enrutamiento multiagente** y los **subagentes**. Puede crear un agente coordinador
...
### ¿Por qué se truncó el contexto a mitad de la tarea? ¿Cómo puedo evitarlo?
...
- Mantenga el contexto importante en el espacio de trabajo y pida al bot que lo vuelva a leer.
...
- La incorporación también ofrece **Restablecer** si ve una configuración existente. Consulte [Incorporación (CLI)](/es/start/wizard).
...
- Habilite o ajuste la **poda de sesiones** (`agents.defaults.contextPruning`) para recortar la salida antigua de herramientas.
- Use un modelo con una ventana de contexto más grande.

Docs: [Compaction](/es/concepts/compaction), [Session pruning](/es/concepts/session-pruning), [Session management](/es/concepts/session).
...
Opción 2 (si ya está configurado/en lista blanca): listar grupos desde la configuración:

```bash
openclaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/es/channels/whatsapp), [Directory](/es/cli/directory), [Logs](/es/cli/logs).
...
Los chats directos se contraen a la sesión principal de forma predeterminada. Los grupos/canales tienen sus propias claves de sesión, y los temas de Telegram / hilos de Discord son sesiones separadas. Consulte [Grupos](/es/channels/groups) y [Mensajes de grupo](/es/channels/group-messages).
...
- **Crecimiento del disco:** las sesiones + las transcripciones residen en `~/.openclaw/agents/<agentId>/sessions/`.
- **Costo de tokens:** más agentes significa mayor uso concurrente del modelo.
...
- Pode las sesiones antiguas (elimine JSONL o almacene entradas) si el disco crece.
- Use `openclaw doctor` para detectar espacios de trabajo extraviados y desajustes de perfil.

### ¿Puedo ejecutar múltiples bots o chats al mismo tiempo en Slack y cómo debo configurarlo?

Sí. Utilice el **enrutamiento Multi-Agent** para ejecutar múltiples agentes aislados y enrutar mensajes entrantes por
cuenta de canal/par/par. Slack es compatible como canal y puede vincularse a agentes específicos.

El acceso del navegador es potente, pero no "hacer cualquier cosa que un humano pueda"; el anti-bot, los CAPTCHAs y la MFA pueden
...
Documentos: [Enrutamiento Multi-Agent](/es/concepts/multi-agent), [Slack](/es/channels/slack),
...
Los modelos se referencian como `provider/model` (ejemplo: `anthropic/claude-opus-4-6`). Si omites el proveedor, OpenClaw actualmente asume `anthropic` como un respaldo temporal de desuso, pero aún así debes configurar `provider/model` de forma **explícita**.
...
**Para el chat rutinario o de bajo riesgo:** usa modelos de respaldo más baratos y enruta por el rol del agente.
...
más barato para el chat rutinario o los resúmenes. Puedes enrutar modelos por agente y usar subagentes para
...
en el prompt y a comportamientos inseguros. Consulta [Seguridad](/es/gateway/security).
...
Nota de seguridad: los modelos más pequeños o muy cuantizados son más vulnerables a la inyección de prompts. Recomendamos encarecidamente **modelos grandes** para cualquier bot que pueda usar herramientas. Si todavía quieres modelos pequeños, activa el aislamiento (sandboxing) y listas de permitidos estrictas para las herramientas.

Documentación: [Ollama](/es/providers/ollama), [Local models](/es/gateway/local-models), [Model providers](/es/concepts/model-providers), [Security](/es/gateway/security), [Sandboxing](/es/gateway/sandboxing).
...
Evite `config.apply` con un objeto parcial a menos que tenga la intención de reemplazar toda la configuración. Si sobrescribió la configuración, restáurela desde una copia de seguridad o vuelva a ejecutar `openclaw doctor` para reparar.
...
- Verifique la configuración de tiempo de ejecución actual en cada puerta de enlace con `openclaw models status`.
- Para agentes sensibles a la seguridad o con herramientas habilitadas, use el modelo más fuerte y de última generación disponible.
...
`/model` (y `/model list`) muestra un selector numerado y compacto. Seleccione por número:
...
Sugerencia: `/model status` muestra qué agente está activo, qué archivo `auth-profiles.json` se está usando y qué perfil de autenticación se probará a continuación.
También muestra el endpoint del proveedor configurado (`baseUrl`) y el modo de API (`api`) cuando está disponible.
...
### ¿Por qué veo que el modelo no está permitido y luego no hay respuesta

Si `agents.defaults.models` está establecido, se convierte en la **lista de permitidos** para `/model` y cualquier
anulación de sesión. Al elegir un modelo que no está en esa lista, devuelve:
...
Esto significa que el **proveedor no está configurado** (no se encontró ninguna configuración de proveedor de MiniMax o perfil de autenticación), por lo que no se puede resolver el modelo. Una solución para esta detección está
en **2026.1.12** (no lanzado en el momento de escribir esto).

Lista de verificación de solución:

1. Actualice a **2026.1.12** (o ejecute desde el código fuente `main`), luego reinicie el gateway.
...
3. Use el exact model id (distingue mayúsculas y minúsculas): `minimax/MiniMax-M2.5` o
...
- Rutee por agente o use `/agent` para cambiar
...
### ¿Cómo defino/anulo los atajos de alias de modelo
...
- O copie `auth-profiles.json` del `agentDir` del agente principal en el `agentDir` del nuevo agente.
...
2. **Respaldo de modelo (fallback)** al siguiente modelo en `agents.defaults.model.fallbacks`.
...
### Lista de verificación de solución para No credentials found for profile anthropicdefault
...
- **Confirmar que su variable de entorno es cargada por la Gateway**
...
- **Asegúrese de estar editando el agente correcto**
  - Las configuraciones de multiagente significan que puede haber múltiples archivos `auth-profiles.json`.
...
Esto significa que la ejecución está fijada a un perfil de autenticación de Anthropic, pero la Gateway no puede encontrarlo en su almacén de autenticación.
...
Si la configuración de tu modelo incluye Google Gemini como respaldo (o cambiste a un alias de Gemini), OpenClaw lo intentará durante el respaldo del modelo. Si no has configurado las credenciales de Google, verás `No API key found for provider "google"`.
...
OpenClaw puede omitir temporalmente un perfil si está en un estado de **enfriamiento** (límites de tasa/tiempos de espera/fallos de autenticación) corto o en un estado **deshabilitado** más largo (facturación/créditos insuficientes). Para inspeccionar esto, ejecuta `openclaw models status --json` y comprueba `auth.unusableProfiles`. Ajuste: `auth.cooldowns.billingBackoffHours*`.

También puede establecer un override de orden **por agente** (almacenado en `auth-profiles.json` de ese agente) a través de la CLI:
...
## Puerta de enlace: puertos, "ya se está ejecutando" y modo remoto
...
### ¿Por qué el estado de openclaw gateway dice Runtime ejecutándose pero RPC probe falló

Porque "ejecutándose" es la vista del **supervisor** (launchd/systemd/schtasks). La sonda RPC es la CLI conectándose realmente al WebSocket de la puerta de enlace y llamando a `status`.
...
Está editando un archivo de configuración mientras el servicio ejecuta otro (a menudo una discrepancia de `--profile` / `OPENCLAW_STATE_DIR`).
...
### ¿Qué significa que otra instancia de la puerta de enlace ya está escuchando

OpenClaw impone un bloqueo de tiempo de ejecución vinculando el escucha de WebSocket inmediatamente al inicio (por defecto `ws://127.0.0.1:18789`). Si el enlace falla con `EADDRINUSE`, lanza `GatewayLockError` indicando que otra instancia ya está escuchando.
...
- `openclaw gateway` solo se inicia cuando `gateway.mode` está `local` (o pasas la bandera de anulación).
- La aplicación de macOS observa el archivo de configuración y cambia los modos en vivo cuando estos valores cambian.

### La Interfaz de Control indica no autorizado o sigue reconectando ¿Qué hacer ahora

Tu puerta de enlace se está ejecutando con autenticación habilitada (`gateway.auth.*`), pero la interfaz de usuario no está enviando el token/contraseña correspondiente.

Datos (del código):

- La Interfaz de Control mantiene el token en `sessionStorage` para la sesión actual de la pestaña del navegador y la URL de la puerta de enlace seleccionada, por lo que las actualizaciones en la misma pestaña siguen funcionando sin restaurar la persistencia del token a largo plazo en localStorage.
...
- Lo más rápido: `openclaw dashboard` (imprime + copia la URL del panel, intenta abrirla; muestra una sugerencia SSH si no hay interfaz gráfica).
...
### Establecí gatewaybind tailnet pero no puede vincularse nada escucha
...
Nota: `tailnet` es explícito. `auto` prefiere el bucle local; usa `gateway.bind: "tailnet"` cuando quieras un enlace exclusivo de tailnet.

### ¿Puedo ejecutar varios Gateways en el mismo host

Por lo general no: un Gateway puede ejecutar varios canales de mensajería y agentes. Use varios Gateways solo cuando necesite redundancia (ej: bot de rescate) o aislamiento estricto.
...
Los perfiles también sufijan los nombres de los servicios (`ai.openclaw.<profile>`; heredados `com.openclaw.*`, `openclaw-gateway-<profile>.service`, `OpenClaw Gateway (<profile>)`).
...
### ¿Cómo inicio/detiendo/reinicio el servicio Gateway?
...
Documentos: [Windows (WSL2)](/es/platforms/windows), [Manual de servicio del Gateway](/es/gateway).
...
- Emparejamiento de canales/lista blanca bloqueando las respuestas (verifique la configuración del canal + registros).
...
### Desconectado del gateway sin razón, ¿qué hago ahora?
...
### Error en setMyCommands de Telegram ¿Qué debería comprobar
...
Si el Gateway está remoto, asegúrese de estar mirando los registros en el host del Gateway.
...
Inicie el Gateway con `--verbose` para obtener más detalles en la consola. Luego inspeccione el archivo de registro en busca de errores de autenticación del canal, enrutamiento del modelo y RPC.
...
- El comportamiento predeterminado en los canales compatibles con MD es **emparejamiento**:
...
- Abrir MD públicamente requiere aceptación explícita (`dmPolicy: "open"` y lista de permitidos `"*"`).

Ejecute `openclaw doctor` para mostrar políticas de MD riesgosas.

### ¿La inyección de prompt es solo una preocupación para los bots públicos?

No. La inyección de prompt se trata sobre **contenido no confiable**, no solo sobre quién puede enviar MD al bot.
...
- mantener `web_search` / `web_fetch` / `browser` desactivados para los agentes con herramientas habilitadas
- sandboxing y listas de permitidos de herramientas estrictas

Detalles: [Seguridad](/es/gateway/security).

### ¿Mi bot debería tener su propia cuenta de correo electrónico, GitHub o número de teléfono?
...
Empieza poco a poco. Concede acceso solo a las herramientas y cuentas que realmente necesites y amplía más tarde si es necesario.
...
Si deseas acceso inmediato, añade tu ID de remitente a la lista blanca o establece `dmPolicy: "open"` para esa cuenta.

### WhatsApp: ¿enviará mensajes a mis contactos? ¿Cómo funciona el emparejamiento?

No. La política predeterminada de MD de WhatsApp es **emparejamiento**. Los remitentes desconocidos solo reciben un código de emparejamiento y su mensaje **no se procesa**. OpenClaw solo responde a los chats que recibe o a envíos explícitos que tú desencadenas.
...
Solicitud del asistente para el número de teléfono: se usa para establecer tu **lista blanca/propietario** para que se permitan tus propios MD. No se usa para el envío automático. Si ejecutas en tu número personal de WhatsApp, usa ese número y habilita `channels.whatsapp.selfChatMode`.

## Comandos de chat, abortar tareas y "no para"
...
Soluciónalo en el chat donde lo veas:
...
### Cómo detener/cancelar una tarea en ejecución
...
Reinicia la puerta de enlace (gateway) después de editar la configuración. Si solo deseas esto para un solo
agente, establécelo bajo `agents.list[].tools.message` en su lugar.

### ¿Por qué da la sensación de que el bot ignora mensajes rápidos
...
- `followup` - ejecuta mensajes uno a la vez
- `collect` - agrupa mensajes y responde una vez (predeterminado)
- `steer-backlog` - dirige ahora, luego procesa el registro de tareas pendientes
...
**P: "¿Cuál es el modelo predeterminado para Anthropic con una clave API?"**

**R:** En OpenClaw, las credenciales y la selección del modelo son independientes. Configurar `ANTHROPIC_API_KEY` (o almacenar una clave de API de Anthropic en los perfiles de autenticación) habilita la autenticación, pero el modelo predeterminado real es el que configure en `agents.defaults.model.primary` (por ejemplo, `anthropic/claude-sonnet-4-5` o `anthropic/claude-opus-4-6`). Si ve `No credentials found for profile "anthropic:default"`, significa que Gateway no pudo encontrar las credenciales de Anthropic en el `auth-profiles.json` esperado para el agente que se está ejecutando.
