...
nativo puede ser más complicado. WSL2 te brinda la experiencia completa de Linux — un comando
...
- [Guía de inicio](/es/start/getting-started) (usar dentro de WSL)
...
- Use `listenaddress=0.0.0.0` para acceso a LAN; `127.0.0.1` lo mantiene solo localmente.
