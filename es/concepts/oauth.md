...
<Warning>
La compatibilidad con el token de configuración de Anthropic es una compatibilidad técnica, no una garantía política.
Anthropic ha bloqueado algunos usos de suscripciones fuera de Claude Code en el pasado.
Decida por sí mismo si utilizar la autenticación de suscripción y verifique los términos actuales de Anthropic.
</Warning>
