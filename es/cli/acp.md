...
Ejecuta el puente del [Agente de Protocolo de Cliente (ACP)](https://agentclientprotocol.com/) que se comunica con una puerta de enlace OpenClaw.
...
Use ACP cuando un IDE (u otro cliente) hable el Protocolo de Cliente de Agente (ACP) y desee
que impulse una sesión de Gateway de OpenClaw.
