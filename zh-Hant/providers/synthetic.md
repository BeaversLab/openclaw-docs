...
注意：OpenClaw 的 Anthropic 用戶端會將 `/v1` 附加到基礎 URL，因此請使用
...
- 如果您啟用模型允許清單 (`agents.defaults.models`)，請加入您計畫
  使用的每個模型。
- 請參閱 [Model providers](/zh-Hant/concepts/model-providers) 以了解提供者規則。
