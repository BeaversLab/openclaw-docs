...
<Note>
  本頁是精選索引。如果您是新手，請從[入門指南
  ](/zh-Hant/start/getting-started)開始。若要查看文件的完整地圖，請參閱[文件中心
  ](/zh-Hant/start/hubs)。
</Note>

## 從這裡開始

- [文件中心 (所有頁面連結)](/zh-Hant/start/hubs)
- [說明](/zh-Hant/help)
...
- [配對 (DM 和節點)](/zh-Hant/channels/pairing)
