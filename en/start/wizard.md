...
<Tip>
  CLI onboarding includes a web search step where you can pick a provider (Perplexity, Brave,
...
<Tabs>
  <Tab title="QuickStart (defaults)">
    ...
    Setup Reference](/en/start/wizard-cli-reference#outputs-and-internals) - Tailscale exposure
...
<Note>
  ...
  to include workspace. If the config is invalid or contains legacy keys, onboarding asks you to run
