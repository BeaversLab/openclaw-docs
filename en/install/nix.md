...
<Info>
  The [nix-openclaw](https://github.com/openclaw/nix-openclaw) repo is the source of truth for Nix
...
<Steps>
  <Step title="Install Determinate Nix">
    ...
    installer](https://github.com/DeterminateSystems/nix-installer) instructions.
  </Step>
  ...
  <Step title="Configure secrets">
    Set up your messaging bot token and model provider API key. Plain files at `~/.secrets/` work
    fine.
  </Step>
