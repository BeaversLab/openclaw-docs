...
- If running on a VPS/public host, review
  [Security hardening for network exposure](/en/gateway/security#04-network-exposure-bind--port--firewall),
...
Running on a VPS? See [Hetzner (Docker VPS)](/en/install/hetzner).
...
See [Multi-Agent Sandbox & Tools](/en/tools/multi-agent-sandbox-tools) for examples,
