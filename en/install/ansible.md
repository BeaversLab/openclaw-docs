...
Note: The gateway runs **directly on the host** (not in Docker), but agent sandboxes use Docker for isolation. See [Sandboxing](/en/gateway/sandboxing) for details.
...
See [Multi-Agent Sandbox & Tools](/en/multi-agent-sandbox-tools) for sandbox configuration.
...
- [Multi-Agent Sandbox & Tools](/en/multi-agent-sandbox-tools) — per-agent isolation
