...
If the installer completes but `openclaw` is not found in a new terminal, it’s usually a Node/npm PATH issue. See: [Install](/en/install#nodejs--npm-path-sanity).
