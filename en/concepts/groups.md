...
![Group message flow](/en/images/groups-flow.svg)
...
See [Group messages](/en/concepts/group-messages) for WhatsApp-only behavior (history injection, mention handling details).
