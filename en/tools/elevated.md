...
<Info>
  Elevated mode only changes behavior when the agent is **sandboxed**. For unsandboxed agents, exec
...
- [Exec tool](/en/tools/exec) — shell command execution
- [Exec approvals](/en/tools/exec-approvals) — approval and allowlist system
- [Sandboxing](/en/gateway/sandboxing) — sandbox configuration
