...
See [Plugin manifest](/en/plugins/manifest) for the manifest file format.

## Further reading

- [Plugin architecture and internals](/en/plugins/architecture) -- capability model,
...
- [Plugin agent tools](/en/plugins/agent-tools)
